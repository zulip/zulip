...
test("basics", (override) => {
    ...
    let messages_in_topic;

    override(message_finder, "get_messages_in_topic", () => messages_in_topic);
    override(message_finder, "get_max_message_id_in_stream", () => 103);

    messages_in_topic = [{id: 101}, {id: 102}];
