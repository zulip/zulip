...
run_test('marked', () => {
    var test_cases = [
        ...
        {input: 'This is a link with a realm filter [Issue 1234](#1234) and text after it',
         expected: '<p>This is a link with a realm filter <a href="https://trac.zulip.net/ticket/1234" target="_blank" title="https://trac.zulip.net/ticket/1234">Issue 1234</a> and text after it</p>'},
        {input: 'This is not a `[realm filter](#1234)`.',
         expected: '<p>This is not a <code>[realm filter](#1234)</code>.</p>'},
