...
casper.waitForText('Filter by stream name', function () {
    casper.test.assertSelectorHasText('.ind-stream[data-stream-name="Verona"] .stream-title', 'Verona', 'Verona stream exists before filtering');
    casper.test.assertSelectorDoesntHaveText('.ind-stream.notdisplayed .subscription_name', 'Verona', 'Verona stream shown before filtering');
});
casper.then(function () {
...
casper.waitForSelectorTextChange('form#add_new_subscription', function () {
    casper.test.assertSelectorHasText('.ind-stream.notdisplayed .stream-title', 'Verona', 'Verona stream not shown after filtering');
    casper.test.assertSelectorHasText('.ind-stream .stream-title', 'Waseemio', 'Waseemio stream exists after filtering');
    casper.test.assertSelectorDoesntHaveText('.ind-stream.notdisplayed .stream-title', 'Waseemio', 'Waseemio stream shown after filtering');
});
