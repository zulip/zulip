...
casper.then(function () {
    ...
    casper.waitUntilVisible("#compose_actions_dropdown", function () {
        casper.click("#compose_actions_dropdown");
    });
    casper.waitUntilVisible(".compose_stream_button", function () {
        casper.click(".compose_stream_button");
    });
