...
1. Navigate to the [Bots tab][your-bots] of the **Personal settings** menu,
   and click **Add a new bot**.
...
1. Download the `zuliprc` file for the bot created above from the
   [Bots tab][your-bots], by clicking the download
...
1. Download the `botserverrc` file from the [Bots tab][your-bots], using
   the **Download config of all active outgoing webhook bots in Zulip
   Botserver format** option.
...
[your-bots]: {{zulip_url}}/#settings/your-bots
