...
* In Zulip 12.0 (feature level 442), support was added for new filter
  related to user mention: `mentions`. The `mentions` operator filters
  messages that contain a direct, visible personal mention of the
  specified user ID.
