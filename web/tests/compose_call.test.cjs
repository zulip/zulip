...
test("videos", ({override}) => {
    ...
    (function test_jitsi_jwt_video_and_audio_links_compose_clicked() {
        ...
        override(realm, "server_jitsi_server_url", "https://jitsi.example.com");
        override(realm, "server_jitsi_jwt_configured", true);
        ...
        override(realm, "server_jitsi_jwt_configured", false);
        called = false;
        with_overrides(({disallow}) => {
