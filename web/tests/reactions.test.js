        ...
        expected_view_calls: [
            {
                ...
                message: {
                    ...
                    current_user_reacted: alice.user_id === page_params.user_id,
                    reaction_label: clean_reaction_object_alice.label,
                    reacted_by: alice.full_name,
                },
        ...
        expected_view_calls: [
            {
                ...
                message: {
                    ...
                    current_user_reacted: bob.user_id === page_params.user_id,
                    reaction_label: clean_reaction_object_bob.label,
                    reacted_by: bob.full_name,
                },
        ...
        expected_view_calls: [
            {
                ...
                message: {
                    ...
                    current_user_reacted: cali.user_id === page_params.user_id,
                    reaction_label: clean_reaction_object_cali.label,
                    reacted_by: cali.full_name,
                },
