...
const messages = [
    ...
    {id: 101, stream_id: rome_sub.stream_id, topic: "boo", sender_id: 1, type: "stream"},
    {id: 102, stream_id: rome_sub.stream_id, topic: "boo", sender_id: 2, type: "stream"},
    {id: 103, stream_id: rome_sub.stream_id, topic: "boo", sender_id: 3, type: "stream"},
];
...
run_test("test_get_count_of_messages_to_be_moved", () => {
    ...
    message_lists.current.data.all_messages = () => messages;
