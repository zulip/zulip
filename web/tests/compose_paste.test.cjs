...
run_test("paste_handler_converter", () => {
    ...
    */
    ...
    // Pasting from LibreOffice Calc using ^V should paste an image.
    ...
    // A single table pasted from LibreOffice Writer is incorrectly detected as coming from LibreOffice Calc due to the `paste_html`.
    // Details can be found at: https://github.com/zulip/zulip/pull/34752/#discussion_r2113598064
    ...
    // This contains three child elements inside the body tag, pasted from Writer, which is correctly classified.
    ...
    // <body> has a single child element which is not a <table> pasted from Writer.
