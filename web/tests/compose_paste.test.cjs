...
run_test("paste_handler_converter", () => {
    ...
    */
    ...
    // The fixtures below are sourced from Firefox, which produces a
    // simpler paste_html shape than Chrome (no `<html><body>` wrapper,
    // no fragment comments, and no inline `style` attributes on each
    // node). The Chrome-sourced fixtures further down exercise the
    // same paths against the heavier markup Chrome generates.
    ...
    assert.equal(compose_paste.paste_handler_converter(input), "@**King Hamlet|10**");
    ...
    assert.equal(compose_paste.paste_handler_converter(input), "@**Polonius|13**");
    ...
    input =
        ...
        '<span class="mention-content-wrapper">King Hamlet</span></span></p>';
    assert.equal(compose_paste.paste_handler_converter(input), "@_**King Hamlet|10**");
    ...
    assert.equal(compose_paste.paste_handler_converter(input), "@**Desdemona|9**");
    ...
    assert.equal(compose_paste.paste_handler_converter(input), "@*hamletcharacters*");
    ...
    input =
        ...
        '<span class="mention-content-wrapper">hamletcharacters</span></span></p>';
    assert.equal(compose_paste.paste_handler_converter(input), "@_*hamletcharacters*");
    ...
    assert.equal(compose_paste.paste_handler_converter(input), "@**topic**");
    ...
    input =
        ...
        '<span class="mention-content-wrapper">topic</span></span></p>';
    assert.equal(compose_paste.paste_handler_converter(input), "@_**topic**");
    ...
    assert.equal(compose_paste.paste_handler_converter(input), "@**all**");
    ...
    input =
        ...
        '<span class="mention-content-wrapper">all</span></span></p>';
    assert.equal(compose_paste.paste_handler_converter(input), "@_**all**");
