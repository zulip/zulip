...
function set_page_params_no_edit_restrictions() {
    ...
    state_data.realm_delete_own_message_policy = 1;
    state_data.realm_enable_read_receipts = true;
    state_data.realm_edit_topic_policy = 5;
    state_data.realm_move_messages_within_stream_limit_seconds = null;
}
