...
test("reaction_is_notifiable", () => {
    // Case 1: Message is not sent by user and should not notify current user
    user_settings.reaction_notifications_policy =
        settings_config.reaction_notifications_policy_values.always.code;
    let message = {
        id: 1,
        type: "private",
    ...
    // Case 2: DM reaction notification
    message = {
        id: 2,
        type: "private",
        content: "React to my DM",
    ...
    user_settings.reaction_notifications_policy =
        settings_config.reaction_notifications_policy_values.followed_topics.code;

    assert.equal(reaction_notifications.reaction_is_notifiable(message), true);

    user_settings.reaction_notifications_policy =
        settings_config.reaction_notifications_policy_values.unmuted_messages.code;

    assert.equal(reaction_notifications.reaction_is_notifiable(message), true);

    // Case 3: Notify me about reactions to my message in topics I'm following
    user_settings.reaction_notifications_policy =
        settings_config.reaction_notifications_policy_values.followed_topics.code;
    message = {
        id: 3,
    ...
    // Case 4: Notify me about reactions to my message in topics I haven't muted
    user_settings.reaction_notifications_policy =
        settings_config.reaction_notifications_policy_values.unmuted_messages.code;
    message = {
        id: 4,
    ...
    // Case 5: If reactions are in DMs, but notification setting is disabled
    user_settings.reaction_notifications_policy =
        settings_config.reaction_notifications_policy_values.never.code;
    ...
    // Case 6: If reactions are in followed topics, but notification setting is disabled
    message = {
        id: 6,
        content: "React to my followed topic message",
        type: "stream",
    ...
    // Case 7: If reactions are in unmuted topics, but notification setting is disabled
    message = {
        id: 7,
        content: "React to my unmuted topic message",
        type: "stream",
