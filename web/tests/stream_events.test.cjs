...
test("update_property", ({override}) => {
    ...
    // Test archiving stream
    {
        ...
        override(realm, "realm_new_stream_announcements_stream_id", stream_id);
        override(realm, "realm_signup_announcements_stream_id", stream_id);
        override(realm, "realm_zulip_update_announcements_stream_id", stream_id);
