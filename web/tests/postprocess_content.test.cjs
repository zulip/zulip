    ...
    assert.equal(
        postprocess_content(
            '<a href="http://example.com">good</a> ' +
                ...
                '<a class="external_inline_url" href="https://www.youtube.com/watch?v=tyKJueEk0XM">' +
                '<img src="https://i.ytimg.com/vi/tyKJueEk0XM/default.jpg">' +
                "</a>" +
                "</div>",
        ),
        '<a href="http://example.com" target="_blank" rel="noopener noreferrer" class="external_inline_url">good</a> ' +
            ...
            "</div>" +
            '<div class="youtube-video message_inline_image">' +
            '<a class="external_inline_url" href="https://www.youtube.com/watch?v=tyKJueEk0XM" target="_blank" rel="noopener noreferrer">' +
...
run_test("message_inline_animated_image_still", ({override}) => {
    ...
    assert.equal(
        ...
        '<div class="message_inline_image">' +
            '<a href="/user_uploads/path/to/image.png" target="_blank" rel="noopener noreferrer" aria-label="image.png" data-message-link-type="internal_named_link">' +
