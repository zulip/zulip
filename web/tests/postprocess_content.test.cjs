...
run_test("postprocess_basic_links", () => {
    assert.equal(
        ...
        '<a href="http://example.com" target="_blank" rel="noopener noreferrer" title="http://example.com/">good</a> ' +
            '<a href="http://example.com" target="_blank" rel="noopener noreferrer" title="http://example.com/">http://example.com</a> ' +
            '<a href="http://zulip.zulipdev.com/user_uploads/w/ha/tever/file.png" target="_blank" rel="noopener noreferrer" title="http://zulip.zulipdev.com/user_uploads/w/ha/tever/file.png">upload</a> ' +
            "<a>invalid</a> " +
            "<a>unsafe</a> " +
