...
run_test("postprocess_basic_links", () => {
    assert.equal(
        ...
        '<a href="http://example.com" target="_blank" rel="noopener noreferrer" data-message-link-type="external_named_link">good</a> ' +
            '<a href="http://example.com" target="_blank" rel="noopener noreferrer" data-message-link-type="external_plain_url">http://example.com</a> ' +
            '<a href="http://zulip.zulipdev.com/user_uploads/w/ha/tever/file.png" target="_blank" rel="noopener noreferrer" data-message-link-type="user_upload">upload</a> ' +
            "<a>invalid</a> " +
            "<a>unsafe</a> " +
