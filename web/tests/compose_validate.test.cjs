...
test_ui("maybe_clear_stale_recipient_not_subscribed_warnings", () => {
    ...
    $banner_container.set_find_results(".recipient_not_subscribed", $banner_present);
    ...
    $banner_stale[0].remove = () => {
        banner_stale_removed = true;
    };
    $banner_container.set_find_results(".recipient_not_subscribed", $banner_stale);
    ...
    $banner_container.set_find_results(".recipient_not_subscribed", $banner_id_form);
    ...
    $banner_container.set_find_results(".recipient_not_subscribed", $banner_name_and_id);
    ...
    $banner_unknown_user[0].remove = () => {
        banner_unknown_removed = true;
    };
    $banner_container.set_find_results(".recipient_not_subscribed", $banner_unknown_user);
