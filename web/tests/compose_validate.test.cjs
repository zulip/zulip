...
test_ui("validate", ({mock_template, override, override_rewire}) => {
    ...
    mock_template("compose_banner/compose_banner.hbs", false, (data) => {
        ...
        assert.equal(data.banner_text, compose_validate.NO_STREAM_MENTIONED_ERROR_MESSAGE);
    ...
    mock_template("compose_banner/compose_banner.hbs", false, (data) => {
        ...
        assert.equal(data.banner_text, compose_validate.NO_TOPIC_MENTIONED_ERROR_MESSAGE);
