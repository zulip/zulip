...
function initialize_handlers({override}) {
    override(state_data, "realm_available_video_chat_providers", {disabled: {id: 0}});
    override(state_data, "realm_video_chat_provider", 0);
...
test_ui("send_message", ({override, override_rewire, mock_template}) => {
    ...
    (function test_message_send_success_codepath() {
        ...
        state_data.user_id = new_user.user_id;
...
test_ui("initialize", ({override}) => {
    ...
    state_data.max_file_upload_size_mib = 512;
