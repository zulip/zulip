...
test("browser_idle_detection", ({override}) => {
    ...
    override(browser_idle_detection, "listen_to_idle_detector_permission_change", (cb) => cb());
    activity.setup_browser_idle_detector(idle_handler);
    ...
    // For full coverage.
    override(browser_idle_detection, "request_browser_idle_detector_permission", noop);
