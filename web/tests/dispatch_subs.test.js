...
test("stream delete (special streams)", ({override}) => {
    ...
    state_data.realm_notifications_stream_id = event.streams[0].stream_id;
    state_data.realm_signup_notifications_stream_id = event.streams[1].stream_id;
    ...
    assert.equal(state_data.realm_notifications_stream_id, -1);
    assert.equal(state_data.realm_signup_notifications_stream_id, -1);
});
