...
function test_sync_realm_settings() {
    ...
    function test_common_policy(property_name) {
        ...
        state_data[`realm_${property_name}`] = settings_config.common_policy_values.by_members.code;
        ...
        for (const policy_value of Object.values(settings_config.common_policy_values)) {
            state_data[`realm_${property_name}`] = policy_value.code;
...

    {
        ...
        state_data.realm_create_public_stream_policy = 1;
        state_data.realm_message_content_edit_limit_seconds = 120;
...

    {
        ...
        state_data.realm_message_content_edit_limit_seconds = 130;
        settings_org.sync_realm_settings("message_content_edit_limit_seconds");
...

    {
        ...
        state_data.realm_emails_restricted_to_domains = true;
        state_data.realm_disallow_disposable_email_addresses = false;
        ...
        state_data.realm_emails_restricted_to_domains = false;

        state_data.realm_disallow_disposable_email_addresses = true;
        settings_org.sync_realm_settings("emails_restricted_to_domains");
...
function test_discard_changes_button(discard_changes) {
    ...
    state_data.realm_allow_edit_history = true;
    state_data.realm_edit_topic_policy =
        settings_config.common_message_policy_values.by_everyone.code;
    state_data.realm_allow_message_editing = true;
    state_data.realm_message_content_edit_limit_seconds = 3600;
    state_data.realm_delete_own_message_policy =
        settings_config.common_message_policy_values.by_everyone.code;
    state_data.realm_message_content_delete_limit_seconds = 120;
...
test("set_up", ({override, override_rewire}) => {
    state_data.realm_available_video_chat_providers = {
        jitsi_meet: {
            id: 1,
            name: "Jitsi Meet",
        },
    ...
    override(state_data, "is_owner", true);
    settings_org.set_up();
