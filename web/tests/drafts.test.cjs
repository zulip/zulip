...
test("format_drafts", ({override, mock_template}) => {
    ...
    const expected = [
        ...
        },
        {
            ...
            recipient_users: [{full_name: "Aaron", is_placeholder_user: false}],
        ...
        },
        {
            ...
            is_stream: false,
            recipient_users: [
                {full_name: "Iago", is_placeholder_user: false},
                {full_name: "Zoe", is_placeholder_user: false},
            ],
            has_recipient_data: true,
        ...
        },
        {
            ...
            is_dm_with_self: false,
            is_stream: false,
            recipient_users: [{full_name: "Iago", is_placeholder_user: false}],
            has_recipient_data: true,
