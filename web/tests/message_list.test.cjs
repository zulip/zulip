...
function MessageListView() {
    return {
        ...
        get_last_message_historical: () => undefined,
    };
}
...
run_test("bookend", ({override}) => {
    ...
    list.view.get_last_message_historical = () => false;
    is_subscribed = false;
    ...
    list.view.get_last_message_historical = () => true;
    ...
    list.view.get_last_message_historical = () => undefined;
