...
test("canonicalization", () => {
    ...
    const term_1 = Filter.canonicalize_narrow([{operator: "with", operand: 12}]);
    const term_2 = Filter.canonicalize_narrow([topic_term, {operator: "with", operand: 12}]);
    const term_3 = Filter.canonicalize_narrow([channel_term, {operator: "with", operand: 12}]);
