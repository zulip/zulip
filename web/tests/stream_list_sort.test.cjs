...
channel_folders.initialize({
    channel_folders: [frontend_folder, backend_folder, empty_folder],
});
...
test("basics", ({override}) => {
    ...
    assert.deepEqual(sorted_sections[4].id, empty_folder.id.toString());
