...
run_test("build_reload_hash", () => {
    window.location.hash = "#settings/profile";
    assert.equal(hash_util.build_reload_hash(), "settings/profile");

    window.location.hash = "#test";
    assert.equal(hash_util.build_reload_hash(), "test");

    window.location.hash = "#";
    assert.equal(hash_util.build_reload_hash(), "");
