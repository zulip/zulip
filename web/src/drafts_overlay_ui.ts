...
function rerender_drafts(): void {
    ...
    if (focused_draft_id !== undefined) {
        // Defer: focusing synchronously right after the list DOM is replaced
        // doesn't take (the same reason launch() defers its initial focus).
        setTimeout(() => {
