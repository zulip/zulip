...
export const server_event_schema = z.intersection(
    z.discriminatedUnion("type", [
            ...
            z.discriminatedUnion("property", [
                z.object({
                    ...
                    data: z.union([
                        ...
                        z.object({
                            topics_policy: z.string(),
                            mandatory_topics: z.boolean(),
                        }),
                    ]),
                }),
                z.object({
