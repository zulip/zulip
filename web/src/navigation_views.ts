...
export const built_in_views_meta_data: Record<string, BuiltInViewBasicMetadata> = {
    ...
    mark_messages_as_read: {
        fragment: "mark_messages_as_read",
        name: $t({defaultMessage: "Mark messages as read"}),
        is_pinned: true,
        icon: "zulip-icon-mark-as-read",
        css_class_suffix: "mark_messages_as_read",
        tooltip_template_id: "",
        has_unread_count: false,
        unread_count_type: "",
        supports_masked_unread: false,
    ...
    show_hide_unread_counter: {
        fragment: "show_hide_unread_counter",
        name: $t({defaultMessage: "Show/hide unread counter"}),
        is_pinned: true,
        icon: "zulip-icon-eye",
        css_class_suffix: "show_hide_unread_counter",
        tooltip_template_id: "",
        has_unread_count: false,
        unread_count_type: "",
        supports_masked_unread: false,
