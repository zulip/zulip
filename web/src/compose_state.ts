...
let is_channel_picker_open = false;
...
export function set_is_channel_picker_open(val: boolean): void {
    is_channel_picker_open = val;
}

export function get_is_channel_picker_open(): boolean {
    return is_channel_picker_open;
}
