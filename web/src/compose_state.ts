...
let recipient_guest_ids_for_dm_warning: number[] | undefined;
...
export function set_recipient_guest_ids_for_dm_warning(guest_names: number[]): void {
    recipient_guest_ids_for_dm_warning = guest_names;
}

export function get_recipient_guest_ids_for_dm_warning(): number[] | undefined {
