...
export function user_can_move_messages_out_of_channel(stream_id: number): boolean {
...
export function user_can_move_messages_within_channel(stream_id: number): boolean {
    const stream = get_sub_by_id(stream_id);
    assert(stream !== undefined);
