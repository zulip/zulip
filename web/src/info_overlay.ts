...
const markdown_help_rows = [
    ...
    },
    {
        ...
        effect_html: $t_html(
            {defaultMessage: "(notifies <user-group></user-group> group)"},
            {"user-group": () => `<b>${$t({defaultMessage: "support team"})}</b>`},
        ),
    },
    {
        markdown: "@**all**",
...
<div class="codehilite"><pre><span class="k">def</span> <span class="nf">${$t({defaultMessage: "zulip"})}</span><span class="p">():</span>
    ...
    {
        markdown: $t(
            {defaultMessage: "Some inline math <math></math>"},
            {math: () => "$$ e^{i \\pi} + 1 = 0 $$"},
        ),
    },
    {
            ...
            <ul class="todo-widget">
                <li>
                    <label class="checkbox">
                        ...
                        <div>
                            <strike><strong>${$t({defaultMessage: "Task 1"})}:</strong> ${$t({defaultMessage: "This is the first task."})}</strike>
                        </div>
                    </label>
                </li>
                <li>
