...
export function dispatch_normal_event(event) {
    ...
    switch (event.type) {
        ...
        case "navigation_views":
            switch (event.op) {
                case "add":
                    navigation_views.update_navigation_view_dict(event.navigation_view);
                    break;
                case "update":
                    navigation_views.update_navigation_view_dict(event.navigation_view);
                    break;
                case "delete":
                    navigation_views.delete_navigation_view(event.fragment);
                    break;
                default:
                    blueslip.error("Unexpected event type navigation_views/" + event.op);
                    break;
            }
            break;
