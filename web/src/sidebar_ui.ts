...
export function update_left_sidebar_unread_counts_visibility(): void {
    ...
    if (!user_settings.web_left_sidebar_unreads_count_summary) {
        $home_view.addClass("hide_unread_counts");
        $topics_header.addClass("hide_unread_counts");
        $streams_header.addClass("hide_unread_counts");
        $direct_message_header.addClass("hide_unread_counts");
    } else {
        $home_view.removeClass("hide_unread_counts");
        $topics_header.removeClass("hide_unread_counts");
        $streams_header.removeClass("hide_unread_counts");
        $direct_message_header.removeClass("hide_unread_counts");
    }
}
