...
export function show_button_loading_indicator($button: JQuery): void {
    ...
    $button.find(".zulip-icon").removeClass("visibility-visible").addClass("visibility-hidden");
    $button
...
export function hide_button_loading_indicator($button: JQuery): void {
    ...
    $button.find(".zulip-icon").removeClass("visibility-hidden").addClass("visibility-visible");
    $button
        .find(".action-button-label")
