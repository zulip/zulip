...
export let new_stream_can_unsubscribe_group_widget = null;
...
export function dropdown_setup() {
    ...
    new_stream_can_unsubscribe_group_widget = new dropdown_widget.DropdownWidget({
        widget_name: "new_stream_can_unsubscribe_group",
        get_options: () =>
            user_groups.get_realm_user_groups_for_dropdown_list_widget(
        ...
        item_click_callback(event, dropdown) {
            ...
            event.preventDefault();
            event.stopPropagation();
            new_stream_can_unsubscribe_group_widget.render();
        },
        $events_container: $("#subscription_overlay"),
        tippy_props: {
            placement: "bottom-start",
