...
import render_confirm_deactivate_user_group from "../templates/confirm_dialog/confirm_deactivate_user_group.ts";
import render_confirm_join_group_direct_member from "../templates/confirm_dialog/confirm_join_group_direct_member.ts";
import render_modal_banner from "../templates/modal_banner/modal_banner.ts";
import render_settings_checkbox from "../templates/settings/settings_checkbox.ts";
...
import render_stream_group_permission_settings from "../templates/user_group_settings/stream_group_permission_settings.ts";
import render_user_group_membership_status from "../templates/user_group_settings/user_group_membership_status.ts";
import render_user_group_permission_settings from "../templates/user_group_settings/user_group_permission_settings.ts";
import render_user_group_settings from "../templates/user_group_settings/user_group_settings.ts";
import render_user_group_settings_empty_notice from "../templates/user_group_settings/user_group_settings_empty_notice.ts";
