...
import render_inline_url_tooltip from "../templates/inline_url_tooltip.hbs";
...
import {try_stream_topic_syntax_text} from "./copy_and_paste.ts";
...
export function initialize(): void {
    ...
    message_list_tooltip(".message_content > p > a.inline_url", {
        onShow(instance) {
            const $elem = $(instance.reference);
            const url = $elem.attr("href");
            instance.setContent(parse_html(render_inline_url_tooltip({url})));
        },
        onHidden(instance) {
            instance.destroy();
        },
    ...
    message_list_tooltip(".message_content > p > a.internal_named_link", {
        delay: LONG_HOVER_DELAY,
        onShow(instance) {
            const $elem = $(instance.reference);
