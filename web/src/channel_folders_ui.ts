...
function render_channel_folder_stream_list(streams: StreamSubscription[], folder_id: number): void {
    ...
    channel_folder_stream_list_widget = ListWidget.create($container, streams, {
        name: `channel-folder-${folder_id}-stream-list`,
        ...
        $simplebar_container: $("#edit_channel_folder .edit-channel-folder-stream-list-container"),
    });
...
function render_add_channel_folder_widget(): void {
    ...
    $add_channel_button.on("click", (e) => {
        e.preventDefault();
        assert(add_channel_folder_widget);
