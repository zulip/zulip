    ...
    popover_menus.register_popover_menu(target, {
        ...
        onMount(instance) {
            ...
            $popper.on("click", ".sidebar-open-topic-links", () => {
                ...
                // could get this from `props.placement`, but for some reason
                // it's still falling back when it runs out of space, and the first
                // popover might run out of space when the second won't.
