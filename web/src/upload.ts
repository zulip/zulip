...
// This list is identical to the one defined in zerver/lib/mime_types.py
const AUDIO_EXTENSIONS = new Set([".aac", ".flac", ".mp3", ".mpeg", ".wav"]);

function is_audio(file_name: string): boolean {
    return AUDIO_EXTENSIONS.has(file_name.slice(file_name.lastIndexOf(".")));
}
