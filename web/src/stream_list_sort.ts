...
export function sort_groups(stream_ids: number[], search_term: string): StreamListSortResult {
    ...
    const sections = [pinned_section, ...folder_sections_sorted, normal_section];
    ...
    if (!same_as_before) {
        ...
        all_streams = sections.flatMap((section) => [
            ...section.streams,
...
export function prev_stream_id(stream_id: number): number | undefined {
    ...
    // TODO(evy) figure out how to handle hidden inactive streams
