...
export function mark_as_unread_from_here(message_id: number): void {
    ...
    const min_message_ids_to_update =
        has_found_newest || may_contain_multiple_conversations
    ...
    if (
        ...
        assert(min_message_ids_to_update !== undefined);
        ...
        const ctx = {
            show_message_count: message_count >= MIN_MARK_AS_UNREAD_COUNT_LOWER_BOUND,
            count: display_count,
        };
