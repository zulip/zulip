...
export function confirm_mark_all_as_read(): void {
    ...
    const default_message_count = count_messages("topics_not_followed");
    ...
    $("#mark_as_read_option").on("change", function () {
        ...
        const message_count = count_messages(selected_option);
...
function count_messages(selected_option: string): number {
