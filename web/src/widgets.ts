...
import * as propose_widget from "./propose_widget.ts";
import * as rsvp_widget from './rsvp_widget.ts';
import * as todo_widget from "./todo_widget.ts";
import * as zform from "./zform.ts";

export function initialize(): void {
    generic_widget.widgets.set("poll", poll_widget);
    generic_widget.widgets.set("propose_meeting", propose_widget);
    generic_widget.widgets.set("rsvp", rsvp_widget);
