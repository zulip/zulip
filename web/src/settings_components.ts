...
export const simple_dropdown_realm_settings_schema = z.pick(realm_schema, {
    ...
    realm_default_new_user_avatar: true,
});
...
const dropdown_widget_map = new Map<string, DropdownWidget | null>([
    ...
    ["realm_default_new_user_avatar", null],
...
export function get_dropdown_list_widget_setting_value(
    $input_elem: JQuery,
    ...
    if (setting_widget === null) {
        throw new Error(`Widget ${widget_name} not found`);
    }
