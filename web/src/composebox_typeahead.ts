...
export function initialize_topic_edit_typeahead(
    ...
    return new Typeahead(bootstrap_typeahead_input, {
        ...
        showOnFocus: is_topic_creation_disabled,
...
export function initialize({
    ...
    // Register the typeahead with compose_recipient so it can update
    // helpOnEmptyStrings and showOnFocus when the channel changes.
