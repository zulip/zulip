...
function delete_profile_field(this: HTMLElement, e: JQuery.ClickEvent): void {
    ...
    const profile_field_id = Number.parseInt($(this).closest("td").attr("data-profile-field-id")!, 10);
...
function open_edit_form_modal(this: HTMLElement): void {
    ...
    const field_id = Number.parseInt($(this).closest("td").attr("data-profile-field-id")!, 10);
