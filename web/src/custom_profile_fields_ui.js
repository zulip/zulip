...
export function append_custom_profile_fields(element_id, user_id) {
    ...
    const all_custom_fields = state_data.custom_profile_fields;
    const all_field_types = state_data.custom_profile_field_types;
...
export function initialize_custom_user_type_fields(
    ...
    for (const field of state_data.custom_profile_fields) {
