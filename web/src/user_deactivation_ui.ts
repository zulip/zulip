...
export function confirm_deactivation(
    ...
    void channel.get({
        ...
        success(raw_data) {
            ...
            const user_can_delete_any_message_group = settings_data.user_can_delete_any_message();
            const opts = {
                ...
                realm_url,
                realm_name,
                message_delete_actions: settings_config.message_delete_action_values,
                user_can_delete_any_message_group,
            };
