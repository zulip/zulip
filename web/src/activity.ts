...
import {maybe_get_user_by_id, my_current_user_id} from "./people.ts";
    ...
    void channel.post({
        ...
        success(response) {
            ...
            if (redraw) {
                ...
                const user_id = my_current_user_id();
                const status = presence.status_from_raw(raw, maybe_get_user_by_id(user_id));
