...
export function show_generate_integration_url_modal(api_key: string): void {
    ...
    function generate_integration_url_post_render(): void {
        ...
        function update_url(render_events = false): void {
            ...
            const selected_topics_scheme = topics_to_use_dropdown_widget.value();
            if (stream_id !== -1) {
                params.set("stream", stream_id!.toString());
                if (
                    ($override_topic.prop("checked") ||
                        selected_topics_scheme === send_all_to_single_topic.unique_id) &&
                    topic_name !== ""
                ) {
                    params.set("topic", topic_name);
                } else if (selected_topics_scheme === topics_named_after_slack_channels.unique_id) {
                    params.delete("topic");
        ...
        topics_to_use_dropdown_widget = new dropdown_widget.DropdownWidget({
            ...
            get_options() {
                return [
                    ...
                    topics_named_after_slack_channels,
                    send_all_to_single_topic,
                ];
            },
        ...
        function topics_to_use_click_callback(
            ...
            $topic_input
                .parent()
                .toggleClass("hide", selected_topic_option !== send_all_to_single_topic.unique_id);
        ...
        function stream_item_click_callback(
            ...
            if (user_selected_option === direct_messages_option.unique_id) {
                ...
                set_input_disabled_state($topics_to_use_widget, true);
                topics_to_use_dropdown_widget.render(send_all_to_single_topic.unique_id);
            } else {
