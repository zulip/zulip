...
export class TaskData {
    ...
    editing_items = new Map<string, JQuery>();
    my_idx = 1;
    ...
    get_editing_items(): Map<string, JQuery> {
        return this.editing_items;
    }

    set_editing_item(key: string, $element: JQuery): void {
        this.editing_items.set(key, $element);
    }
