...
function update_linkifiers_order(): void {
    ...
    $(".linkifier_row").each(function () {
        order.push(Number.parseInt($(this).closest("td").attr("data-linkifier-id")!, 10));
    });
    settings_ui.do_settings_change(
        channel.patch,
...
export function build_page(): void {
    ...
    $(".admin_linkifiers_table").on("click", ".delete", function (e) {
        ...
        const url =
            "/json/realm/filters/" +
            encodeURIComponent($button.closest("td").attr("data-linkifier-id")!);
    ...
    $(".admin_linkifiers_table").on("click", ".edit", function (e) {
        ...
        const $button = $(this);
        const linkifier_id = Number.parseInt($button.closest("td").attr("data-linkifier-id")!, 10);
