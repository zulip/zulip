...
export const update_person = function update(person) {
    ...
    if (Object.hasOwn(person, "delivery_email")) {
        ...
        if (people.is_my_user_id(person.user_id)) {
            ...
            state_data.delivery_email = delivery_email;
    ...
    if (Object.hasOwn(person, "full_name")) {
        ...
        if (people.is_my_user_id(person.user_id)) {
            state_data.full_name = person.full_name;
    ...
    if (Object.hasOwn(person, "role")) {
        ...
        if (people.is_my_user_id(person.user_id) && state_data.is_owner !== person_obj.is_owner) {
            state_data.is_owner = person_obj.is_owner;
            settings_org.maybe_disable_widgets();
            settings.update_lock_icon_in_sidebar();
        }

        if (people.is_my_user_id(person.user_id) && state_data.is_admin !== person_obj.is_admin) {
            state_data.is_admin = person_obj.is_admin;
        ...
        if (
            ...
            state_data.is_moderator !== person_obj.is_moderator
        ) {
            state_data.is_moderator = person_obj.is_moderator;
        }
    }
    ...
    if (Object.hasOwn(person, "is_billing_admin")) {
        ...
        if (people.is_my_user_id(person.user_id)) {
            state_data.is_billing_admin = person_obj.is_billing_admin;
        }
    }
    ...
    if (Object.hasOwn(person, "avatar_url")) {
        ...
        if (people.is_my_user_id(person.user_id)) {
            state_data.avatar_source = person.avatar_source;
            state_data.avatar_url = url;
            state_data.avatar_url_medium = person.avatar_url_medium;
