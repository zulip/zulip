        ...
        void channel.patch({
            ...
            success: () => {
                ...
                feedback_widget.show({
                    ...
                    populate($container) {
                        $container.text(
                            $t(
                                {
                                    defaultMessage:
                                        "Your time zone was updated to {browser_time_zone}",
                                },
                                {browser_time_zone},
                            ),
                        );
                    ...
                    undo_button_text: $t({defaultMessage: "Profile settings"}),
                });
            },
            error() {
                feedback_widget.show({
                    ...
                    populate($container) {
                        $container.text(
                            $t({defaultMessage: "There was an error updating the timezone."}),
                        );
                    },
                });
            },
