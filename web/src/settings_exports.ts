...
function maybe_show_notes_about_unusable_users_if_exported(
    ...
    // Add a note if at least one user won’t be able to log in to the
    // exported realm. This can happen if they don’t consent to their
    // private data being exported when “Standard export” is selected,
    // or if they both don’t consent and have set their email visibility
    // to “nobody” when “Public export” is selected.
