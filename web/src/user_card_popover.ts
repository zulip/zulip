...
function init_long_text_copy_icon(): void {
    $(".copy-custom-profile-field-long-text").each(function () {
        const $copy_icon = $(this);
...
function register_click_handlers(): void {
    ...
    $("body").on("click", ".copy-custom-profile-field-long-text", function (this: HTMLElement, e) {
        ...
        void (async () => {
            try {
                await navigator.clipboard.writeText(field_value);
