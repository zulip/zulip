...
export function get_actions_popover_content_context(message_id) {
    ...
    const should_display_read_receipts_option =
        state_data.realm_enable_read_receipts && not_spectator;
...
export function get_personal_menu_content_context() {
    const my_user_id = state_data.user_id;
    ...
    return {
        user_id: my_user_id,
        invisible_mode,
        user_is_guest: state_data.is_guest,
        ...
        user_full_name: state_data.full_name,
...
export function get_gear_menu_content_context() {
    const user_has_billing_access = state_data.is_billing_admin || state_data.is_owner;
    const is_plan_standard = state_data.realm_plan_type === 3;
    ...
    return {
        ...
        realm_url: new URL(state_data.realm_uri).hostname,
        is_owner: state_data.is_owner,
        is_admin: state_data.is_admin,
        is_spectator: page_params.is_spectator,
        is_self_hosted: state_data.realm_plan_type === 1,
        is_development_environment: page_params.development_environment,
        is_plan_limited: state_data.realm_plan_type === 2,
        is_plan_standard,
        is_plan_standard_sponsored_for_free: state_data.realm_plan_type === 4,
        is_plan_plus,
        is_org_on_paid_plan,
        is_business_org: state_data.realm_org_type === 10,
        is_education_org: state_data.realm_org_type === 30 || state_data.realm_org_type === 35,
        standard_plan_name: "Zulip Cloud Standard",
        server_needs_upgrade: state_data.server_needs_upgrade,
