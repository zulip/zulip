...
/*
    ...
    1. Either the startContainer or endContainer or both are within an inline expression where the
    range covers one or more math expressions.
    2. Either the startContainer, endContainer, or both are within a math block where the
    range covers one or more math expressions.
    ...
    This is done in cases where the startContainer/endContainer denoting the end of the range
    lies inside the math block or expression(depending on whether startContainer comes after the endContainer or
    vice-versa in the DOM) as part of the effort to keep selection range and paste content
