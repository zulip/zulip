...
export function update_send_read_receipts_tooltip() {
    if (state_data.realm_enable_read_receipts) {
...
export function set_up() {
    ...
    const setup_api_key_modal = () => {
        ...
        if (state_data.realm_password_auth_enabled === false) {
        ...
        $("#regenerate_api_key").on("click", (e) => {
            const email = state_data.delivery_email;
        ...
        $("#download_zuliprc").on("click", function () {
            const bot_object = {
                ...
                email: state_data.delivery_email,
    ...
    $("#change_password").on("click", async (e) => {
        ...
        dialog_widget.launch({
            ...
            html_body: render_dialog_change_password({
                password_min_length: state_data.password_min_length,
                password_min_guesses: state_data.password_min_guesses,
            }),
    ...
    $("#change_email_button").on("click", (e) => {
        ...
        if (settings_data.user_can_change_email()) {
            dialog_widget.launch({
                ...
                html_body: render_change_email_modal({delivery_email: state_data.delivery_email}),
                html_submit_button: $t_html({defaultMessage: "Change"}),
                loading_spinner: true,
        ...
        if (
            ...
            dialog_widget.launch({
                ...
                html_body: render_demo_organization_add_email_modal({
                    delivery_email: state_data.delivery_email,
