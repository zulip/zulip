...
function message_was_moved_between_streams(message: Message): boolean {
...
function get_message_divider_data(opts: {
    ...
    if (
        ...
        !message_was_moved_between_streams(curr_message)
    ) {
...
export class MessageListView {
    ...
    get_possible_group_subscription_markers(
        ...
        if (
            ...
            message_was_moved_between_streams(first_message)
        ) {
            return undefined;
        }
    ...
    build_message_groups(messages: Message[]): {
        ...
        for (const message of messages) {
            ...
            let want_subscription_status_divider = false;
            const want_moved_message_divider = message_was_moved_between_streams(message);
            ...
            if (!message_was_moved_between_streams(message)) {
