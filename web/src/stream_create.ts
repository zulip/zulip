...
export function open_edit_modal_for_archived_channel(stream_id: number): void {
    ...
    function save_stream_info(): void {
        const stream_id = Number.parseInt(
            $("#change_stream_info_modal .dialog_submit_button").attr("data-stream-id")!,
            10,
        );
...
export function initialize(): void {
    $("#channels_overlay_container").on("click", "#archived_stream_rename", (e) => {
        ...
        open_edit_modal_for_archived_channel(stream_id);
    });
}
