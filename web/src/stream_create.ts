...
export function set_up_handlers(): void {
    ...
    $container.on("click", ".finalize_create_stream", (e) => {
        ...
        void (async () => {
            ...
            // the channel twice, and the back button so that the
            // settings we validated cannot be changed underneath us.
            // The buttons are re-enabled if creating fails, or when the
            // form is reopened.
