...
function highlight_all_private_messages_view(): void {
    $(".not-modal-direct-messages-container").addClass("active-direct-messages-section");
}

function unhighlight_all_private_messages_view(): void {
    $(".not-modal-direct-messages-container").removeClass("active-direct-messages-section");
}
...
function zoom_in(): void {
    ...
    $("#left-sidebar-modal").addClass("zoom-in-conversations");
...
function zoom_out(): void {
    ...
    $("#left-sidebar-modal").removeClass("zoom-in-conversations");
...
export function initialize(): void {
    ...
    $("#left-sidebar").on("click", ".zoom-in-conversations .left-sidebar-modal-close-area", (e) => {
        e.stopPropagation();
        e.preventDefault();
