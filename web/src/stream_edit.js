...
export function get_display_text_for_realm_message_retention_setting() {
    const realm_message_retention_days = state_data.realm_message_retention_days;
...
export function show_settings_for(node) {
    ...
    const html = render_stream_settings({
        ...
        upgrade_text_for_wide_organization_logo: state_data.upgrade_text_for_wide_organization_logo,
...
export function initialize() {
    ...
    $("#streams_overlay_container").on("click", ".deactivate", (e) => {
        ...
        const is_new_stream_notification_stream =
            stream_id === state_data.realm_notifications_stream_id;
        const is_signup_notification_stream =
            stream_id === state_data.realm_signup_notifications_stream_id;
