...
function setup_dropdown(sub, slim_sub) {
    ...
    const can_access_stream_topics_group_widget = new dropdown_widget.DropdownWidget({
        widget_name: "can_access_stream_topics_group",
        get_options: () =>
            user_groups.get_realm_user_groups_for_dropdown_list_widget(
        ...
        item_click_callback(event, dropdown) {
            ...
            event.preventDefault();
            event.stopPropagation();
            can_access_stream_topics_group_widget.render();
            settings_components.save_discard_stream_settings_widget_status_handler(
                $(".advanced-configurations-container"),
                slim_sub,
            );
        ...
        default_id: sub.can_access_stream_topics_group,
        unique_id_type: dropdown_widget.DataTypes.NUMBER,
        on_mount_callback(dropdown) {
            $(dropdown.popper).css("min-width", "300px");
        },
    ...
    settings_components.set_dropdown_setting_widget(
        "can_access_stream_topics_group",
        can_access_stream_topics_group_widget,
    );
    can_access_stream_topics_group_widget.setup();
}
