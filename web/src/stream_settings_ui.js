...
function should_list_all_streams() {
    return !state_data.realm_is_zephyr_mirror_realm;
}
...
export function setup_page(callback) {
    ...
    function populate_and_fill() {
        ...
        const template_data = {
            ...
            can_view_all_streams: !state_data.is_guest && should_list_all_streams(),
            max_stream_name_length: state_data.max_stream_name_length,
            max_stream_description_length: state_data.max_stream_description_length,
            ...
            zulip_plan_is_not_limited: state_data.zulip_plan_is_not_limited,
            org_level_message_retention_setting:
                stream_edit.get_display_text_for_realm_message_retention_setting(),
            upgrade_text_for_wide_organization_logo:
                state_data.upgrade_text_for_wide_organization_logo,
            is_business_type_org:
                state_data.realm_org_type === settings_config.all_org_type_values.business.code,
        ...
        // implicitly because state_data.realm_is_zephyr_mirror_realm.
...
export function change_state(section, right_side_tab) {
    ...
    if (/\d+/.test(section)) {
        ...
        if (!sub || (state_data.is_guest && !stream_data.is_subscribed(stream_id))) {
            toggler.goto("subscribed");
        } else {
            show_right_section();
