...
export const reload_metadata_schema = z.object({
    reload_data: z.object({
        ...
        send_draft_immediately: z.optional(z.boolean()),
    }),
    timestamp: z.number(),
});
...
function preserve_state(send_draft_immediately: boolean, save_compose: boolean): void {
    ...
    const metadata: z.infer<typeof reload_metadata_schema> = {
        reload_data,
        timestamp: Date.now(),
    };
