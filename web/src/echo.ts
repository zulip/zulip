...
type Data = z.output<typeof send_message_api_response_schema>;
...
function resend_message(
    ...
    $row: JQuery,
    {
        ...
        on_send_message_success: (request: Message, data: Data) => void;
        send_message: (
            request: Message,
...
export function edit_locally(message: Message, request: LocalEchoRequest): Message {
