...
import render_onboarding_compose_go_to_conversation_button_tooltip_template from "../templates/onboarding_compose_go_to_conversation_button_tooltip_template.hbs";
...
export function show_go_to_conversation_button_intro_tooltip(): void {
    ...
    go_to_conversation_intro_tooltip_instance = tippy.default(element, {
        ...
        content: parse_html(render_onboarding_compose_go_to_conversation_button_tooltip_template()), // Changed this line
        onHidden(instance) {
            instance.destroy();
            go_to_conversation_intro_tooltip_instance = null;
