...
export function initialize(): void {
    ...
    popover_menus.register_popover_menu(".left-sidebar-navigation-menu-icon", {
        ...
        onShow(instance) {
            ...
            const unpinned_built_in_views = left_sidebar_navigation_area
                .get_built_in_views()
                .filter((view) => {
                    if (view.is_pinned) {
                        return false;
                    }
                    if (view.fragment === left_sidebar_navigation_area.current_active_fragment) {
                        return false;
                    }
                    ...
                    if (view.fragment === "reminders") {
                        return message_reminder.get_count() > 0;
                    }
                    return true;
                });

            const views = is_condensed ? built_in_popover_condensed_views : unpinned_built_in_views;
        ...
        onMount() {
            const all_views = left_sidebar_navigation_area.get_built_in_views();
            ...
            for (const view of all_views) {
                ...
                switch (view.fragment) {
                    ...
                    case built_in_views_meta_data.starred_messages!.fragment:
                        ...
                        break;
                    case built_in_views_meta_data.inbox!.fragment:
                    case built_in_views_meta_data.recent_view!.fragment:
                    case built_in_views_meta_data.all_messages!.fragment:
