...
export function initialize(): void {
                ...
                ui_util.parse_html(
                    render_left_sidebar_starred_messages_popover({
                        ...
                        is_currently_active_unpinned_view:
                            left_sidebar_navigation_area.is_currently_active_unpinned_view(
                                built_in_views_values.starred_messages.fragment,
                            ),
                    }),
                ),
            );
            ...
            instance.setContent(
                ui_util.parse_html(
                    render_left_sidebar_drafts_popover({
                        ...
                        is_currently_active_unpinned_view:
                            left_sidebar_navigation_area.is_currently_active_unpinned_view(
                                built_in_views_values.drafts.fragment,
                            ),
                    }),
                ),
            );
            ...
            instance.setContent(
                ui_util.parse_html(
                    render_left_sidebar_inbox_popover({
                        ...
                        is_currently_active_unpinned_view:
                            left_sidebar_navigation_area.is_currently_active_unpinned_view(
                                built_in_views_values.inbox.fragment,
                            ),
                    }),
                ),
            );
            ...
            instance.setContent(
                ui_util.parse_html(
                    render_left_sidebar_all_messages_popover({
                        ...
                        is_currently_active_unpinned_view:
                            left_sidebar_navigation_area.is_currently_active_unpinned_view(
                                built_in_views_values.all_messages.fragment,
                            ),
                    }),
                ),
            );
            ...
            instance.setContent(
                ui_util.parse_html(
                    render_left_sidebar_recent_view_popover({
                        ...
                        is_currently_active_unpinned_view:
                            left_sidebar_navigation_area.is_currently_active_unpinned_view(
                                built_in_views_values.recent_view.fragment,
                            ),
                    }),
                ),
            );
            ...
            instance.setContent(
                ui_util.parse_html(
                    render_navigation_view_hide_popover({
                        ...
                        is_currently_active_unpinned_view:
                            left_sidebar_navigation_area.is_currently_active_unpinned_view(
                                built_in_views_values.mentions.fragment,
                            ),
                    }),
                ),
            );
            ...
            instance.setContent(
                ui_util.parse_html(
                    render_navigation_view_hide_popover({
                        ...
                        is_currently_active_unpinned_view:
                            left_sidebar_navigation_area.is_currently_active_unpinned_view(
                                built_in_views_values.my_reactions.fragment,
                            ),
                    }),
                ),
            );
            ...
            instance.setContent(
                ui_util.parse_html(
                    render_navigation_view_hide_popover({
                        ...
                        view_name: "scheduled messages",
                        is_currently_active_unpinned_view:
                            left_sidebar_navigation_area.is_currently_active_unpinned_view(
                                built_in_views_values.scheduled_messages.fragment,
                            ),
                    }),
                ),
            );
    ...
    popover_menus.register_popover_menu(".left-sidebar-navigation-menu-icon", {
        ...
        onShow(instance) {
            ...
            let views: navigation_views.BuiltInView[] = [];
            if (is_condensed) {
                const all_views = left_sidebar_navigation_area.get_all_views_for_left_sidebar();
                const condensed_views =
                    left_sidebar_navigation_area.get_views_visible_in_condensed_state();
                const condensed_fragments = new Set(condensed_views.map((view) => view.fragment));

                views = all_views.filter((view) => {
                    if (condensed_fragments.has(view.fragment)) {
                        return false;
                    }

                    if (view.fragment === built_in_views_values.scheduled_messages.fragment) {
                ...
                views = left_sidebar_navigation_area
                    .get_all_views_for_left_sidebar()
                    .filter((view) => {
                        if (view.is_pinned) {
                            return false;
                        }
