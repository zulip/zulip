...
export function initialize(): void {
    ...
    popover_menus.register_popover_menu(".dm-section-menu-icon", {
        ...
        onMount(instance) {
            ...
            $popper.one("click", "#pin_dm_section_open", {instance}, pin_dm_section_open);
            $popper.one("click", "#unpin_dm_section", {instance}, unpin_dm_section);
        },
        onShow(instance) {
            popover_menus.popover_instances.left_sidebar_direct_messages_popover = instance;
            assert(instance.reference instanceof HTMLElement);
        ...
        onHidden(instance) {
            instance.destroy();
            popover_menus.popover_instances.left_sidebar_direct_messages_popover = null;
        },
    });
