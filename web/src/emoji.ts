...
>();
// Unlike `all_realm_emojis`, this has no entry for the Zulip emoji,
// which is not an uploaded image and so is never animated.
export const all_realm_emojis_by_url = new Map<string, RealmEmoji>();
