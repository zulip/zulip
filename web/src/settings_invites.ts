...
export function on_load_success(
    ...
    $(".admin_invites_table").on("click", ".edit-invite", function (this: HTMLElement, e) {
        ...
        const creator_role = people.get_by_user_id(invite.invited_by_user_id).role;
        const invite_as_options = get_invite_as_options_for_invite(invite.invited_as, creator_role);
