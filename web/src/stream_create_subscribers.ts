...
export const MAX_SUBS_FOR_NOTIFICATION = 100;
...
export function update_notification_choice_checkbox(added_user_count: number): void {
    const $send_notification_checkbox = $("#people_to_add .send_notification_to_new_subscribers");
    const $send_notification_container = $(
        "#people_to_add .send_notification_to_new_subscribers_container",
    );
