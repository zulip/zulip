...
$(() => {
    ...
    $("body").on("blur", "input[name='monthly_discounted_price']", function () {
        const monthly_price = Number.parseInt($(this).val(), 10);
    ...
    $("body").on("blur", "input[name='annual_discounted_price']", function () {
        const annual_price = Number.parseInt($(this).val(), 10);
        ...
        if (!$monthly_price.val()) {
            const data_original_monthly_price = $monthly_price.attr("data-original-monthly-price");
