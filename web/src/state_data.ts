...
// Used in search suggestions since we want to display user understable
// operands.
export const string_only_operand_narrow_term_schema = z.object({
    operator: narrow_operator_schema,
    operand: z.string(),
    negated: z.optional(z.boolean()),
});

export type StringOnlyOperandNarrowTerm = z.output<typeof string_only_operand_narrow_term_schema>;
