...
const current_user_schema = v.object({
    ...
    can_subscribe_other_users: v.boolean(),
...
export const state_data_schema = v.intersect([
    ...
    v.pipe(
        v.object({
            ...
            realm_default_streams: v.array(stream_schema),
        }),
