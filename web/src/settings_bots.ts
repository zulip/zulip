...
import {get_service_bot_trigger_input, show_service_bot_trigger_options} from "./user_profile.ts";
    ...
    function create_a_new_bot(): void {
        ...
        if (bot_type === OUTGOING_WEBHOOK_BOT_TYPE) {
            ...
            const service_triggers: string[] = get_service_bot_trigger_input(
                "#new_bot_trigger_checkbox_container",
            );
    ...
    function set_up_form_fields(): void {
        ...
        $("#create_bot_type").on("change", () => {
            ...
            if (bot_type === OUTGOING_WEBHOOK_BOT_TYPE) {
                ...
                show_service_bot_trigger_options("#new_bot_trigger_checkbox_container");
            } else if (bot_type === EMBEDDED_BOT_TYPE) {
