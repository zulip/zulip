...
export type DropdownWidgetOptions = {
    ...
    // with a keyboard click or not.
    dropdown_opened_by_keyboard_click?: boolean;
};
...
export class DropdownWidget {
    ...
    constructor(options: DropdownWidgetOptions) {
        ...
        this.dropdown_opened_by_keyboard_click = options.dropdown_opened_by_keyboard_click ?? false;
    }
    ...
    setup(): void {
        ...
        $(this.widget_selector).on("mousedown", () => {
            this.dropdown_opened_by_keyboard_click = false;
        });

        $(this.widget_selector).on("keydown", () => {
            this.dropdown_opened_by_keyboard_click = true;
        });
        ...
        tippy.delegate(delegate_container, {
            ...
            onShow: (instance: tippy.Instance) => {
                ...
                setTimeout(() => {
                    if (this.hide_search_box) {
                        if (this.dropdown_opened_by_keyboard_click) {
