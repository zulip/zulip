...
import {raw_stream_subscription_schema} from "./stream_types";
...
export type ApiStreamSubscription = z.infer<typeof raw_stream_subscription_schema>;

// This is the actual type of subscription objects we use in the app.
export const stream_subscription_schema = raw_stream_subscription_schema
    .omit({
        subscribers: true,
    })
    .extend({
