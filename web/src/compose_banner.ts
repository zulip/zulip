...
export function update_split_messages_info_banner(): void {
    const enabled = compose_split_messages.is_split_messages_enabled();
    const will_split = compose_split_messages.will_split_into_multiple_messages();

    if (!enabled || !will_split) {
