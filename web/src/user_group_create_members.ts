...
> {
    ...
    // removed during the wait would not be reflected in the group.
    ...
    $add_members_container.find(".input").prop("contenteditable", false);
    ...
    $add_members_container.find(".input").prop("contenteditable", true);
