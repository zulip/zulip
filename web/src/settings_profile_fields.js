...
export function field_type_id_to_string(type_id) {
    for (const field_type of Object.values(state_data.custom_profile_field_types)) {
    ...
    if (profile_field_type === field_types.EXTERNAL_ACCOUNT.id) {
        ...
        if (profile_field_external_account_type === "custom") {
            ...
            const profile_field_name =
                state_data.realm_default_external_accounts[profile_field_external_account_type]
                    .name;
...
function get_profile_field(id) {
    return state_data.custom_profile_fields.find((field) => field.id === id);
}
...
export function get_external_account_link(field) {
    ...
    if (field_subtype === "custom") {
        ...
        field_url_pattern = state_data.realm_default_external_accounts[field_subtype].url_pattern;
    }
...
export function build_page() {
    ...
    do_populate_profile_fields(state_data.custom_profile_fields);
    meta.loaded = true;
