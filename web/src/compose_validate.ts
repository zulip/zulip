...
// We avoid re-parsing markdown; instead we do a string search for the
// three mention forms the parser accepts: @**Name**, @**Name|id**,
// and @**|id**.
export function maybe_clear_stale_recipient_not_subscribed_warnings(
    ...
    for (const banner of $existing_banners) {
        ...
        // @**Name|id** for duplicate names), matching what the typeahead inserts.
