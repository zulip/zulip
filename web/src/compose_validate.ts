...
// guest in the dm.
export let warn_if_guest_in_dm_recipient = (): void => {
...
export function rewire_warn_if_guest_in_dm_recipient(
    value: typeof warn_if_guest_in_dm_recipient,
): void {
    warn_if_guest_in_dm_recipient = value;
}
