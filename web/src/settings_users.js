            ...
            success(response) {
                try {
                    ...
                    if (data.presences) {
                        ...
                        for (const [userId, presenceData] of Object.entries(data.presences)) {
                            updatedPresenceInfo[userId] = {
                                active_timestamp: presenceData.active_timestamp,
                                idle_timestamp: presenceData.idle_timestamp,
                            };
                        }
                        Object.assign(user_setting_presence_info, updatedPresenceInfo);
                    }
                    resolve();
                } catch (error) {
