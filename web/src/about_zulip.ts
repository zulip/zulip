...
export function initialize(): void {
    const rendered_about_zulip = render_about_zulip({
        zulip_version: state_data.zulip_version,
        zulip_merge_base: state_data.zulip_merge_base,
        is_fork:
            state_data.zulip_merge_base && state_data.zulip_merge_base !== state_data.zulip_version,
    });
