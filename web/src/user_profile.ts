...
export function show_edit_bot_info_modal(user_id: number, $container: JQuery): void {
    ...
    function edit_bot_post_render(): void {
        ...
        if (bot_type === OUTGOING_WEBHOOK_BOT_TYPE) {
            ...
            show_bot_trigger_options($("#bot_triggers_checkbox_container"), service.triggers);
        }
        if (bot_type === EMBEDDED_BOT_TYPE) {
            ...
            // TODO: Add `show_bot_trigger_options` here once
...
export const bot_trigger_options = [
...
export function show_bot_trigger_options(
    $checkbox_inputs_container: JQuery,
    bot_triggers?: string[],
): void {
    $checkbox_inputs_container.empty();

    for (const trigger_option of bot_trigger_options) {
