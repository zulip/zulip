...
export function update_profile_modal_ui(
    ...
    if (new_data.avatar_url !== undefined) {
        ...
        avatar.update_manage_user_avatar_widget(
...
export function show_edit_user_info_modal(user_id: number, $container: JQuery): void {
    ...
    avatar.build_manage_user_avatar_widget(user_id, () => {
        // Reopens the manage user modal when the cropper or confirmation box closes
        // because two modals can't be open at a time.
