...
export function show_edit_user_info_modal(user_id: number, $container: JQuery): void {
    ...
    $("#edit-user-form").on("click", ".deactivate_user_button", (e) => {
        ...
        function handle_confirm(): void {
            ...
            const message_delete_action = {
                delete_public_stream_messages: $("#message-delete-action[value='1']").is(
                    ":checked",
                ),
                delete_private_stream_messages: $("#message-delete-action[value='2']").is(
                    ":checked",
                ),
                delete_direct_messages: $("#message-delete-action[value='3']").is(":checked"),
            };
