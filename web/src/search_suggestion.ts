...
const channels_incompatible_patterns: TermPattern[] = [
    ...common_incompatible_patterns,
    ...
    if (!page_params.is_spectator) {
        suggestions.push(
            ...filter_suggestions_by_criteria(terms, [
                ...
                archived_channels_search_string,
            ]),
        );
    }
