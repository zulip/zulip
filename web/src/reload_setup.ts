...
export function initialize(): void {
    ...
    if (parsed.success) {
        const data = parsed.data.reload_data;
        if (data.compose_active_draft_id !== undefined) {
            ...
            if (draft === false) {
                ...
                if (data.send_draft_immediately) {
                    compose.finish();
                }
            }
        }
        ...
        reload_with_legacy_data(fragment);
    }
}

function reload_with_legacy_data(fragment: unknown): void {
