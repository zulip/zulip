...
function build_stream_popover(opts: {elt: HTMLElement; stream_id: number}): void {
    ...
    const stream_edit_hash = can_change_stream_permissions
        ? hash_util.channels_settings_edit_url(sub, "general")
        : hash_util.channels_settings_edit_url(sub, "personal");
    const channel_setting_url = browser_history.get_full_url(stream_edit_hash);
