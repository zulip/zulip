...
// Rendering contexts that carry the `web_animate_image_previews`
// setting through to a template should use this type rather than
// `string`, since the templates branch on the exact value.
