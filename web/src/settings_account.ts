...
// TODO: Move these to server_events_dispatch when it's converted to typescript.
export const privacy_settings_schema = z.enum([
...
export function update_privacy_settings_box(property: PrivacySettings): void {
    if (!overlays.settings_open()) {
        return;
    }
