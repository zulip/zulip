...
function list_resolved_topics_last(topic_names: string[]): string[] {
...
export function get_list_info(
    ...
    zoomed: boolean,
    filter_topics: (topic_names: string[]) => string[],
    {demote_resolved_topics}: {demote_resolved_topics: boolean},
): TopicListInfo {
    ...
    if (demote_resolved_topics) {
        ordered_topic_names = list_resolved_topics_last(ordered_topic_names);
    }
