...
function get_user_card_popover_data(
    ...
    const can_send_private_message =
        (previous_direct_messages_exist(user_id_string) ||
            people.user_can_initiate_direct_message_thread(user_id_string)) &&
        people.user_can_direct_message(user_id_string) &&
        is_active &&
        !is_me;
