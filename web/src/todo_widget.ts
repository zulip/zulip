...
export function activate({
    ...
    function toggle_task_edit_controls(key: string): void {
        ...
        $task_list_item.find(".todo-task-list-item-bar").toggleClass("hidden");
    ...
    function submit_task_list_item(key: string): void {
        ...
        $task_list_item
            .find(".todo-task")
            .replaceWith($(render_todo_widget_task_item(new_task_item)));
    ...
    function update_todo_widget(): void {
        ...
        switch (last_event.type) {
            case "new_task": {
                ...
                $html.find(".todo-task-list-item-bar").toggle();
