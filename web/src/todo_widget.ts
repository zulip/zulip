...
export function render({
    ...
    function start_editing_item(key: string): void {
        ...
        task_data.set_editing_item(key, $task_list_item.find(".todo-edit-task-list-item-bar"));
        toggle_task_edit_controls(key);
    }
    ...
    function render_results(): void {
        ...
        function restore_todo_item_edit_state(): void {
            ...
            for (const [key, $edit_elem] of editing_items.entries()) {
                ...
                $task_list_item.find(".todo-edit-task-list-item-bar input.add-task").val(edit_task);
                $task_list_item.find(".todo-edit-task-list-item-bar input.add-desc").val(edit_desc);
                task_data.set_editing_item(
                    key,
                    $task_list_item.find(".todo-edit-task-list-item-bar"),
                );
                toggle_task_edit_controls(key);
            }
        }
