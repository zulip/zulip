        ...
        >
                ...
                <table class="hotkeys_table table table-striped table-bordered">
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="hotkey">
                                ${$html_t(
                                    {defaultMessage: "<z-kbd-1></z-kbd-1> or <z-kbd-2></z-kbd-2>"},
                                    {
                                        ["z-kbd-1"]: () => html`<kbd>Enter</kbd>`,
                                        ["z-kbd-2"]: () => html`<kbd>R</kbd>`,
                                    },
                                )}
                            </span>
                        </td>
                        ...
                        <td>
                            <span class="hotkey">
                                ${$html_t(
                                    {defaultMessage: "<z-kbd-1></z-kbd-1> or <z-kbd-2></z-kbd-2>"},
                                    {
                                        ["z-kbd-1"]: () => html`<kbd>Esc</kbd>`,
                                        ["z-kbd-2"]: () =>
                                            html`<kbd data-mac-key="Ctrl">Ctrl</kbd> +
                                                <kbd>[</kbd>`,
                                    },
                                )}
                            </span>
                        ...
                        <td>
                            <span class="hotkey">
                                ${$html_t(
                                    {defaultMessage: "<z-kbd-1></z-kbd-1> or <z-kbd-2></z-kbd-2>"},
                                    {
                                        ["z-kbd-1"]: () => html`<kbd class="arrow-key">↓</kbd>`,
                                        ["z-kbd-2"]: () => html`<kbd>J</kbd>`,
                                    },
                                )}
                            </span>
                        </td>
                        ...
                        <td>
                            <span class="hotkey">
                                ${$html_t(
                                    {defaultMessage: "<z-kbd-1></z-kbd-1> or <z-kbd-2></z-kbd-2>"},
                                    {
                                        ["z-kbd-1"]: () => html`<kbd>End</kbd>`,
                                        ["z-kbd-2"]: () => html`<kbd>Shift</kbd> + <kbd>G</kbd>`,
                                    },
                                )}
                            </span>
                        </td>
                        ...
                        <td>
                            <span class="hotkey">
                                ${$html_t(
                                    {defaultMessage: "<z-kbd-1></z-kbd-1> or <z-kbd-2></z-kbd-2>"},
                                    {
                                        ["z-kbd-1"]: () => html`<kbd>Ctrl</kbd> + <kbd>K</kbd>`,
                                        ["z-kbd-2"]: () => html`<kbd>/</kbd>`,
                                    },
                                )}
                            </span>
                        </td>
                                    ...
                                    },
                                    {
                                        ["z-kbd-1"]: () =>
                                            html`<kbd data-mac-key="Ctrl">Ctrl</kbd> +
                                                <kbd>[</kbd>`,
                                        ["z-wrapper"]: (content) =>
                                            html`<span class="go-to-home-view-hotkey-help"
                                                >${content}</span
                                            >`,
                                        ["z-kbd-2"]: () =>
                                            html`<span class="go-to-home-view-hotkey-help"
            ...
            <div>
                <table class="hotkeys_table table table-striped table-bordered">
                    ...
                    <tr>
                        <td class="definition">${$t({defaultMessage: "Filter left sidebar"})}</td>
                        <td>
                        ...
                        <td>
                            <span class="hotkey">
                                ${$html_t(
                                    ...
                                    {
                                        ["z-kbd-1"]: () => html`<kbd>PgUp</kbd>`,
                                        ["z-kbd-2"]: () =>
                                            html`<kbd>Fn</kbd> + <kbd class="arrow-key">↑</kbd>`,
                                        ["z-kbd-3"]: () => html`<kbd>Shift</kbd> + <kbd>K</kbd>`,
                                    },
                                )}
                            </span>
                        </td>
                        ...
                        <td>
                            <span class="hotkey">
                                ${$html_t(
                                    ...
                                    {
                                        ["z-kbd-1"]: () => html`<kbd>PgDn</kbd>`,
                                        ["z-kbd-2"]: () =>
                                            html`<kbd>Fn</kbd> + <kbd class="arrow-key">↓</kbd>`,
                                        ["z-kbd-3"]: () => html`<kbd>Shift</kbd> + <kbd>J</kbd>`,
                                        ["z-kbd-4"]: () => html`<kbd>Space</kbd>`,
                                    },
                                )}
                            </span>
                        </td>
                            ...
                            <span class="hotkey">
                                ${$html_t(
                                    ...
                                    },
                                    {
                                        ...
                                        ["z-kbd-2"]: () =>
                                            html`<kbd>Fn</kbd> + <kbd class="arrow-key">→</kbd>`,
                                        ["z-kbd-3"]: () => html`<kbd>Shift</kbd> + <kbd>G</kbd>`,
                                    },
                                )}
                            </span>
                        </td>
            ...
            <div>
                <table class="hotkeys_table table table-striped table-bordered">
                    ...
                    <tr>
                        <td class="definition">
                            ${$t({defaultMessage: "Go to list of topics for the current channel"})}
                        </td>
                        <td>
                            <span class="hotkey"><kbd>Y</kbd></span>
                        </td>
                    </tr>
                    <tr>
                        <td class="definition">
                        ...
                        <td>
                            <span class="hotkey">
                                ${$html_t(
                                    {defaultMessage: "<z-kbd-1></z-kbd-1> or <z-kbd-2></z-kbd-2>"},
                                    {
                                        ["z-kbd-1"]: () => html`<kbd>Shift</kbd> + <kbd>A</kbd>`,
                                        ["z-kbd-2"]: () => html`<kbd>Shift</kbd> + <kbd>D</kbd>`,
                                    },
                                )}
                            </span>
                        </td>
            ...
            <div>
                <table class="hotkeys_table table table-striped table-bordered">
                    ...
                    <tr>
                        <td class="definition">${$t({defaultMessage: "Quote message"})}</td>
                        <td>
                            <span class="hotkey"><kbd>></kbd></span>
                        </td>
                    </tr>
                    <tr>
                        <td class="definition">${$t({defaultMessage: "Forward message"})}</td>
                        <td>
                            <span class="hotkey"><kbd>&lt;</kbd></span>
                        </td>
                        ...
                        <td>
                            <span class="hotkey">
                                ${$html_t(
                                    ...
                                    {
                                        ["z-kbd-1"]: () => html`<kbd>Tab</kbd>`,
                                        ["z-kbd-2"]: () => html`<kbd>Enter</kbd>`,
                                        ["z-kbd-3"]: () => html`<kbd>Ctrl</kbd> + <kbd>Enter</kbd>`,
                                    },
                                )}
                            </span>
                        </td>
                    ...
                    <tr>
                        <td class="definition">
                            ${$t({defaultMessage: "Use or create a saved snippet"})}
                        </td>
                        <td>
                            <span class="hotkey"><kbd>Ctrl</kbd> + <kbd>'</kbd></span>
                        </td>
            ...
            <div>
                <table class="hotkeys_table table table-striped table-bordered">
                    ...
                    <tr>
                        <td class="definition">
                            ${$t({defaultMessage: "Add emoji reaction to selected message"})}
                        </td>
                        <td>
                            <span class="hotkey"><kbd>:</kbd></span>
                        </td>
                    ...
                    <tr>
                        <td class="definition">${$t({defaultMessage: "Copy link to message"})}</td>
                        <td>
                            <span class="hotkey"><kbd>L</kbd></span>
                        </td>
                    </tr>
                </table>
            </div>
                        ...
                        <td>
                            <span class="hotkey">
                                ${$html_t(
                                    ...
                                    {
                                        ["z-kbd-1"]: () => html`<kbd class="arrow-key">↑</kbd>`,
                                        ["z-kbd-2"]: () => html`<kbd class="arrow-key">↓</kbd>`,
                                    },
                                )}
                            </span>
                        </td>
