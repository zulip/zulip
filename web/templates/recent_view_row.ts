                ...
                >
                    ${to_bool(context.is_private)
                        ? html`
                              <a
                                  href="${context.pm_url}"
                                  class="recent-view-table-link ${to_bool(context.is_group)
                                      ? "recent-view-dm-group"
                                      : "recent-view-dm"}"
                                  >${{__html: context.rendered_pm_with_html}}</a
                              >
                          `
                        : html`
                              <a
                                  class="white-space-preserve-wrap recent-view-table-link ${to_bool(
                                          ...
                                          ? html`
                                                ...
                                                >
                                                    ...
                                                    context.all_visibility_policies.FOLLOWED
                                                        ? html`
                                                              <i
                                                                  class="zulip-icon zulip-icon-follow recipient_bar_icon visibility-status-icon"
                                                                  tabindex="0"
                                                                  aria-label="${$t({
                                                                      defaultMessage:
                                                                          "Topic actions menu",
                                                        ...
                                                        : context.visibility_policy ===
                                                          ...
                                                          ? html`
                                                                <i
                                                                    class="zulip-icon zulip-icon-unmute recipient_bar_icon visibility-status-icon"
                                                                    tabindex="0"
                                                                    aria-label="${$t({
                                                                        defaultMessage:
                                                                            "Topic actions menu",
                                                          ...
                                                          : context.visibility_policy ===
                                                            ...
                                                            ? html`
                                                                  <i
                                                                      class="zulip-icon zulip-icon-mute recipient_bar_icon visibility-status-icon"
                                                                      tabindex="0"
                                                                      aria-label="${$t({
                                                                          defaultMessage:
                                                                              "Topic actions menu",
                                                            ...
                                                            : html`
                                                                  <i
                                                                      class="zulip-icon zulip-icon-more-vertical recent-view-row-topic-menu visibility-status-icon"
                                                                      tabindex="0"
                                                                      aria-label="${$t({
                                                                          defaultMessage:
                                                                              "Topic actions menu",
