            ...
            <div id="user-list">
                        ...
                        __html: render_input_wrapper(
                            {
                                ...
                                icon: "search",
                                id: "userlist-header-search",
                                input_type: "filter-input",
                            },
                            () => html`
                                <input
                                    type="text"
                                    class="input-element user-list-filter home-page-input"
                                    autocomplete="off"
                ...
                >
                    ...
                    <div class="invite-user-shortcut">
                        <a
                            class="invite-user-link right-sidebar-wrappable-text-container"
                            role="button"
                        >
                            <span class="right-sidebar-wrappable-text-inner">
                                ${$t({defaultMessage: "Invite to organization"})}
                            </span>
                        </a>
                    </div>
                </div>
