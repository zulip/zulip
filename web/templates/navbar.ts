    ...
    const out = html`<div class="header">
        <nav class="header-main" id="top_navbar">
            <div class="column-left">
                <a
                    class="header-button left-sidebar-toggle-button ${to_bool(context.embedded)
            ...
            <div class="column-right">
                ...
                <div
                    id="gear-menu"
                    class="${to_bool(context.embedded)
                ...
                <div id="personal-menu" class="hidden-for-spectators navbar-item">
                    ...
                    >
                        <div class="header-button-avatar">
                            <img class="header-button-avatar-image" src="${context.user_avatar}" />
                        </div>
                    </a>
                </div>
                <div
                ...
                >
                    <a
                        id="login_button"
                        class="header-button login_button navbar-item"
                        tabindex="0"
                    >
                ...
                <div id="userlist-toggle" class="hidden-for-spectators">
                    <a
                        id="userlist-toggle-button"
                        role="button"
                        class="header-button navbar-item"
                        tabindex="0"
                    >
