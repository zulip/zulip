                ...
                <form id="send_message_form" action="/json/messages" method="post">
                    <div class="compose_table">
                            ...
                            <div id="compose-recipient" class="low-attention-recipient-row">
                                ...
                                <div id="compose_recipient_box">
                                    ...
                                    <button
                                        ...
                                        class="compose-new-recipient-button"
                                        tabindex="-1"
                                    >
                                ...
                                >
                                    <div class="pill-container">
                                        ...
                                        <button
                                            type="button"
                                            id="compose-new-direct-recipient-button"
                                            class="compose-new-recipient-button tippy-zulip-delayed-tooltip"
                        ...
                        <div class="messagebox">
                            ...
                            >
                                <textarea
                                    class="new_message_textarea message-textarea"
                                    name="content"
                                    id="compose-textarea"
                                    placeholder="${$t({
                            ...
                            <div id="message-send-controls-container">
                                ...
                                <span
                                    id="compose-limit-indicator"
                                    class="message-limit-indicator"
                                ></span>
                            ...
                            <div
                                id="message-formatting-controls-container"
                                class="compose-scrolling-buttons-container"
                            >
