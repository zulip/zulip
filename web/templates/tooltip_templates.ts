...
export default function render_tooltip_templates() {
    const out = html`<template id="view-user-card-tooltip-template">
        ...
        <template id="new_message_button_tooltip_template">
            ${$t({defaultMessage: "New message"})} ${tooltip_hotkey_hints("C")}
        </template>
        ...
        <template id="preview-tooltip">
            ${$t({defaultMessage: "Preview mode"})} ${tooltip_hotkey_hints("Alt", "P")}
        </template>
        <template id="exit-preview-tooltip">
            ${$t({defaultMessage: "Exit preview mode"})} ${tooltip_hotkey_hints("Alt", "P")}
        </template>
        ...
        <template id="add-todo-tooltip">
            <div>
                <span>${$t({defaultMessage: "Add to-do list"})}</span><br />
                <span class="tooltip-inner-content italic"
                    >${$t({defaultMessage: "A to-do list must be an entire message."})}</span
                >
            </div>
        </template>
        <template id="add-saved-snippet-tooltip">
            ${$t({defaultMessage: "Add saved snippet"})} ${tooltip_hotkey_hints("Ctrl", "'")}
        </template>
        ...
        <template id="code-tooltip">
            ${$t({defaultMessage: "Code"})} ${tooltip_hotkey_hints("Ctrl", "Shift", "C")}
        </template>
        ...
        <template id="all-message-tooltip-template">
            <div class="views-tooltip-container" data-view-code="all_messages">
                ...
                <div
                    class="tootlip-inner-content views-message-count italic hidden-for-spectators"
                ></div>
        ...
        <template id="recent-conversations-tooltip-template">
            <div class="views-tooltip-container" data-view-code="recent_topics">
                ...
                ></div>
                <div
                    class="tooltip-inner-content views-tooltip-home-view-note italic hide hidden-for-spectators"
                >
                    ${$t({defaultMessage: "This is your home view."})}
                </div>
            </div>
        ...
        <template id="drafts-tooltip-template">
            <div class="views-tooltip-container" data-view-code="drafts">
                <div>${$t({defaultMessage: "Drafts"})}</div>
                <div class="tootlip-inner-content views-message-count italic"></div>
            </div>
        ...
        <template id="mentions-tooltip-template">
            <div class="views-tooltip-container" data-view-code="mentions">
                <div>${$t({defaultMessage: "Mentions"})}</div>
                <div class="tootlip-inner-content views-message-count italic"></div>
            </div>
        </template>
        ...
        <template id="delete-reminder-tooltip-template">
            ${$t({defaultMessage: "Delete reminder"})} ${tooltip_hotkey_hints("Backspace")}
        </template>
        ...
        <template id="color-picker-confirm-button-tooltip-template">
            ${$t({defaultMessage: "Confirm new color"})}
        </template>
        <template id="save-button-tooltip-template"> ${$t({defaultMessage: "Save"})} </template>
        <template id="cancel-button-tooltip-template"> ${$t({defaultMessage: "Cancel"})} </template>
        <template id="filter-left-sidebar-tooltip-template">
            ${$t({defaultMessage: "Filter left sidebar"})} ${tooltip_hotkey_hints("Q")}
        </template>
        <template id="inbox-channel-mute-toggle-tooltip-template">
            <div>
                <div>${$t({defaultMessage: "You have muted this channel."})}</div>
                <div class="italic">${$t({defaultMessage: "Click to unmute this channel."})}</div>
            </div>
        </template> `;
    return to_html(out);
}
