    ...
    >
        ...
        <ul role="menu" class="popover-menu-list">
            <li role="none">
                ...
                >
                    ${to_array(context.stream_color_palette).map((colors, colors_index) =>
                        to_array(colors).map(
                            (color, color_index) => html`
                                <input
                                    type="radio"
                                    id="color-${color}"
                                    ...
                                    ${color === context.stream_color ? "checked" : ""}
                                />
                                <label
                                    role="menuitemradio"
                                    ...
                                    data-swatch-color="${color}"
                                    data-row="${colors_index}"
                                    data-column="${color_index}"
                                    tabindex="0"
                                ></label>
                            `,
                        ),
