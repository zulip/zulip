...
export default function render_user_card_popover(context) {
    ...
    >
        <div class="popover-menu-user-header">
            <div
                class="popover-menu-user-avatar-container ${!to_bool(context.is_active)
                    ? "deactivated"
                    : ""}"
            >
                <img
                ...
                ${to_bool(context.is_active) && !to_bool(context.is_bot)
                    ? html`
                          <div
                              class="popover-menu-user-presence user-circle zulip-icon zulip-icon-${context.user_circle_class} ${context.user_circle_class} hidden-for-spectators"
                    ...
                    ? html`
                          <span
                              class="popover-menu-user-presence conversation-partners-icon fa fa-ban fa-lg deactivated-user-icon user_circle"
                          ></span>
                      `
                    : ""}
            </div>
            <div class="popover-menu-user-info">
                <div
                    class="popover-menu-user-full-name text-select"
                      ...
                      >
                          ...
                          >
                              ...
                              ${to_bool(context.is_sender_popover)
                                  ? html` ${popover_hotkey_hints("Shift", "R")} `
                                  : ""}
                          </a>
                      </li>
                  `
