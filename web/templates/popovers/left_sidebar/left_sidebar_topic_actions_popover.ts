...
export default function render_left_sidebar_topic_actions_popover(context) {
    const out = html`<div
        class="popover-menu no-auto-hide-left-sidebar-overlay"
    ...
    >
        <ul role="menu" class="popover-menu-list">
            <li role="none" class="popover-topic-header text-item popover-menu-list-item">
                <span
                    class="popover-topic-name ${to_bool(context.is_empty_string_topic)
                        ? "empty-topic-display"
                        : ""}"
                    ...
                    ? html`
                          ...
                          <li role="none" class="popover-menu-list-item">
                              ...
                              >
                                  ...
                                  >
                                      <i
                                          class="zulip-icon zulip-icon-inherit"
                                          aria-hidden="true"
                                      ></i>
                                  </label>
                                  ${to_bool(context.stream_muted) || to_bool(context.topic_unmuted)
                                      ? html`
                                            ...
                                            >
                                                <i
                                                    class="zulip-icon zulip-icon-unmute"
                                                    aria-hidden="true"
                                                ></i>
                                            </label>
                                        `
                                  ...
                                  >
                                      <i
                                          class="zulip-icon zulip-icon-follow"
                                          aria-hidden="true"
                                      ></i>
                                  </label>
                      ...
                      `
                    : ""
                : ""}${to_bool(context.is_topic_empty)
                ? html`
                      <li role="separator" class="popover-menu-separator"></li>
                      <li role="none" class="popover-menu-list-item text-item italic">
                          <span class="popover-menu-label"
                              >${$t({defaultMessage: "There are no messages in this topic."})}</span
                          >
                      </li>
                  `
                : /* Group 2 */ html` <li role="separator" class="popover-menu-separator"></li>
                      ${to_bool(context.show_ai_features) && to_bool(context.can_summarize_topics)
                          ? html`
                                <li role="none" class="link-item popover-menu-list-item">
                                    <a
                                        role="menuitem"
                                        class="sidebar-popover-summarize-topic popover-menu-link"
                                        tabindex="0"
                                    >
                                        <i
                                            class="popover-menu-icon fa fa-magic"
                                            aria-hidden="true"
                                        ></i>
                                        <span class="popover-menu-label"
                                            >${$t({
                                                defaultMessage: "Summarize recent messages",
                                            })}</span
                                        >
                                    </a>
                                </li>
                          ...
                          ? html`
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <span class="popover-menu-label"
                                            >${$t({
                                                defaultMessage: "Unstar all messages in topic",
                                            })}</span
                                        >
                                    </a>
                                </li>
                          ...
                          : html`
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <span class="popover-menu-label"
                                            >${$t({
                                                defaultMessage: "Mark all messages as unread",
                                            })}</span
                                        >
                                    </a>
                                </li>
                      ...
                      to_bool(context.is_realm_admin)
                          ...
                          : to_bool(context.can_rename_topic)
                            ? html`
                              ...
                              `
                            : ""}${to_bool(context.can_resolve_topic) &&
