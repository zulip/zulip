        ...
        >
            ...
            ${to_bool(context.has_unread_messages)
                ? html`
                      ...
                      >
                          <a
                              role="menuitem"
                              class="mark_stream_as_read popover-menu-link"
                              tabindex="0"
                          >
                              <i
                ...
                : html`
                      ...
                      >
                          <a
                              role="menuitem"
                              class="mark_stream_as_unread popover-menu-link"
                              tabindex="0"
                          >
                              <i
                ...
                ? html`
                  ...
                  `
                : ""}${to_bool(context.show_go_to_list_of_topics)
                ? html`
                      <li role="none" class="link-item popover-menu-list-item">
                          <a
                              role="menuitem"
                              href="${context.stream.list_of_topics_view_url}"
                              class="stream-popover-go-to-list-of-topics navigate-link-on-enter popover-menu-link"
                              tabindex="0"
                          >
                              <i
                                  class="popover-menu-icon zulip-icon zulip-icon-topic-list"
                                  aria-hidden="true"
                              ></i>
                              <span class="popover-menu-label"
                                  >${$t({defaultMessage: "Go to list of topics"})}</span
                              >
            ...
            <li role="none" class="link-item popover-menu-list-item hidden-for-spectators">
                <a
                    ...
                    class="open_stream_settings popover-menu-link"
                    tabindex="0"
                >
            ...
            <li role="none" class="link-item popover-menu-list-item hidden-for-spectators">
                <a role="menuitem" class="toggle_stream_muted popover-menu-link" tabindex="0">
                    ${to_bool(context.stream.is_muted)
                        ? html`
                              <i
                                  class="popover-menu-icon zulip-icon zulip-icon-unmute"
                                  aria-hidden="true"
                              ></i>
                              <span class="popover-menu-label"
                        ...
                        : html`
                              <i
                                  class="popover-menu-icon zulip-icon zulip-icon-mute"
                                  aria-hidden="true"
                              ></i>
                              <span class="popover-menu-label"
            ...
            ${!to_bool(context.stream.is_archived)
                ? html`
                      ...
                      >
                          <a
                              role="menuitem"
                              class="popover_sub_unsub_button popover-menu-link"
                              tabindex="0"
                          >
                              <i
                              ...
                              ></i>
                              <span class="popover-menu-label"
                                  >${$t({defaultMessage: "Unsubscribe"})}</span
                              >
                          </a>
                      </li>
                      <li
                      ...
                      >
                          <a
                              role="menuitem"
                              class="choose_stream_color popover-menu-link"
                              data-stream-id="${context.stream.stream_id}"
                              tabindex="0"
                          >
                              <i
