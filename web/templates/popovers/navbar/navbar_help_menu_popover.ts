    ...
    >
        <ul role="menu" class="popover-menu-list">
            ...
            ${to_bool(context.corporate_enabled)
                ? html` <li role="none" class="link-item popover-menu-list-item">
                          <a
                              role="menuitem"
                      ...
                      ${to_bool(context.is_admin) || to_bool(context.is_owner)
                          ? html`
                                <li role="none" class="link-item popover-menu-list-item">
                                    <a
                                        role="menuitem"
                                    ...
                                    >
                                        <i
                                            class="popover-menu-icon zulip-icon zulip-icon-handshake"
                                            aria-hidden="true"
                                        ></i>
                                        <span class="popover-menu-label"
                                            >${$t({defaultMessage: "Contact sales"})}</span
                                        >
                                    </a>
                                </li>
                            `
