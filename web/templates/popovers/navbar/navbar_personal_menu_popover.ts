            ...
            <header class="personal-menu-header">
                <div class="avatar">
                    ...
                    ${to_bool(context.is_active)
                        ? html`
                              <span
                                  class="status-circle zulip-icon zulip-icon-${context.user_circle_class} ${context.user_circle_class} user-circle hidden-for-spectators"
                ...
                <ul role="menu" class="popover-menu-list">
                    ...
                    <li role="none" class="link-item popover-menu-list-item">
                        <a
                            ...
                            tabindex="0"
                            class="view_full_user_profile popover-menu-link navigate-link-on-enter"
                        >
                            <i
