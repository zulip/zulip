...
import render_info_density_control_button_group from "../../settings/info_density_control_button_group.ts";
...
export default function render_navbar_gear_menu_popover(context) {
    ...
    >
            ...
            ${to_bool(context.is_self_hosted)
                ...
                : html`
                      <div class="org-info org-plan hidden-for-spectators">
                          ${to_bool(context.is_demo_organization)
                              ? html`
                                    <a
                                        ...
                                        rel="noopener noreferrer"
                                        class="navigate-link-on-enter popover-menu-link"
                                        >${$t({defaultMessage: "Demo organization"})}</a
                                    >
                                `
            ...
            !to_bool(context.is_plan_standard_sponsored_for_free)
                ? to_bool(context.sponsorship_pending)
                    ? html`
                      ...
                      `
                    : html`${to_bool(context.is_demo_organization) && to_bool(context.is_owner)
                          ? html`
                                <div class="org-info org-upgrade">
                                    <a class="convert-demo-organization popover-menu-link"
                                        >${$t({
                                            defaultMessage: "Convert into permanent organization",
                                        })}</a
                                    >
                                </div>
                            `
        ...
        <ul role="menu" class="popover-menu-list">
                ...
                <div class="info-density-controls">
                    ${{
                        __html: render_info_density_control_button_group({
                            ...
                            property_value: context.web_font_size_px,
                    ...
                    ${{
                        __html: render_info_density_control_button_group({
                            prefix: "gear_menu_",
                            for_settings_ui: false,
                            property_value: context.web_line_height_percent,
            ...
            ${to_bool(context.user_has_billing_access) && to_bool(context.show_billing)
                ? html`
                      <li role="none" class="link-item popover-menu-list-item">
                          <a
                              role="menuitem"
                ...
                ? html`
                  ...
                  `
                : ""}${to_bool(context.user_has_billing_access)
                ? html`${to_bool(context.show_remote_billing)
                      ? html`
                            <li role="none" class="link-item popover-menu-list-item">
                                <a
                                    role="menuitem"
