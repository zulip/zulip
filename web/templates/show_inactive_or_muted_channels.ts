...
export default function render_show_inactive_or_muted_channels(context) {
    const out = html`<div
        class="stream-list-toggle-inactive-or-muted-channels bottom_left_row zoom-in-hide"
    >
