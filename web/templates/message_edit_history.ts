                ...
                >
                    ...
                    >
                        ${to_bool(message.is_stream)
                            ? html`
                                  <div
                                      class="message_header message_header_stream overlay-message-header"
                                  >
                                      <div
                        ...
                        >
                            <div class="messagebox">
                                <div class="messagebox-content">
                                    ${to_bool(message.initial_entry_for_move_history)
                                        ? html`
                                              <div
                                              ...
                                              >
                                                  ...
                                                  <p>
                                                      ...
                                                      <span
                                                          class="highlight_text_inserted ${to_bool(
                                                              message.is_empty_string_new_topic,
                                                          )
                                                              ? "empty-topic-display"
                                                              : ""}"
                                                          >${message.new_topic_display_name}</span
                                                      >
                                                  </p>
                                              </div>
                                          `
                                        : html`${to_bool(message.stream_changed)
                                              ? html`
                                                    <div
                                                        class="message_content message_edit_history_content"
                                                    >
                                              ...
                                              ? html`
                                                    ...
                                                    >
                                                        <p>
                                                            ...
                                                            >
                                                            <span
                                                                class="highlight_text_deleted ${to_bool(
                                                                    message.is_empty_string_prev_topic,
                                                                )
                                                                    ? "empty-topic-display"
                                                                    : ""}"
                                                                >${message.prev_topic_display_name}</span
                                                            >
                                                        </p>
                                                    </div>
                                                `
