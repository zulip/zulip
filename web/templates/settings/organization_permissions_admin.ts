import {or, to_array, to_bool} from "../../src/hbs_compat.ts";
        ...
        <form class="admin-realm-form org-permissions-form">
            <div id="org-join-settings" class="settings-subsection-parent">
                ...
                <div class="m-10 inline-block organization-permissions-parent">
                    <div
                        id="realm_invite_required_container"
                    ...
                    >
                        ${{
                            __html: render_settings_checkbox({
                                label: context.admin_settings_label.realm_invite_required,
                                is_disabled: !to_bool(context.user_has_email_set),
                                is_checked: context.realm_invite_required,
                                prefix: "id_",
                    ...
                    ${{
                        __html: render_group_setting_value_pill_input({
                            label: context.group_setting_labels.can_invite_users_group,
                            setting_name: "realm_can_invite_users_group",
                        }),
                    }}
                    ${{
                        __html: render_group_setting_value_pill_input({
                            label: context.group_setting_labels.create_multiuse_invite_group,
            ...
            <div id="org-stream-permissions" class="settings-subsection-parent">
                ...
                <div class="m-10 organization-permissions-parent">
                    ${{
                        __html: render_group_setting_value_pill_input({
                            label: context.group_setting_labels.can_create_public_channel_group,
                    ...
                    ${{
                        __html: render_dropdown_widget_with_label({
                            value_type: "number",
                            label: context.group_setting_labels.can_create_web_public_channel_group,
                            widget_name: "realm_can_create_web_public_channel_group",
                        }),
                    }}
                    ${{
                        __html: render_group_setting_value_pill_input({
                            label: context.group_setting_labels.can_create_private_channel_group,
                    ...
                    ${{
                        __html: render_group_setting_value_pill_input({
                            ...
                            label: context.group_setting_labels.can_mention_many_users_group,
                    ...
                    ${{
                        __html: render_group_setting_value_pill_input({
                            ...
                            label: context.group_setting_labels.can_set_topics_policy_group,
            ...
            <div id="org-group-permissions" class="settings-subsection-parent">
                ...
                <div class="m-10 organization-permissions-parent">
                    ${{
                        __html: render_group_setting_value_pill_input({
                            label: context.group_setting_labels.can_manage_all_groups,
                    ...
                    ${{
                        __html: render_group_setting_value_pill_input({
                            label: context.group_setting_labels.can_create_groups,
            ...
            <div id="org-direct-message-permissions" class="settings-subsection-parent">
                ...
                ${{
                    __html: render_group_setting_value_pill_input({
                        label: context.group_setting_labels.direct_message_permission_group,
                        setting_name: "realm_direct_message_permission_group",
                    }),
                }}
                ${{
                    __html: render_group_setting_value_pill_input({
                        label: context.group_setting_labels.direct_message_initiator_group,
            ...
            <div id="org-msg-editing" class="settings-subsection-parent">
                ...
                <div class="inline-block organization-settings-parent">
                    ...
                    <div class="input-group">
                        <label
                            for="id_realm_message_edit_history_visibility_policy"
                            class="settings-field-label"
                            >${$t({
                                defaultMessage: "Allow viewing the history of a message?",
                            })}</label
                        >
                        <select
                            name="realm_message_edit_history_visibility_policy"
                            id="id_realm_message_edit_history_visibility_policy"
                            class="prop-element settings_select bootstrap-focus-style"
                            data-setting-widget-type="string"
                        >
                            ${{
                                __html: render_dropdown_options_widget({
                                    option_values:
                                        context.message_edit_history_visibility_policy_values,
                                }),
                            }}
                        </select>
                    </div>
                                ...
                                ${$t(
                                    ...
                                    },
                                    {
                                        realm_message_content_edit_limit_minutes:
                                            context.realm_message_content_edit_limit_minutes,
                                    },
                                )}
                            </span>
                        </div>
            ...
            <div id="org-moving-msgs" class="settings-subsection-parent">
                ...
                ${{
                    __html: render_group_setting_value_pill_input({
                        label: context.group_setting_labels.can_move_messages_between_topics_group,
                            ...
                            ${$t(
                                ...
                                },
                                {
                                    realm_move_messages_within_stream_limit_minutes:
                                        context.realm_move_messages_within_stream_limit_minutes,
                                },
                            )}
                        </span>
                    </div>
                ...
                ${{
                    __html: render_group_setting_value_pill_input({
                        label: context.group_setting_labels
                            ...
                            ${$t(
                                ...
                                },
                                {
                                    realm_move_messages_between_streams_limit_minutes:
                                        context.realm_move_messages_between_streams_limit_minutes,
                                },
                            )}
                        </span>
                    </div>
            ...
            <div id="org-msg-deletion" class="settings-subsection-parent">
                ...
                <div class="inline-block organization-settings-parent">
                                ...
                                >${$t(
                                    ...
                                    },
                                    {
                                        realm_message_content_delete_limit_minutes:
                                            context.realm_message_content_delete_limit_minutes,
                                    },
                                )}</span
                            >
                        </div>
                    ...
                    ${{
                        __html: render_group_setting_value_pill_input({
                            label: context.group_setting_labels.can_set_delete_message_policy_group,
            ...
            <div id="org-user-identity" class="settings-subsection-parent">
                ...
                <div class="inline-block organization-permissions-parent">
                    ...
                    ${{
                        __html: render_settings_checkbox({
                            is_disabled: context.server_name_changes_disabled,
                            label: context.admin_settings_label.realm_name_changes_disabled,
                            is_checked: or(
                                context.realm_name_changes_disabled,
                                context.server_name_changes_disabled,
                            ),
                            prefix: "id_",
                    ...
                    ${{
                        __html: render_settings_checkbox({
                            is_disabled: context.server_avatar_changes_disabled,
                            label: context.admin_settings_label.realm_avatar_changes_disabled,
                            is_checked: or(
                                context.realm_avatar_changes_disabled,
                                context.server_avatar_changes_disabled,
                            ),
                            prefix: "id_",
            ...
            <div id="org-guest-settings" class="settings-subsection-parent">
                ...
                <div class="inline-block organization-permissions-parent">
                    ...
                    ${{
                        __html: render_settings_checkbox({
                            label: context.admin_settings_label.realm_enable_guest_user_dm_warning,
                            is_checked: context.realm_enable_guest_user_dm_warning,
                            prefix: "id_",
                    ...
                    ${{
                        __html: render_dropdown_widget_with_label({
                            ...
                            value_type: "number",
                            label: context.group_setting_labels.can_access_all_users_group,
            ...
            <div id="org-other-permissions" class="settings-subsection-parent">
                ...
                <div class="m-10 inline-block organization-permissions-parent">
                    ${to_bool(context.is_plan_self_hosted)
                        ? html` ${{
                              __html: render_group_setting_value_pill_input({
                                  help_link: "https://zulip.com//help/self-hosted-billing",
                                  label: context.group_setting_labels.can_manage_billing_group,
                    ...
                    <div
                        class="disabled-unfinished-feature"
                        ${!to_bool(context.server_can_summarize_topics)
                    ...
                    >
                        ...
                        ${{
                            __html: render_group_setting_value_pill_input({
                                label: context.group_setting_labels.can_summarize_topics_group,
                    ...
                    ${{
                        __html: render_group_setting_value_pill_input({
                            label: context.group_setting_labels.can_create_write_only_bots_group,
                            setting_name: "realm_can_create_write_only_bots_group",
                        }),
                    }}
                    ${{
                        __html: render_group_setting_value_pill_input({
                            label: context.group_setting_labels.can_create_bots_group,
                            setting_name: "realm_can_create_bots_group",
                        }),
                    }}
                    ${{
                        __html: render_group_setting_value_pill_input({
                            label: context.group_setting_labels.can_add_custom_emoji_group,
