...
export default function render_admin_invites_list(context) {
    const out = ((invite) =>
        html`<tr
            ...
            data-is-multiuse="${!to_bool(invite.is_multiuse) ? "false" : "true"}"
        >
            <td>
            ...
            <td class="actions">
                ${{
                    __html: render_icon_button({
                        disabled: invite.disable_buttons,
                        ["data-tippy-content"]: $t({defaultMessage: "Revoke"}),
                    ...
                    ? html` ${{
                      ...
                      ${{
                          __html: render_icon_button({
                              disabled: invite.disable_buttons,
                              ["data-tippy-content"]: $t({defaultMessage: "Resend"}),
