...
export default function render_preferences_emoji(context) {
    ...
    >
        ...
        <div class="input-group">
            ...
            <div
                class="emojiset_choices settings-highlight-box prop-element"
                ...
                ${to_array(context.settings_object.emojiset_choices).map(
                    (emojiset) => html`
                        <label class="preferences-radio-choice-label">
                            ...
                            <span class="right">
                                ${emojiset.key === "text"
                                    ? html` <span class="emoji_alt_code">&nbsp;:relaxed:</span> `
                                    : html`
                                          <img
                                              class="emoji"
                                              src="/static/generated/emoji/images-${emojiset.key}-64/1f604.png"
                                          />
                                          <img
                                              class="emoji"
