...
export default function render_settings_checkbox(context) {
    const out =
        context.render_only !== false
            ? html`<div
                  class="input-group settings-checkbox-wrapper ${to_bool(context.is_disabled)
                      ? "control-label-disabled"
                      : ""}${to_bool(context.tooltip_message) ? " tippy-zulip-tooltip" : ""}"
                  ${to_bool(context.tooltip_message)
                      ? html` data-tippy-content="${context.tooltip_message}"`
                      : ""}
              >
                  ...
                  >
                      ...
                      ${to_bool(context.label_parens_text)
                          ...
                          : ""}${to_bool(context.help_icon_tooltip_text)
                          ? html`
                                <i
                                    ...
                                    ${to_bool(context.hide_tooltip)
                                        ...
                                        : ""}
                                    data-tippy-content="${context.help_icon_tooltip_text}"
                                ></i>
                            `
                          : ""}
                  </label>
