...
_properties = {
    ...
    Confirmation.REALM_CREATION: ConfirmationType(
        "create_realm", validity_in_days=settings.REALM_CREATION_LINK_VALIDITY_DAYS
    ),
    Confirmation.REALM_ACTIVATION: ConfirmationType("get_prereg_key_and_redirect"),
