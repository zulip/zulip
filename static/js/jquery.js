...
// Pass this if window is not defined yet
    ...
    jQuery.extend({
        ...
        isPlainObject: function (obj) {
            ...
            // Objects with prototype are plain if they were constructed by global Object function
...
(function (window) {
    ...
    const funescape = function (_, escaped, escapedWhitespace) {
        ...
        const x = high;
        return x !== high || escapedWhitespace ?
            escaped :
            high < 0 ?
            // BMP codepoint
                String.fromCharCode(high + 0x10000) :
            // Supplemental Plane codepoint (surrogate pair)
                String.fromCharCode(high >> 10 | 0xD800, high & 0x3FF | 0xDC00); //eslint-disable-line no-bitwise
    };
