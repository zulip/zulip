...
function triage_stream(left_panel_params, sub) {
    ...
    if (left_panel_params.unsubscribed_only && sub.subscribed) {
...
// LeftPanelParams { input: String, subscribed_only: Boolean, unsubscribed_only: Boolean, sort_order: String }
