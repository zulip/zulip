...
function init_email_tooltip(user) {
    ...
    */
    ...
    $(".user_popover_email .nowrap").each(function () {
...
function render_user_info_popover(
    ...
    const $popover_title = $(render_user_info_popover_title(popover_args));
    ...
    const $user_name_element = $popover_title.find(".user-info-popover-header__full-name");
    const $bot_owner_element = $popover_title.find(".bot_owner");
...
export function register_click_handlers() {
    ...
    $("body").on("click", ".popover-lists__text-item", (e) => {
        e.preventDefault();
        e.stopPropagation();
    });

    $("body").on("click", ".user-info-popover-header", (e) => {
        e.preventDefault();
        e.stopPropagation();
    });
}
