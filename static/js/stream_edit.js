...
exports.initialize = function () {
    ...
    $("#subscriptions_table").on("click", ".change-stream-privacy", function (e) {
        ...
        var template_data = {
            ...
            is_public: !stream.can_make_public,
            is_private: stream.can_make_public && !stream.history_public_to_subscribers,
            is_private_with_public_history: (stream.can_make_public &&
