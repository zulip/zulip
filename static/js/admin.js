...
exports.build_page = function () {
    var options = {
        ...
        realm_default_twenty_four_hour_time: settings_display.twenty_four_hour_time_values,
    ...
    $("#id_realm_default_twenty_four_hour_time").val(JSON.stringify(page_params.realm_default_twenty_four_hour_time));
