...
function message_hover(message_row) {
    ...
    if ((message_edit.get_editability(message) === message_edit.editability_types.FULL) &&
        ...
        message_row.find(".edit_content").html('<i class="icon-vector-pencil edit_content_button" title="Edit"></i>');
    } else {
        message_row.find(".edit_content").html('<i class="icon-vector-file-text-alt edit_content_button" title="Edit" data-msgid="' + id + '"></i>');
    }
}
