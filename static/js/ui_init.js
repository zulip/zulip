(function () {
    ...
    exports.initialize_kitchen_sink_stuff = function () {
        ...
        $('#streams_header h4').tooltip({
            placement: 'right',
            animation: false
        });

        $('#streams_header i[data-toggle="tooltip"]').tooltip({
            placement: 'left',
            animation: false
        });

        $('#userlist-header #userlist-title').tooltip({
            placement: 'right',
            animation: false
        });

        $('#userlist-header #user_filter_icon').tooltip({
            placement: 'left',
            animation: false
        });
        ...
        $('#left_bar_compose_reply_button_big').tooltip({
            placement: 'top',
            animation: false
        });
        $('#left_bar_compose_private_button_big').tooltip({
            placement: 'top',
            animation: false
        });
        $('#left_bar_compose_stream_button_big').tooltip({
            placement: 'top',
            animation: false
        });
        $('#left_bar_compose_draft_button_big').tooltip({
            placement: 'top',
            animation: false
        });
        $('#user-presence-right-menu-link').tooltip({
            placement: 'right',
            animation: false
        });
        $('#search-big-icon').tooltip({
            placement: 'bottom',
            animation: false
        });
        ...
        $('#top-left-messages').tooltip({
            placement: 'bottom',
            animation: false
        });
        $('#top-left-private-message-filter').tooltip({
            placement: 'bottom',
            animation: false
        });
        $('#message-label-clickable').tooltip({
            placement: 'bottom',
            animation: false
        });
