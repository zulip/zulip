...
import * as info_overlay_reminder from "./info_overlay_reminder";
...
export function initialize() {
    ...
    // REMINDER
    $("body").on("click", ".reminder-notifications-left-sidebar", (e) => {
        info_overlay_reminder.show(muted_topics_ui.get_all_muted_topics());
    });
