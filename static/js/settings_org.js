...
function _set_up() {
    ...
    var property_types = {
        ...
        settings: {
            ...
            allow_message_deleting_by_admin: {
                type: 'bool',
                checked_msg: i18n.t("Administrators can delete any messages!"),
                unchecked_msg: i18n.t("Administrators can no longer delete their messages!"),
            },
