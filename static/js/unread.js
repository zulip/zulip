...
exports.unread_alert_counter = make_id_set();
exports.unread_stream_push_counter = make_id_set();
...
exports.process_loaded_messages = function (messages) {
    _.each(messages, function (message) {
        ...
        if (message.type === 'stream') {
            ...
            if (stream_name) {
                if (stream_data.receives_push_notifications(stream_name)) {
                    exports.unread_stream_push_counter.add(message.id);
                }
            }
        }
        ...
        if (message.alerted) {
            exports.unread_alert_counter.add(message.id);
        }
...
exports.mark_as_read = function (message_id) {
    ...
    exports.unread_alert_counter.del(message_id);
    exports.unread_stream_push_counter.del(message_id);
...
exports.declare_bankruptcy = function () {
    ...
    exports.unread_alert_counter.clear();
    exports.unread_stream_push_counter.clear();
...
exports.get_counts = function () {
    ...
    res.alert_word_message_count = exports.unread_alert_counter.count();
    res.stream_push_notify_count = exports.unread_stream_push_counter.count();
