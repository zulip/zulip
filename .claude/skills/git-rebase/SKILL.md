---
name: git-rebase
description: "Squash fixups into earlier commits, reorder commits, or reword commit messages without an interactive editor. Use when a commit that is not at HEAD needs to change."
---
