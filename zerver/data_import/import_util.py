...
def measure_content_max_lenghts_for_a_quote_and_reply(
    ...
    """
    This algorithm maximizes for reply content length.
    """
    min_quoted_content_length = template_syntax_buffer + quoted_content_length_limit

    if max_message_length <= min_quoted_content_length + reply_content_length:
        max_reply_content_length = reply_content_length
        max_quoted_content_length = max_message_length - max_reply_content_length
    else:
        max_reply_content_length = max_message_length - min_quoted_content_length
        max_quoted_content_length = min_quoted_content_length

    return MaxContentLengths(
        reply_content=max_reply_content_length, quoted_content=max_quoted_content_length
    )
