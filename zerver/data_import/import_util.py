...
def get_length_measurements_for_a_quote_and_reply(
    ...
    quoted_content_length_buffer: int = 1000,
) -> MaxContentLengths:
    ...
    if reply_content_length <= available_length - quoted_content_length_buffer:
        ...
        return MaxContentLengths(
            reply_content=available_length - quoted_content_length_buffer,
            quoted_content=quoted_content_length_buffer,
        )
