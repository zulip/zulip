...
def process_message_attachments(
    ...
    for attachment in attachments:
        ...
        markdown_links.append(attachment_result.markdown_link)
        ...
        attachment_out_path = os.path.join(output_dir, "uploads", attachment_result.path)
...
def do_convert_data(mattermost_data_dir: str, output_dir: str, masking_content: bool) -> None:
    ...
    for team in mattermost_data["team"]:
        ...
        upload_records: list[ZerverFieldsT] = [asdict(upload) for upload in uploads_list]
        create_converted_data_files(upload_records, realm_output_dir, "/uploads/records.json")
