...
def process_message_attachment(
    ...
    uploads_list.append(
        UploadRecordData(
            ...
            path=attachment_result.path,
            realm_id=realm_id,
            s3_path=attachment_result.path,
            size=fileinfo["size"],
...
def do_convert_data(rocketchat_data_dir: str, output_dir: str) -> None:
    ...
    upload_records = [asdict(upload) for upload in uploads_list]
