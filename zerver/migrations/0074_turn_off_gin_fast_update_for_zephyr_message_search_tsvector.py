...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.execute("ALTER INDEX zephyr_message_search_tsvector SET (fastupdate = OFF)")

    def backwards(self, orm):
        db.execute("ALTER INDEX zephyr_message_search_tsvector SET (fastupdate = ON)")
    ...
    models = {
        ...
        u'zerver.stream': {
            ...
            'email_token': ('django.db.models.fields.CharField', [], {'default': "'4b66488d4f9e60aa68267e95e0e6db79'", 'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
