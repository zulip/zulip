...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PushDeviceToken.ios_app_id'
        db.add_column(u'zerver_pushdevicetoken', 'ios_app_id',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=True)


    def backwards(self, orm):
        # Deleting field 'PushDeviceToken.ios_app_id'
        db.delete_column(u'zerver_pushdevicetoken', 'ios_app_id')
    ...
    models = {
        ...
        u'zerver.stream': {
            ...
            'email_token': ('django.db.models.fields.CharField', [], {'default': "'c8596bdc3352ed6c1d655490f0a28b09'", 'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
