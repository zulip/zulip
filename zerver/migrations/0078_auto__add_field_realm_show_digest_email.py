...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Realm.show_digest_email'
        db.add_column(u'zerver_realm', 'show_digest_email',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=True)
        db.execute("UPDATE zerver_realm SET show_digest_email = FALSE WHERE domain IN ('mit.edu', 'customer29.invalid', 'customer20.invalid', 'zulip.com')")


    def backwards(self, orm):
        # Deleting field 'Realm.show_digest_email'
        db.delete_column(u'zerver_realm', 'show_digest_email')
    ...
    models = {
        ...
        u'zerver.stream': {
            ...
            'email_token': ('django.db.models.fields.CharField', [], {'default': "'1377ae2f7680fac7048d5c3b473fb383'", 'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
