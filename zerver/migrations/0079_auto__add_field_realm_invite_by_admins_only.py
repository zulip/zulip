...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Realm.invite_by_admins_only'
        db.add_column(u'zerver_realm', 'invite_by_admins_only',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=True)
        db.execute("UPDATE zerver_realm SET invite_by_admins_only = TRUE WHERE domain = 'users.customer4.invalid'")


    def backwards(self, orm):
        # Deleting field 'Realm.invite_by_admins_only'
        db.delete_column(u'zerver_realm', 'invite_by_admins_only')
    ...
    models = {
        ...
        u'zerver.stream': {
            ...
            'email_token': ('django.db.models.fields.CharField', [], {'default': "'47beaaed350946c6e4846643d05c64ce'", 'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
