...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Realm.invite_required'
        db.add_column(u'zerver_realm', 'invite_required',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=True)
        if settings.ENTERPRISE:
            db.execute("UPDATE zerver_realm SET invite_required = FALSE")
        else:
            db.execute("UPDATE zerver_realm SET invite_required = TRUE")
            db.execute("UPDATE zerver_realm SET invite_required = FALSE WHERE domain IN ('customer3.invalid','mit.edu','zulip.com')")

    def backwards(self, orm):
        # Deleting field 'Realm.invite_required'
        db.delete_column(u'zerver_realm', 'invite_required')
    ...
    models = {
        ...
        u'zerver.stream': {
            ...
            'email_token': ('django.db.models.fields.CharField', [], {'default': "'c59173613e9744b325ec2f1faaba4d3b'", 'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
