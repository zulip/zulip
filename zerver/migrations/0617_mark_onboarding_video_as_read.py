...
def mark_onboarding_video_as_read(apps: StateApps, schema_editor: BaseDatabaseSchemaEditor) -> None:
    ...
    while lower_id_bound < max_id:
        ...
        with connection.cursor() as cursor:
            query = SQL("""
                ...
                SELECT id, 'onboarding_video', %(timestamp_value)s
...
def mark_onboarding_video_as_unread(
    apps: StateApps, schema_editor: BaseDatabaseSchemaEditor
) -> None:
    OnboardingStep = apps.get_model("zerver", "OnboardingStep")

    OnboardingStep.objects.filter(onboarding_step="onboarding_video").delete()
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(
            mark_onboarding_video_as_read,
            reverse_code=mark_onboarding_video_as_unread,
            elidable=True,
        ),
    ]
