...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Realm.mandatory_topics'
        db.add_column(u'zerver_realm', 'mandatory_topics',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=True)
        db.execute("UPDATE zerver_realm SET mandatory_topics = TRUE WHERE domain = 'customer7.invalid'")

    def backwards(self, orm):
        # Deleting field 'Realm.mandatory_topics'
        db.delete_column(u'zerver_realm', 'mandatory_topics')
    ...
    models = {
        ...
        u'zerver.stream': {
            ...
            'email_token': ('django.db.models.fields.CharField', [], {'default': "'f4fbbd386703af923e0478757078de05'", 'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
