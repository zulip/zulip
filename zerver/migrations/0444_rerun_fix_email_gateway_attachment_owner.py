...
class Migration(migrations.Migration):
    ...
    This was previously zerver/migrations/0443_fix_attachment_realm.py,
    but has been moved to run after 0443_fix_attachment_realm so that that migration can fix
    certain attachments that would otherwise not be addressed here.
    """

    dependencies = [
        ("zerver", "0443_fix_attachment_realm"),
    ]
