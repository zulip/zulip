...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Realm.name_changes_disabled'
        db.add_column(u'zerver_realm', 'name_changes_disabled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=True)
        db.execute("UPDATE zerver_realm SET name_changes_disabled = TRUE WHERE domain IN ('employees.customer16.invalid', 'users.customer4.invalid')")


    def backwards(self, orm):
        # Deleting field 'Realm.name_changes_disabled'
        db.delete_column(u'zerver_realm', 'name_changes_disabled')
    ...
    models = {
        ...
        u'zerver.stream': {
            ...
            'email_token': ('django.db.models.fields.CharField', [], {'default': "'57fcc31c60623617aaa729b444171327'", 'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
