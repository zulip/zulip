...
def process_message_update_event(
    ...
    prior_alert_word_user_ids = set(event_template.pop("prior_alert_word_user_ids", []))
    ...
    for user_data in users:
        ...
        if not rendering_only_update:
            ...
            maybe_enqueue_notifications_for_message_update(
                ...
                prior_alerted=user_profile_id in prior_alert_word_user_ids,
            )
...
def maybe_enqueue_notifications_for_message_update(
    ...
    if prior_mentioned or prior_alerted:
        # Don't spam people with duplicate mentions or alert words.
