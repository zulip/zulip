...
from zerver.lib.devices import b64decode_token_id
...
class RegisterPushDeviceToBouncer(BouncerTestCase):
    ...
    def get_register_push_device_payload(
        ...
        token_id = base64.b64encode(hash_bytes[0:8]).decode()
    ...
    def test_register_push_device_success(self) -> None:
        ...
        self.assertEqual(remote_push_devices[0].token_id, b64decode_token_id(payload["token_id"]))
        ...
        assert type(payload["token_id"]) is str  # for mypy
        self.assertEqual(remote_push_devices[1].token_id, b64decode_token_id(payload["token_id"]))
...
class RegisterPushDeviceToServer(BouncerTestCase):
    ...
    def test_register_push_device_success(self) -> None:
        ...
        self.assertIsNone(device.push_token_id)
        assert type(payload["token_id"]) is str  # for mypy
        self.assertEqual(device.pending_push_token_id, b64decode_token_id(payload["token_id"]))
        ...
        assert type(payload["token_id"]) is str  # for mypy
        self.assertEqual(device.push_token_id, b64decode_token_id(payload["token_id"]))
        self.assertIsNone(device.pending_push_token_id)
        self.assertEqual(
            events[0]["event"],
            dict(
    ...
    def test_invalid_token_id_error(self) -> None:
        ...
        self.assert_json_error(result, "Invalid `token_id`")
    ...
    def test_token_rotation(self) -> None:
        ...
        self.assertEqual(device.push_token_id, b64decode_token_id(rotate_token_payload["token_id"]))
        self.assertEqual(
            events[0]["event"],
            dict(
                type="device",
