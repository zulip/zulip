...
class MessageHasKeywordsTest(AttachmentTest):
    '''Test for keywords like has_link, has_image, has_attachment.
       Here, we subclass AttachmentTest instead of ZulipTestCase to
       re-use the common logic for creating dummy attachment files.
    '''
