...
class BotTest(ZulipTestCase, UploadSerializeMixin):
    ...
    def test_patch_outgoing_webhook_bot(self) -> None:
        ...
        bot_info = {
            ...
            "service_triggers": orjson.dumps([Service.BOT_TRIGGER_ALL_MENTIONS]).decode(),
        }
        email = "hambot-bot@zulip.testserver"
        result = self.client_patch(f"/json/bots/{self.get_bot_user(email).id}", bot_info)
        self.assert_json_success(result)
        ...
        self.assertEqual(service_triggers, [Service.BOT_TRIGGER_ALL_MENTIONS])
    ...
    def test_patch_bot_service_triggers(self) -> None:
        ...
        bot_info = {
            "service_triggers": orjson.dumps(
                [
                    Service.BOT_TRIGGER_ALL_MENTIONS.upper(),
                    Service.BOT_TRIGGER_ALL_MENTIONS,
