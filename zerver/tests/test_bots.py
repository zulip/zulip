...
class BotTest(ZulipTestCase, UploadSerializeMixin):
    ...
    def test_add_bot_with_bot_type_incoming_webhook(self) -> None:
        ...
        self.login("hamlet")
        self.assert_num_bots_equal(0)
        self.create_bot(bot_type=UserProfile.INCOMING_WEBHOOK_BOT, integration_name="github")
        self.assert_num_bots_equal(1)
    ...
    def check_user_can_create_bot(
        ...
        if bot_type == UserProfile.INCOMING_WEBHOOK_BOT:
            bot_info["integration_name"] = integration_name
    ...
    def test_create_incoming_webhook_bot_with_invalid_integration_name(self) -> None:
        ...
        expected_error_message = "Invalid integration name."
    ...
    def test_can_create_write_only_bots_group(self) -> None:
        ...
        self.check_user_can_create_bot(
            "hamlet", "testbot-1", UserProfile.INCOMING_WEBHOOK_BOT, integration_name="github"
        )
        self.check_user_can_create_bot(
            "polonius",
            "testbot-2",
        ...
        self.check_user_can_create_bot(
            "shiva", "testbot-3", UserProfile.INCOMING_WEBHOOK_BOT, integration_name="github"
        )
        self.check_user_can_create_bot(
            "iago", "testbot-4", UserProfile.INCOMING_WEBHOOK_BOT, integration_name="github"
        )
        self.check_user_can_create_bot(
            "hamlet",
            "testbot-5",
        ...
        self.check_user_can_create_bot(
            "iago", "testbot-5", UserProfile.INCOMING_WEBHOOK_BOT, integration_name="github"
        )
        self.check_user_can_create_bot(
            "shiva",
            "testbot-6",
        ...
        self.check_user_can_create_bot(
            "hamlet", "testbot-6", UserProfile.INCOMING_WEBHOOK_BOT, integration_name="github"
        )
        self.check_user_can_create_bot(
            "cordelia", "testbot-7", UserProfile.INCOMING_WEBHOOK_BOT, integration_name="github"
        )
        ...
        self.check_user_can_create_bot(
            "iago", "testbot-8", UserProfile.INCOMING_WEBHOOK_BOT, integration_name="github"
        )
        ...
        self.check_user_can_create_bot(
            "hamlet", "testbot-9", UserProfile.INCOMING_WEBHOOK_BOT, integration_name="github"
        )
        # Iago is in the `administrators_system_group` subgroup, so can create bots.
        self.check_user_can_create_bot(
            "iago", "testbot-10", UserProfile.INCOMING_WEBHOOK_BOT, integration_name="github"
        )
        ...
        self.check_user_can_create_bot(
            "iago", "testbot-12", UserProfile.INCOMING_WEBHOOK_BOT, integration_name="github"
        )
        ...
        self.check_user_can_create_bot(
            "shiva", "testbot-13", UserProfile.INCOMING_WEBHOOK_BOT, integration_name="github"
        )
    ...
    def test_create_incoming_webhook_bot_without_service_name(self) -> None:
        ...
        self.assertEqual(bot_config, {"integration_name": "stripe"})
