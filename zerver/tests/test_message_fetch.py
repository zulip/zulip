...
class GetOldMessagesTest(ZulipTestCase):
    ...
    def test_get_messages_using_narrow_channels_all(self) -> None:
        ...
        # Direct messages hamlet receives; channels:all is a channel-message
        # filter, so these should never appear in its results.
        self.send_personal_message(iago, hamlet)
        self.send_group_direct_message(iago, [hamlet, self.example_user("cordelia")])
