...
class NarrowBuilderTest(ZulipTestCase):
    ...
    def test_add_term_using_reaction_operator(self) -> None:
        ...
        self._do_add_term_test(
            term,
            'WHERE EXISTS(SELECT %s AS "a" FROM "zerver_reaction" U0 WHERE (U0."emoji_code" = %s AND U0."message_id" = ("zerver_message"."id") AND U0."reaction_type" = %s) LIMIT 1)',
        )
    ...
    def test_add_term_using_reaction_operator_negated(self) -> None:
        ...
        self._do_add_term_test(
            term,
            'WHERE NOT (EXISTS(SELECT %s AS "a" FROM "zerver_reaction" U0 WHERE (U0."emoji_code" = %s AND U0."message_id" = ("zerver_message"."id") AND U0."reaction_type" = %s) LIMIT 1))',
        )
