...
class SAMLAuthBackendTest(SocialAuthBase):
    ...
    def test_social_auth_group_sync(self) -> None:
        realm = get_realm("zulip")
        hamlet = self.example_user("hamlet")
        user_group_one = create_user_group_in_database("testgroup1", [], realm, acting_user=hamlet)
        user_group_two = create_user_group_in_database("testgroup2", [], realm, acting_user=hamlet)
        ...
        bulk_add_members_to_user_groups(
            [user_group_one, user_group_two], [hamlet.id], acting_user=None
        )
    ...
    def test_social_auth_create_user_with_synced_role_and_groups(self) -> None:
        ...
        user_group_one = create_user_group_in_database(
            "testgroup1", [], realm, acting_user=desdemona
        )
        user_group_two = create_user_group_in_database(
            "testgroup2", [], realm, acting_user=desdemona
        )
