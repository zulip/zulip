...
class AppleAuthBackendNativeFlowTest(AppleAuthMixin, SocialAuthBase):
    ...
    def social_auth_test(self, account_data_dict: Dict[str, str],
                         ...
                         **extra_data: Any) -> HttpResponse:
        """
        In the native flow the app authenticates with Apple and receives the JWT id_token.
        The app sends an appropriate request with it to /complete/apple/ to get logged in.
        See the backend class for details.
        """
