...
class StreamMessagesTest(ZulipTestCase):
    ...
    def test_not_too_many_queries(self) -> None:
        ...
        # When sending a message to a new topic we do 3 queries.
        # 1 to check if the topic exists + 2 to check permissions for creating a new topic.
        # Hence, whenever sending message to an existing topic the query count is reduced by 2.
        ...
        # by 2, similar for the test cases below.
        flush_per_request_caches()
