...
class MessageMoveStreamTest(ZulipTestCase):
    ...
    def test_can_move_messages_out_of_channel_group(self) -> None:
        ...
        error_msg = "You don't have permission to move this message"
        ...
        self.assert_move_message("hamlet", stream_1, stream_id=stream_2.id, error_msg=error_msg)
        ...
        self.assert_move_message("polonius", stream_1, stream_id=stream_2.id, error_msg=error_msg)
        ...
        self.assert_move_message(
            ...
            error_msg="You don't have permission to edit this message",
        )
        ...
        self.assert_move_message("shiva", stream_1, stream_id=stream_2.id, error_msg=error_msg)
