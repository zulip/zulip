...
EXPORTED_MICROSOFT_TEAMS_USER_EMAIL = dict(
    ...
    guest="guest@ZulipChat.onmicrosoft.com",
...
MICROSOFT_TEAMS_EXPORT_USER_ROLE_DATA = MicrosoftTeamsUserRoleData(
    ...
    guest_user_ids={"03dfa7d8-1d7e-4ead-972c-1f9df51afb3b"},
)
...
class MicrosoftTeamsImporterIntegrationTest(ZulipTestCase):
    ...
    def get_imported_microsoft_teams_user(
        ...
        email = EXPORTED_MICROSOFT_TEAMS_USER_EMAIL[name]
...
class MicrosoftTeamsImporterUnitTest(ZulipTestCase):
    ...
    def test_at_least_one_recipient_per_user(self) -> None:
        """
        Make sure each user atleast has a recipient field. This makes sure the
    ...
    def test_get_user_roles(self) -> None:
        with (
            ...
            # In actuality, this is probably a very rare case since this role is
            # one of the built-in roles.
