...
class MicrosoftTeamsImporterUnitTest(MicrosoftTeamsImportTestCase):
    ...
    def test_convert_html_to_markdown_list_conversion(self) -> None:
        """
        ...
        convert_html_to_markdown leaves them intact. See #39351.
        """
        raw_text = "- bullet 1\n- bullet 2\n- bullet 3\n- bullet 4"
        content = convert_html_to_markdown(raw_text)
    ...
    def test_process_hosted_content_attachments(self) -> None:
        ...
        message_fixtures: list[MessageFixture] = [
            ...
            # The original message was just two custom emojis, nothing else. convert_html_to_markdown doesn't know
