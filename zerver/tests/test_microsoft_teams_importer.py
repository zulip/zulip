...
class MicrosoftTeamsImporterIntegrationTest(ZulipTestCase):
    ...
    def test_imported_users(self) -> None:
        ...
        # So there shouldn't be any imported accounts with is_mirror_dummy=True.
        non_user_account = self.get_imported_realm_user_field_values("id", is_mirror_dummy=True)
...
class MicrosoftTeamsImporterUnitTest(ZulipTestCase):
    ...
    def test_paginated_get_microsoft_graph_api_data(self) -> None:
        ...
        expected_member_users = {
            user["Id"]
            for user in get_exported_microsoft_teams_user_data()
