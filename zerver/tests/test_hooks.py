...
class TeamcityHookTests(AuthedTestCase):
    def basic_test(self, type, expected_subject, expected_msg):
        """
    ...
    def test_teamcity_success(self):
        self.basic_test("success", u"Project :: Compile", u"Project :: Compile build 5535 - CL 123456 was successful! :thumbsup:\nDetails: [changes](http://teamcity/viewLog.html?buildTypeId=Project_Compile&buildId=19952&tab=buildChangesDiv), [build log](http://teamcity/viewLog.html?buildTypeId=Project_Compile&buildId=19952)")

    def test_teamcity_broken(self):
        self.basic_test("broken", u"Project :: Compile", u"Project :: Compile build 5535 - CL 123456 is broken with status Exit code 1 (new)! :thumbsdown:\nDetails: [changes](http://teamcity/viewLog.html?buildTypeId=Project_Compile&buildId=19952&tab=buildChangesDiv), [build log](http://teamcity/viewLog.html?buildTypeId=Project_Compile&buildId=19952)")

    def test_teamcity_failure(self):
        self.basic_test("failure", u"Project :: Compile", u"Project :: Compile build 5535 - CL 123456 is still broken with status Exit code 1! :thumbsdown:\nDetails: [changes](http://teamcity/viewLog.html?buildTypeId=Project_Compile&buildId=19952&tab=buildChangesDiv), [build log](http://teamcity/viewLog.html?buildTypeId=Project_Compile&buildId=19952)")

    def test_teamcity_fixed(self):
        self.basic_test("fixed", u"Project :: Compile", u"Project :: Compile build 5535 - CL 123456 has been fixed! :thumbsup:\nDetails: [changes](http://teamcity/viewLog.html?buildTypeId=Project_Compile&buildId=19952&tab=buildChangesDiv), [build log](http://teamcity/viewLog.html?buildTypeId=Project_Compile&buildId=19952)")

    def test_teamcity_personal(self):
        fixed_msg = u"Project :: Compile build 5535 - CL 123456 has been fixed! :thumbsup:\nDetails: [changes](http://teamcity/viewLog.html?buildTypeId=Project_Compile&buildId=19952&tab=buildChangesDiv), [build log](http://teamcity/viewLog.html?buildTypeId=Project_Compile&buildId=19952)"
        self.basic_test("fixed", u"Project :: Compile", fixed_msg)
        # A personal build (in this fixture, one that breaks the build) shouldn't trigger a new message, so we should still see the previous one.
        self.basic_test("personal", u"Project :: Compile", fixed_msg)
