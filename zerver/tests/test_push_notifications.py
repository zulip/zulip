...
class GCMIOErrorTest(GCMTest):
    ...
    @mock.patch('logging.warning')
    def test_json_request_raises_ioerror(self, mock_warn: mock.MagicMock, mock_json_request: mock.MagicMock) -> None:
...
class GCMSuccessTest(GCMTest):
    ...
    def test_success(self, mock_send: mock.MagicMock, mock_info: mock.MagicMock, mock_warning: mock.MagicMock) -> None:
        res = {}
...
class GCMCanonicalTest(GCMTest):
    ...
    @mock.patch('logging.warning')
    @mock.patch('gcm.GCM.json_request')
    def test_pushdevice_not_present(self, mock_send: mock.MagicMock, mock_warning: mock.MagicMock) -> None:
        res = {}
    ...
    @mock.patch('logging.info')
    @mock.patch('gcm.GCM.json_request')
    def test_pushdevice_different(self, mock_send: mock.MagicMock, mock_info: mock.MagicMock) -> None:
        res = {}
