...
class RegisterPushDeviceToBouncer(BouncerTestCase):
    ...
    def get_register_push_device_payload(
        ...
        token_kind: int = 2,
        timestamp: int = datetime_to_timestamp(now()),
    ) -> dict[str, str | int]:
        hamlet = self.example_user("hamlet")
    ...
    def test_register_push_device_success(self) -> None:
        ...
        self.assertEqual(response_dict["device_id"], remote_push_devices[0].device_id)
    ...
    def test_register_push_device_error(self) -> None:
        ...
        self.assert_json_error(result, "Push registration liveness timedout")

        # TODO: Test the various cases resulting in PushRegistrationDecodeError
