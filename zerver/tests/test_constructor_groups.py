...
class ConstructorGroupsServiceTest(ZulipTestCase):
    ...
    @patch("zerver.views.video_calls.settings.CONSTRUCTOR_GROUPS_URL", "https://constructor.app/api/groups/xapi-public")
...
class ConstructorGroupsCallTest(ZulipTestCase):
    ...
    def test_not_configured_error(self, mock_configured: Mock) -> None:
        ...
        response = self.client_post(
            ...
            {"is_video_call": orjson.dumps(True).decode()}
        )
    ...
    @patch("zerver.views.video_calls.ConstructorGroupsService._is_configured")
    def test_existing_room_reuse(
        self, mock_configured: Mock, mock_request: Mock
    ) -> None:
        ...
        mock_request.assert_called_once_with("GET", "/room/search", {
