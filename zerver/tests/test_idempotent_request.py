...
class TransactionIdempotencyTest(ZulipTransactionTestCase):
    ...
    async def test_concurrency(self) -> None:
        ...
        def check_result(result: "TestHttpResponse") -> int:
            # helper function, returns status_code of the response.
            # and raises AssertionError in case of
            # unexpected error i.e. not the expected 409.
            try:
            ...
            except AssertionError as unexpected_error:  # nocoverage
