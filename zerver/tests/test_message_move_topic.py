...
class MessageMoveTopicTest(ZulipTestCase):
    ...
    def test_can_move_messages_within_channel_group(self) -> None:
        ...
        self.assert_move_message("hamlet", stream_1, topic_name="new topic", error_msg=error_msg)
        ...
        self.assert_move_message("polonius", stream_1, topic_name="new topic", error_msg=error_msg)

        # Users are not allowed to move messages to different topics out of the channel
        # as `can_move_messages_between_topics_group` is set to nobody. Channel-level
        # `can_move_messages_within_channel_group` setting only applies to the moves local to
        # the channel.
        self.assert_move_message(
            "hamlet", stream_1, stream_id=stream_2.id, topic_name="new topic", error_msg=error_msg
        )
        # But users can move messages to the same topic of a different channel if they have
        # the required permissions to move messages between channels.
        self.assert_move_message("hamlet", stream_1, stream_id=stream_2.id, topic_name="test")
        ...
        self.assert_move_message("shiva", stream_1, topic_name="new topic", error_msg=error_msg)
