...
class MessageMoveTopicTest(ZulipTestCase):
    ...
    def test_can_move_messages_can_create_topic_group(self) -> None:
        ...
        check_move_message(hamlet, stream, topic_name="existing topic 2")
        check_move_message(iago, stream, topic_name="existing topic 2")
        check_move_message(cordelia, stream, topic_name="existing topic 2")
