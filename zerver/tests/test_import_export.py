...
class ImportExportTest(ZulipTestCase):
    ...
    def test_export_realm_with_member_consent(self) -> None:
        ...
        self.send_stream_message(self.example_email("othello"), "Private C", "Hello Stream C")
        ...
        self.send_huddle_message(self.example_email("AARON"), [self.example_email("cordelia"),
                                                               self.example_email("AARON"),
                                                               self.example_email("othello")])
