...
class RealmTest(ZulipTestCase):
    ...
    def test_realm_description_caching(self) -> None:
        ...
        # Test 4: Empty description uses default text
        do_set_realm_property(
            realm,
            "description",
            "",
        ...
        realm.refresh_from_db()
        # Empty description triggers default text
        self.assertIn("The coolest place in the universe.", cast(str, realm.rendered_description))
