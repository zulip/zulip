...
class RealmAPITest(ZulipTestCase):
    ...
    def test_invalid_mark_resolved_topic_notifications_as_read_policy(self) -> None:
        result = self.client_patch(
            "/json/realm/user_settings_defaults",
            {"mark_resolved_topic_notifications_as_read_policy": "invalid"},
        )
        self.assert_json_error(result, "Invalid mark_resolved_topic_notifications_as_read_policy")
