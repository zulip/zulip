...
class RealmTest(ZulipTestCase):
    ...
    def test_realm_description_caching(self) -> None:
        ...
        # Test 4: Empty description is preserved (not replaced with default)
        do_set_realm_property(
            realm,
            "description",
            "",
        ...
        # Test 5: None description uses default text
        result_with_none = render_realm_description(None, realm)
        self.assertIn("The coolest place in the universe.", result_with_none)
