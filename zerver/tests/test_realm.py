...
class RealmAPITest(ZulipTestCase):
    ...
    def do_test_realm_default_setting_update_api(self, name: str) -> None:
        ...
        test_values: dict[str, Any] = dict(
            ...
            resolved_topic_notice_unread_policy=UserProfile.RESOLVED_TOPIC_NOTICE_UNREAD_POLICY_TYPES,
        )
    ...
    def test_invalid_resolved_topic_notice_unread_policy(self) -> None:
        result = self.client_patch(
            "/json/realm/user_settings_defaults",
            {"resolved_topic_notice_unread_policy": "invalid"},
        )
        self.assert_json_error(result, "Invalid resolved_topic_notice_unread_policy")
