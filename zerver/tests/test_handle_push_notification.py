...
from zerver.lib.notification_data import get_smallest_topic_wildcard_mention_participant_count
...
class HandlePushNotificationTest(PushNotificationTestCase):
    ...
    def test_topic_wildcard_helper_returns_none_for_non_stream_message(self) -> None:

        othello = self.example_user("othello")
        user = self.example_user("hamlet")
        message_id = self.send_personal_message(othello, user, "DM body")

        result = get_smallest_topic_wildcard_mention_participant_count(
            [
                {
                    "message_id": message_id,
