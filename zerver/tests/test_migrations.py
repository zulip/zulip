...
class FixDeletedUserEmail(MigrationsTestCase):
    ...
    def setUpBeforeMigration(self, apps: StateApps) -> None:
        ...
        # Fetch users through the historical models rather than helpers
        # like example_user, whose models have every field the codebase
        # has today, not the ones this migration's schema has.
