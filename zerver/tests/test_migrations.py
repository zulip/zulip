...
class FixDeletedUserEmail(MigrationsTestCase):
    ...
    def setUpBeforeMigration(self, apps: StateApps) -> None:
        ...
        deleted_user = UserProfile.objects.get(
            delivery_email=self.example_email("hamlet"), realm=zulip_realm
        )
        ...
        control_user = UserProfile.objects.get(
            delivery_email=self.example_email("cordelia"), realm=zulip_realm
        )
        ...
        deactivated_user = UserProfile.objects.get(
            delivery_email=self.example_email("othello"), realm=zulip_realm
        )
