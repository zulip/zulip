...
class UserGroupAPITestCase(UserGroupTestCase):
    ...
    def test_can_create_groups_for_creating_user_group(self) -> None:
        ...
        othello.save()
        # Update system group membership based on new date_joined so the
        # 'full members' system group reflects the change. Without this call
        # the system still treats othello as a full member.
        promote_new_full_members()
    ...
    def test_realm_level_setting_for_updating_members(self) -> None:
        ...
        othello.save()
        promote_new_full_members()
        # Make sure cordelia is not treated as a full member yet by setting her
        # join date to below the threshold and promoting membership.
