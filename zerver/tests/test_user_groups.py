...
class UserGroupTestCase(ZulipTestCase):
    ...
    def test_user_groups_in_realm_serialized(self) -> None:
        ...
        self.assertEqual(
            ...
            UserGroupMembersDataDict(direct_members=[11], direct_subgroups=[]),
        )
        ...
        assert isinstance(user_groups[10]["can_manage_group"], UserGroupMembersDataDict)
        ...
        assert isinstance(user_groups[10]["can_mention_group"], UserGroupMembersDataDict)
        ...
        self.assertEqual(
            realm_setting_anonymous_group_membership,
            {
                realm.can_create_public_channel_group_id: UserGroupMembersDataDict(
...
class UserGroupAPITestCase(UserGroupTestCase):
    ...
    def test_user_group_deactivation_with_group_used_for_settings(self) -> None:
        ...
        for setting_name in Stream.stream_permission_group_settings:
            ...
            anonymous_setting_group_member_dict = UserGroupMembersDataDict(
