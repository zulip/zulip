...
class UserGroupTestCase(ZulipTestCase):
    ...
    def test_user_groups_in_realm_serialized(self) -> None:
        ...
        empty_user_group_date_created = (
            datetime_to_timestamp(empty_user_group.date_created)
            if empty_user_group.date_created is not None
            else None
        )
        self.assertEqual(user_groups[9]["date_created"], empty_user_group_date_created)
