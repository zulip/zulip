...
from zerver.lib.push_registration import (
    RegisterPushDeviceToBouncerPayload,
...
class NormalActionsTest(BaseAction):
    ...
    def test_push_device(self) -> None:
        hamlet = self.example_user("hamlet")
        ...
        request: RegisterPushDeviceToBouncerPayload = {
        ...
        with (
            ...
            handle_register_push_device_to_bouncer(request)
