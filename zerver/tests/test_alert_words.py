...
class AlertWordTests(ZulipTestCase):
    ...
    def test_remove_word(self) -> None:
        ...
        for alert_word in self.interesting_alert_word_list:
            ...
            deactivated_word = AlertWord.objects.get(user_profile=user, word=alert_word)
            self.assertTrue(deactivated_word.deactivated)
    ...
    def test_json_list_remove(self) -> None:
        ...
        deactivated_row = AlertWord.objects.get(user_profile=user, word__iexact="one")
        self.assertTrue(deactivated_row.deactivated)
