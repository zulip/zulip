...
class ActivateTest(ZulipTestCase):
    ...
    def test_updating_group_permissions_when_deactivating(self) -> None:
        ...
        setting_group = self.create_or_update_anonymous_group_for_setting([hamlet, othello], [])
        do_change_stream_group_based_setting(
            stream, "can_remove_subscribers_group", setting_group, acting_user=iago
        )

        setting_group = self.create_or_update_anonymous_group_for_setting([hamlet], [])
        do_change_stream_group_based_setting(
            stream, "can_administer_channel_group", setting_group, acting_user=iago
        )
