...
class ActivateTest(ZulipTestCase):
    ...
    def test_api_with_delete_action(self) -> None:
        ...
        do_change_stream_invite_only(get_stream("Verona", user.realm), True)
        ...
        self.send_stream_message(user, "Denmark", topic_name="topic1", content="test message 1")
        self.send_stream_message(user, "Denmark", topic_name="topic1", content="test message 2")
        self.send_stream_message(user, "Denmark", topic_name="topic2")
