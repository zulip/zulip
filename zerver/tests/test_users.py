...
class ActivateTest(ZulipTestCase):
    ...
    def test_deactivation_with_deleting_direct_messages(self) -> None:
        ...
        self.assert_length(
            user_messages_before, 13
        )  # 8 + 2 group DMs + 2 to hamlet + 1 extra to admin

        stream_messages = [msg for msg in user_messages_before if msg.is_stream_message()]
        direct_messages = [msg for msg in user_messages_before if not msg.is_stream_message()]
        self.assert_length(stream_messages, 6)
        self.assert_length(direct_messages, 7)
        ...
        self.assertTrue(all(msg.is_stream_message() for msg in user_messages_after))
