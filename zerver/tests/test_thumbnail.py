...
class TestContentTypeCorrection(ZulipTestCase):
    def test_maybe_correct_content_type(self) -> None:
        ...
        # These are intentional tests of known misbehavior.
        test_content_type = maybe_correct_content_type(test_heic, "image/avif")
        self.assertEqual(test_content_type, "image/avif")
...
class TestStoreThumbnail(ZulipTestCase):
    ...
    def test_content_type_correction(self) -> None:
        ...
        content_type_helper("test.heic", "image/avif", "image/avif")
