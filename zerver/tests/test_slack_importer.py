...
*1 reply in #**random>2015-08-18 random message but it is too long for the thread…***
""".strip()
        ...
        expected_thread_2_message_2_content = "second thread"
        expected_thread_2_topic_name = (
            "2015-08-18 random message but it is too long for the th… (2)"
        )
        self.assertEqual(zerver_message[3]["content"], expected_thread_2_message_2_content)
...
*1 reply in #**random>2015-06-12 message body text (2)***
""".strip()
...
@**Jon** please reply to this message

*1 reply in [#random > 2015-07-17 @&#42;&#42;Jon&#42;&#42; please reply to this message](#narrow/channel/2-random/topic/2015-07-17.20.40**Jon**.20please.20reply.20to.20this.20message)*
""".strip()
    ...
    def test_convert_thread_topic_name_with_text_formattings(self) -> None:
        ...
        expected_thread_message_1_content = """
**foo** *bar* ~~baz~~ [qux](https://chat.zulip.org)

*1 reply in [#random > 2019-01-10 &#42;&#42;foo&#42;&#42; &#42;bar&#42; ~~baz~~ &#91;qux&#93;(https://chat.zulip.o…](#narrow/channel/2-random/topic/2019-01-10.20**foo**.20*bar*.20~~baz~~.20.5Bqux.5D.28https.3A.2F.2Fchat.2Ezulip.2Eo.E2.80.A6)*
""".strip()
