...
class TestGetNextOnboardingSteps(ZulipTestCase):
    ...
    def test_some_done_some_not(self) -> None:
        ...
        self.assertEqual(onboarding_steps[6]["name"], "onboarding_video")
        ...
        with self.settings(ONBOARDING_VIDEO_URL=None):
            onboarding_steps = get_next_onboarding_steps(self.user)
        self.assertNotIn("onboarding_video", onboarding_steps)
