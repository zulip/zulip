...
class GetStreamsTest(ZulipTestCase):
    ...
    def test_get_stream_email_address(self) -> None:
        ...
        json = self.assert_json_success(result)
        email_token = ChannelEmailAddress.objects.get(
            channel=denmark_stream, creator=hamlet, sender=email_gateway_bot
        ).email_token
        hamlet_denmark_email = encode_email_address_helper(
        ...
        json = self.assert_json_success(result)
        email_token = ChannelEmailAddress.objects.get(
            channel=denmark_stream, creator=polonius, sender=email_gateway_bot
        ).email_token
        polonius_denmark_email = encode_email_address_helper(
            denmark_stream.name, email_token, show_sender=True
        )
        ...
        json = self.assert_json_success(result)
        email_token = ChannelEmailAddress.objects.get(
            channel=denmark_stream, creator=iago, sender=email_gateway_bot
        ).email_token
        iago_denmark_email = encode_email_address_helper(
            denmark_stream.name, email_token, show_sender=True
        )
