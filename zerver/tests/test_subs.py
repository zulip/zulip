...
class SubscriptionAPITest(ZulipTestCase):
    ...
    def test_successful_cross_realm_notification(self) -> None:
        ...
        expected_rendered_msg = '<p><span class="user-mention" data-user-id="%d">@%s</span> just created a new stream <a class="stream" data-stream-id="%d" href="/#narrow/stream/%s-%s">#%s</a>.</p>' % (
