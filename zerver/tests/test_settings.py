...
class ChangeSettingsTest(ZulipTestCase):
    ...
    def do_test_change_user_setting(self, setting_name: str) -> None:
        test_changes: dict[str, Any] = dict(
            ...
            mark_resolved_topic_notifications_as_read_policy=MarkResolvedTopicNotificationsAsReadPolicyEnum.always.name,
        )
        ...
        self.assert_json_success(result)
        user_profile = self.example_user("hamlet")
        if setting_name == "mark_resolved_topic_notifications_as_read_policy":
            test_value = MarkResolvedTopicNotificationsAsReadPolicyEnum.always.value
    ...
    def test_invalid_setting_value(self) -> None:
        invalid_values: list[dict[str, Any]] = [
            ...
            {
                "setting_name": "mark_resolved_topic_notifications_as_read_policy",
                "value": "invalid",
                "error_msg": "Invalid mark_resolved_topic_notifications_as_read_policy",
            },
        ]
        self.login("hamlet")
