...
from zerver.models.users import ResolvedTopicNoticeUnreadPolicyEnum, get_user_profile_by_api_key
...
class ChangeSettingsTest(ZulipTestCase):
    ...
    def do_test_change_user_setting(self, setting_name: str) -> None:
        test_changes: dict[str, Any] = dict(
            ...
            resolved_topic_notice_unread_policy=ResolvedTopicNoticeUnreadPolicyEnum.always.name,
        )
        ...
        self.assert_json_success(result)
        user_profile = self.example_user("hamlet")
        if setting_name == "resolved_topic_notice_unread_policy":
            test_value = ResolvedTopicNoticeUnreadPolicyEnum.always.value
    ...
    def test_invalid_setting_value(self) -> None:
        invalid_values: list[dict[str, Any]] = [
            ...
            {
                "setting_name": "resolved_topic_notice_unread_policy",
                "value": "invalid",
                "error_msg": "Invalid resolved_topic_notice_unread_policy",
            },
        ]
        self.login("hamlet")
