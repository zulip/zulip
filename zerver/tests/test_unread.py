...
class PointerTest(ZulipTestCase):
    ...
    def test_use_first_unread_anchor_interaction_with_pointer(self):
        ...
        # If we call get_old_messages with use_first_unread_anchor=True, we
        ...
        # call get_old_messages with use_first_unread_anchor=False and simply
        # save the first message we're returned.
        messages = self.get_old_messages(
            anchor=0, num_before=0, num_after=1, use_first_unread_anchor=False)
        ...
        # Now if we call get_old_messages with use_first_unread_anchor=True,
