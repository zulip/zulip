...
class EmptyTopicNameTest(ZulipTestCase):
    def test_client_supports_empty_topic_name(self) -> None:
        ...
        message_id_2 = self.send_stream_message(iago, "Denmark", topic_name="general chat")
        events = client.event_queue.contents()
    ...
    def test_client_not_supports_empty_topic_name(self) -> None:
        ...
        message_id = self.send_stream_message(iago, "Denmark", topic_name="")
        events = client.event_queue.contents()
        self.assertEqual(events[0]["message"]["subject"], "general chat")

        message_id_2 = self.send_stream_message(iago, "Denmark", topic_name="general chat")
        events = client.event_queue.contents()
        self.assertEqual(events[1]["message"]["subject"], "general chat")
    ...
    def test_fetch_messages(self) -> None:
        ...
        second_message_id = self.send_stream_message(hamlet, "Denmark", topic_name="general chat")
        ...
        for message in data["messages"]:
            self.assertEqual(message["subject"], "general chat")
        ...
        data = self.assert_json_success(result)
        self.assertEqual(data["message"]["subject"], "general chat")
        ...
        data = self.assert_json_success(result)
        self.assertEqual(data["message"]["edit_history"][0]["prev_topic"], "general chat")
        ...
        data = self.assert_json_success(result)
        self.assertEqual(data["message"]["edit_history"][0]["topic"], "general chat")
    ...
    def test_get_message_edit_history(self) -> None:
        ...
        message_id_2 = self.send_stream_message(hamlet, "Denmark", topic_name="general chat")
        ...
        data = self.assert_json_success(result)
        self.assertEqual(data["message_history"][0]["topic"], "general chat")
        self.assertEqual(data["message_history"][1]["prev_topic"], "general chat")
    ...
    def test_initial_state_data(self) -> None:
        ...
        self.send_stream_message(hamlet, "Verona", topic_name="general chat")
        ...
        self.assertEqual(state_data["unread_msgs"]["streams"][0]["topic"], "general chat")
        self.assertEqual(state_data["unread_msgs"]["streams"][1]["topic"], "general chat")
        self.assertEqual(state_data["user_topics"][0]["topic_name"], "general chat")
        self.assertEqual(state_data["user_topics"][1]["topic_name"], "general chat")
