...
class Realm(models.Model):  # type: ignore[django-manager-missing] # django-stubs cannot resolve the custom CTEManager yet https://github.com/typeddjango/django-stubs/issues/1023
    ...
    # Who in the organisation is allowed to name
    can_change_own_name_group = models.PositiveSmallIntegerField(default=POLICY_EVERYONE)
...
def can_change_own_name_group(realm: Optional[Realm]) -> bool:
    if realm is None:
        return True
    return realm.can_change_own_name_group == settings.POLICY_EVERYONE
