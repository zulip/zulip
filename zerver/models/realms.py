...
class Realm(models.Model):
    ...
    # Whether AI agents may access the organization through the
    # server's native MCP (Model Context Protocol) endpoint.
    enable_mcp_access = models.BooleanField(default=False, db_default=False)
