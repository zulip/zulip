...
class Realm(models.Model):  # type: ignore[django-manager-missing] # django-stubs cannot resolve the custom CTEManager yet https://github.com/typeddjango/django-stubs/issues/1023
    ...
    abuse_report_channel = models.ForeignKey(
        "Stream",
        related_name="+",
        null=True,
        blank=True,
    ...
    def get_abuse_report_channel(self) -> Optional["Stream"]:
        if self.abuse_report_channel is not None and not self.abuse_report_channel.deactivated:
            return self.abuse_report_channel
        return None
