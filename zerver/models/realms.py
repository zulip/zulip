...
class Realm(models.Model):
    ...
    MAX_REALM_WELCOME_MESSAGE_CUSTOM_TEXT_LENGTH = 1000
    ...
    welcome_message_custom_text = models.TextField(
        default="", max_length=MAX_REALM_WELCOME_MESSAGE_CUSTOM_TEXT_LENGTH
    )
