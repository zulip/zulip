...
class AbstractRealmAuditLog(models.Model):
    ...
    USER_AVATAR_SOURCE_CHANGED_NEW_VALUE = 123
    USER_FULL_NAME_CHANGED = 124
    USER_EMAIL_CHANGED_NEW_VALUE = 125
    ...
    STRIPE_CUSTOMER_CREATED_NEW_VALUE = 401
    STRIPE_CARD_CHANGED = 402
    STRIPE_PLAN_CHANGED_NEW_VALUE = 403
    STRIPE_PLAN_QUANTITY_RESET_NEW_VALUE = 404
