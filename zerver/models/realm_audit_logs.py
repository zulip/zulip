...
class AuditLogEventType(IntEnum):
    ...
    USER_CUSTOM_PROFILE_FIELD_VALUE_CHANGED = 136
    ...
    REALM_CUSTOM_PROFILE_FIELD_CREATED = 231
    REALM_CUSTOM_PROFILE_FIELD_UPDATED = 232
    REALM_CUSTOM_PROFILE_FIELD_DELETED = 233
    REALM_CUSTOM_PROFILE_FIELD_ORDER_CHANGED = 234
