...
class RealmFilter(models.Model):
    ...
    def clean(self) -> None:
        ...
        if (example_input is None) != (reverse_template is None):
            raise ValidationError(
                _("example_input and reverse_template must either both be set or both be null.")
            )
        ...
        if example_input is not None:
            ...
            # If example_input is not None, reverse_template will also
            # not be None due to our previous check.
