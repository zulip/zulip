...
class AbstractMessage(models.Model):
    ...
    # A list of URL strings whose link previews have been hidden by a
    # user with permission to edit the message content.  None for the
    # common case where no previews have been hidden.
    hidden_preview_urls = models.JSONField(default=None, null=True)
