...
class Stream(models.Model):
    ...
    stream_topic_access_group = models.ForeignKey(
        UserGroup,
    ...
    stream_permission_group_settings = {
        ...
        "stream_topic_access_group": GroupPermissionSetting(
            require_system_group=True,
            allow_internet_group=False,
            allow_owners_group=False,
            allow_nobody_group=False,
            ...
            id_field_name="stream_topic_access_group_id",
        ),
    }
    ...
    def is_support_stream(self) -> bool:
        return self.stream_topic_access_group.named_user_group.name != SystemGroups.EVERYONE
    ...
    def to_dict(self) -> DefaultStreamDict:
        return DefaultStreamDict(
            ...
            stream_topic_access_group=self.stream_topic_access_group_id,
...
def get_realm_stream(stream_name: str, realm_id: int) -> Stream:
    return Stream.objects.select_related("stream_topic_access_group__named_user_group").get(
...
def get_stream_by_id_in_realm(stream_id: int, realm: Realm) -> Stream:
    return Stream.objects.select_related(
        "realm", "recipient", "stream_topic_access_group__named_user_group"
