...
class UserBaseSettings(models.Model):
    ...
    enable_reaction_audible_notifications = models.BooleanField(default=True, db_default=True)
    enable_reaction_desktop_notifications = models.BooleanField(default=True, db_default=True)
