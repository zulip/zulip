...
def check_phone_number(var_name: str, val: object) -> str:
    # Ensure it's at least a string first
    ...
    try:
        ...
        # Store in E.164 format (e.g. +15550101010)
...
def format_phone_number(val: Any) -> str:
    # We already know it's valid because the validator runs first.
    # This function just formats it before saving it to the DB.
