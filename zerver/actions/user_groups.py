...
def update_users_in_full_members_system_group(
    ...
    *,
    acting_user: UserProfile | None,
    skip_workplace_audit_log_and_ledger_entry: bool = False,
) -> None:
    ...
    if len(old_full_members) > 0:
        bulk_remove_members_from_user_groups(
            ...
            old_full_member_ids,
            acting_user=acting_user,
            skip_workplace_audit_log_and_ledger_entry=skip_workplace_audit_log_and_ledger_entry,
        )
...
def bulk_add_members_to_user_groups(
    ...
    *,
    ...
    if (
        not skip_workplace_audit_log_and_ledger_entry
