...
def do_send_user_group_update_event(
    user_group: NamedUserGroup, data: dict[str, str | int | UserGroupMembersDataDict]
) -> None:
...
def do_change_user_group_permission_setting(
    ...
    *,
    old_setting_api_value: int | UserGroupMembersDataDict | None = None,
    acting_user: UserProfile | None,
) -> None:
    ...
    event_data_dict: dict[str, str | int | UserGroupMembersDataDict] = {
