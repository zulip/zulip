...
def check_time_limit_for_change_all_or_stream_edit_request(
    message: Message,
    user_profile: UserProfile,
    stream_id: int | None,
    topic_name: str | None,
    ...
    if (
        ...
        and user_profile.realm.move_messages_between_streams_limit_seconds is not None
...
def check_message_or_topic_edit_permissions(
    user_profile: UserProfile,
    message: Message,
    stream_id: int | None,
    topic_name: str | None,
    ...
    if topic_name is not None:
        if is_resolve_topic_request(message, topic_name, propagate_mode, content):
            ...
            check_message_or_topic_edit_permissions(
                user_profile, message, stream_id, topic_name, edit_limit_buffer
            )
