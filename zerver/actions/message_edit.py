...
def _do_hide_preview_url(
    ...
    message.hidden_preview_urls = hidden_urls
    ...
    # Embed data is rendered to HTML immediately and is not stored
    # structurally, so any non-hidden URL whose embed data is not
    # supplied here must be re-fetched by the embed worker.
