...
def validate_message_edit_payload(
    ...
    """
    Checks that the data sent is well-formed. Does not handle editability (but
    checks for races in message edit requests), permissions etc.
    """
    ...
    if content is not None and prev_content_sha256 != utils.sha256_hash(message.content):
...
def check_update_message(
    ...
    if prev_content_sha256 is None:
        ...
        prev_content_sha256 = utils.sha256_hash(message.content)
