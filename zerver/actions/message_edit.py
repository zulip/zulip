...
def get_alert_words_for_message_updates(message: Message) -> set[int]:
    alert_word_user_ids = (
        UserMessage.objects.filter(
            message=message.id,
            flags=~UserMessage.flags.historical,
    ...
    return set(alert_word_user_ids) & user_ids_having_message_access
...
def update_message_content(
    ...
    prior_alert_word_user_ids: set[int],
    ...
    event["prior_alert_word_user_ids"] = list(prior_alert_word_user_ids)
    ...
    # We are not sending mobile push notifications for alert words
    # So we don't need to update mobile push notifications for alert words.
...
def check_update_message(
    ...
    if message_edit_request.is_content_edited:
        ...
        prior_alert_word_user_ids = get_alert_words_for_message_updates(message)
