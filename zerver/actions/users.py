...
from zerver.lib.stream_subscription import update_user_streams_subscriber_count
...
def change_user_is_active(user_profile: UserProfile, value: bool) -> None:
    ...
    with transaction.atomic(savepoint=False):
        ...
        # This must be called after updating Subscription above.
        update_user_streams_subscriber_count(activate=value, user_profile=user_profile)
