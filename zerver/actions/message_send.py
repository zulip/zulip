    ...
    for user_profile_id in um_eligible_user_ids | triggered_service_bots:
        ...
        if (
            ...
            or (
                ...
                # To that end, we want to make sure that all messages
                # where the service bots are part of the recipients and
                # the bot's function is not triggered are marked as read
                # by them.
