...
def get_recipients_for_user_creation_events(
    ...
    # already has access to every other user. So no need to proceed.
    ...
    # TODO: The following code path executes 4 queries.
    # While this is for only a new DirectMessageGroup, it's still worth optimizing.
    # Also because these functions are called in other code paths.
