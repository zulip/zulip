...
def do_invite_users(
    ...
    *,
    ...
    for invitee in invitees:
        if invitee.email == "":
            continue  # nocoverage -- this is a defensive check in case previous callers didn't filter the empty emails.
    ...
    """
    error_dict = get_existing_user_errors(realm, {invitee.email for invitee in good_invitees})
