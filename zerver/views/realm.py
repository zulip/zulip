...
def update_realm(
        ...
        allow_message_deleting_by_admin: Optional[bool]=REQ(validator=check_bool, default=None),
        allow_message_deleting_by_user: Optional[bool]=REQ(validator=check_bool, default=None),
