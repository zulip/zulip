...
def update_realm(
        ...
        name: Optional[str]=REQ(validator=check_string, default=None, type=str),
        description: Optional[str]=REQ(validator=check_string, default=None, type=str),
        restricted_to_domain: Optional[bool]=REQ(validator=check_bool, default=None, type=bool),
        invite_required: Optional[bool]=REQ(validator=check_bool, default=None, type=bool),
        invite_by_admins_only: Optional[bool]=REQ(validator=check_bool, default=None, type=bool),
        name_changes_disabled: Optional[bool]=REQ(validator=check_bool, default=None, type=bool),
        email_changes_disabled: Optional[bool]=REQ(validator=check_bool, default=None, type=bool),
        inline_image_preview: Optional[bool]=REQ(validator=check_bool, default=None, type=bool),
        inline_url_embed_preview: Optional[bool]=REQ(validator=check_bool, default=None, type=bool),
        create_stream_by_admins_only: Optional[bool]=REQ(validator=check_bool, default=None, type=bool),
        add_emoji_by_admins_only: Optional[bool]=REQ(validator=check_bool, default=None, type=bool),
        create_generic_bot_by_admins_only: Optional[bool]=REQ(validator=check_bool,
                                                              default=None, type=bool),
        allow_message_deleting: Optional[bool]=REQ(validator=check_bool, default=None, type=bool),
        allow_message_editing: Optional[bool]=REQ(validator=check_bool, default=None, type=bool),
        mandatory_topics: Optional[bool]=REQ(validator=check_bool, default=None, type=bool),
        message_content_edit_limit_seconds: Optional[int]=REQ(converter=to_non_negative_int,
                                                              default=None, type=int),
        allow_edit_history: Optional[bool]=REQ(validator=check_bool, default=None, type=bool),
        default_language: Optional[str]=REQ(validator=check_string, default=None, type=str),
        waiting_period_threshold: Optional[int]=REQ(converter=to_non_negative_int,
                                                    default=None, type=int),
        authentication_methods: Optional[Dict[Any, Any]]=REQ(validator=check_dict([]),
                                                             default=None, type=dict),
        notifications_stream_id: Optional[int]=REQ(validator=check_int, default=None, type=int),
        signup_notifications_stream_id: Optional[int]=REQ(validator=check_int, default=None, type=int),
        message_retention_days: Optional[int]=REQ(converter=to_not_negative_int_or_none,
                                                  default=None, type=int)
) -> HttpResponse:
