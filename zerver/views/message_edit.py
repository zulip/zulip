...
def get_message_edit_history(
    ...
    *,
    ...
    user_realm_message_edit_history_visibility = user_profile.realm.message_edit_history_visibility
    if (
        user_realm_message_edit_history_visibility
    ...
    visible_raw_edit_history = visible_edit_history_for_message(
        user_realm_message_edit_history_visibility, raw_edit_history
    )

    # Fill in all the extra data that will make it usable
    message_edit_history = fill_edit_history_entries(visible_raw_edit_history, message)
