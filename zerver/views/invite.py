...
def invite_users_backend(request, user_profile,
                         ...
                         invited_as_admin=REQ(validator=check_bool, default=False),
    ...
    if invited_as_admin and not user_profile.is_realm_admin:
        return json_error(_("Must be a realm administrator"))
    ...
    do_invite_users(user_profile, invitee_emails, streams, invited_as_admin, body)
    return json_success()
