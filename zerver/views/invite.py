...
def invite_users_backend(
    ...
    *,
    ...
    # For invites created by:
    # Admin users: The value provided in the request is used.
    # Non-admin users: The value of `welcome_message_custom_text`
    # realm setting is used, if configured. Non-admin users are
    # not allowed to send customized welcome messages.
    if welcome_message_custom_text is None:
        if not user_profile.is_realm_admin and user_profile.realm.welcome_message_custom_text:
