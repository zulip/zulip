...
def create_nextcloud_talk_url(
    ...
    *,
    ...
    # Guests can join by visiting the URL and entering their name
    api_url = urljoin(settings.NEXTCLOUD_SERVER, "/ocs/v2.php/apps/spreed/api/v2/room")
    ...
    # Construct guest-accessible URL
