...
def check_thumbnail_status(
    ...
    *,
    ...
    try:
        ...
        # Not an image file, or the image is too large/corrupted to thumbnail
        return json_success(request, data={"has_thumbnail": False})

    needed = missing_thumbnails(image_attachment)

    return json_success(request, data={"has_thumbnail": len(needed) == 0})
