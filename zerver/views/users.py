...
def update_user_by_id_api(
    ...
    *,
    ...
    #    Question: I added upload handling inside the PATCH API instead of creating a separate POST.
    #    Should we separate this into a dedicated endpoint for clarity?
