    ...
    if bot_type is not None and bot.bot_type != bot_type:
        ...
        match bot_type:
            ...
            case UserProfile.EMBEDDED_BOT:
                # Embedded bots `service_name` must be one of EMBEDDED_BOTS
                # TODO: Update this logic once we want to add support for
                # updating embedded bots.
                service_name = EMBEDDED_BOTS[0].name
