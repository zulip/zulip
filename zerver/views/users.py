...
from zerver.lib.actions import do_change_avatar_fields, do_change_bot_owner, \
    ...
    notify_created_bot, do_update_outgoing_webhook_service
...
def patch_bot_backend(request, user_profile, email,
    ...
    if payload_url is not None:
        ...
        do_update_outgoing_webhook_service(bot, interface_type, payload_url)
    ...
    if payload_url is not None:
        json_result['interface_type'] = interface_type
        json_result['payload_url'] = payload_url
