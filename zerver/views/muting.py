...
def mute_user(user_profile: UserProfile, muted_user_profile: UserProfile) -> HttpResponse:
...
def unmute_user(user_profile: UserProfile, muted_user_profile: UserProfile) -> HttpResponse:
...
@has_request_variables
def add_muted_user(request: HttpRequest, user_profile: UserProfile, muted_user_id: int=REQ()) -> HttpResponse:

     muted_user_profile = get_user_profile_by_id(muted_user_id)
     return mute_user(user_profile, muted_user_profile)

@has_request_variables	
def remove_muted_user(request: HttpRequest, user_profile: UserProfile, muted_user_id: int=REQ()) -> HttpResponse:
