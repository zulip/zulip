...
def add_user_group(
    ...
    *,
    ...
    can_add_members_group: Json[int | UserGroupMembersDataDict] | None = None,
    can_join_group: Json[int | UserGroupMembersDataDict] | None = None,
    can_leave_group: Json[int | UserGroupMembersDataDict] | None = None,
    can_manage_group: Json[int | UserGroupMembersDataDict] | None = None,
    can_mention_group: Json[int | UserGroupMembersDataDict] | None = None,
    can_remove_members_group: Json[int | UserGroupMembersDataDict] | None = None,
) -> HttpResponse:
