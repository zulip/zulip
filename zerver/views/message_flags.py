...
def update_message_flags(
    ...
    *,
    ...
    (count, ignored_because_not_subscribed) = do_update_message_flags(
    ...
    return json_success(
        ...
        data={
            ...
            "ignored_because_not_subscribed": ignored_because_not_subscribed,
        },
    )
...
def update_message_flags_for_narrow(
    ...
    *,
    ...
    (updated_count, ignored_because_not_subscribed) = do_update_message_flags(
        user_profile, operation, flag, messages
    )
