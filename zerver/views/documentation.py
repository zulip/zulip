...
def integrations_catalog(
    ...
    *,
    ...
    context = {}
    context.update(add_catalog_integrations_context(request, category_slug))
...
def integrations_doc(
    ...
    *,
    ...
    context = {}
    context.update(add_doc_integrations_context(request, integration, return_category_slug))
