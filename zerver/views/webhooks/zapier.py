...
def api_zapier_webhook(request, user_profile, client,
                           ...
                           topic=REQ(default='Weather Update')):
  ...
  try:
      ...
      max_temp = payload['temperatureMax']
      body_template = '\n%s Minimium and Maximum expected temperature to be %s and %s respectively' % (summary, min_temp, max_temp)
      body += body_template
