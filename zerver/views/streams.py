...
@require_realm_admin
@has_request_variables
def create_default_stream_group(request, user_profile, group_name=REQ(),
                                stream_names=REQ(validator=check_list(check_string))):
...
@require_realm_admin
@has_request_variables
def update_default_stream_group(request, user_profile, group_name=REQ(), op=REQ(),
                                stream_names=REQ(validator=check_list(check_string))):
...
@require_realm_admin
@has_request_variables
def remove_default_stream_group(request, user_profile, group_name=REQ()):
    # type: (HttpRequest, UserProfile, Text) -> HttpResponse
