...
def update_stream_backend(
    ...
    *,
    ...
    if is_archived is not None and not is_archived and user_profile.is_realm_admin:
        check_stream_access_for_delete_or_update_requiring_metadata_access(user_profile, stream)
