...
from zerver.lib.validator import validate_meeting_data, validate_poll_data, validate_todo_data
...
def process_submessage(
    ...
    *,
    ...
    if widget_type == "meeting":
        try:
            validate_meeting_data(meeting_data=widget_data, is_widget_author=is_widget_author)
        except ValidationError as error:
            raise JsonableError(error.message)
