...
from zerver.lib.actions import do_change_password, do_change_full_name, do_change_is_admin, \
    ...
    do_set_realm_invite_required, do_set_realm_add_stream_by_admins_only,\
    do_set_realm_invite_by_admins_only, get_default_subs, \
...
def home(request):
    ...
    page_params = dict(
        ...
        realm_add_stream_by_admins_only = register_ret['realm_add_stream_by_admins_only'],
...
def update_realm(request, user_profile, name=REQ(validator=check_string, default=None),
                 ...
                 add_stream_by_admins_only=REQ(validator=check_bool, default=None),
    ...
    if add_stream_by_admins_only is not None and realm.add_stream_by_admins_only != add_stream_by_admins_only:
        do_set_realm_add_stream_by_admins_only(realm, add_stream_by_admins_only)
        data['add_stream_by_admins_only'] = add_stream_by_admins_only
