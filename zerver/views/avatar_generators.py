...
def avatar_jdenticon(request: HttpRequest, user_id: int) -> HttpResponse:
...
def avatar_silhouette(request: HttpRequest, user_id: int) -> HttpResponse:
...
def realm_icon_jdenticon(request: HttpRequest, realm_id: int) -> HttpResponse:
