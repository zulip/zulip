...
def json_change_notify_settings(
        ...
        enable_topic_follow_desktop_notifications: Optional[bool]=REQ(validator=check_bool, default=None),
        enable_topic_follow_email_notifications: Optional[bool]=REQ(validator=check_bool, default=None),
        enable_topic_follow_push_notifications: Optional[bool]=REQ(validator=check_bool, default=None),
        enable_topic_follow_audible_notifications: Optional[bool]=REQ(validator=check_bool, default=None),
        enable_topic_follow_wildcard_mentions_notify: Optional[bool]=REQ(validator=check_bool, default=None),
