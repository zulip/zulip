...
def update_display_settings_backend(request, user_profile,
    ...
    # type: (HttpRequest, UserProfile, Optional[bool], Optional[bool], Optional[str], Optional[bool], Optional[bool], Optional[bool], Optional[Text], Optional[Text]) -> HttpResponse
