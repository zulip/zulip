...
from zerver.lib.devices import b64decode_token_id, check_device_id
...
def register_push_device(
    ...
    *,
    ...
    with transaction.atomic(durable=True):
        ...
        token_id = b64decode_token_id(token_id_base64)
        if token_fields_present and not push_key_fields_present:
            ...
            do_rotate_token(user_profile, device, token_id, token_id_base64)
