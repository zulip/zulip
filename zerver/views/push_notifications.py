...
from zerver.lib.push_registration import RegisterPushDeviceToBouncerPayload
...
def register_push_device(
    ...
    *,
    ...
    # TODO: If push notification not configured, return
    ...
    payload: RegisterPushDeviceToBouncerPayload = {
