...
from zerver.lib.markdown import merge_api_changelogs
...
def get_updated_changelog() -> str | None:
    unmerged_changelogs = merge_api_changelogs.get_unmerged_changelogs(verbose=False)
    if not unmerged_changelogs:
        return None

    new_feature_level = merge_api_changelogs.get_feature_level(update_feature_level=False)
    return merge_api_changelogs.merge_changelogs(unmerged_changelogs, new_feature_level, False)
