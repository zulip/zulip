...
def create_user_profile(
    ...
    *,
    ...
    user_profile = UserProfile(
        ...
        bot_type=bot_type,
        bot_owner=bot_owner,
        is_mirror_protouser=is_mirror_protouser,
        is_imported_protouser=is_imported_protouser,
        is_deleted_protouser=is_deleted_protouser,
...
def create_user(
    ...
    is_mirror_protouser: bool = False,
    is_imported_protouser: bool = False,
    is_deleted_protouser: bool = False,
