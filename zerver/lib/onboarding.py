...
""").format(demo_organization_help_url="/help/demo-organizations")
        ...
        inform_about_onboarding_messages_text = ""
        if True:
            inform_about_onboarding_messages_text = _("""
I've kicked off some conversations to help you get started. You can find
them in your [Inbox](/#inbox).
""")

        content = _("""
Hello, and welcome to Zulip!👋 {inform_about_onboarding_messages_text}
...
""").format(
            inform_about_onboarding_messages_text=inform_about_onboarding_messages_text,
