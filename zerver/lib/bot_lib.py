...
def get_bot_handler(service_name):
    ...
    # Assert if this service is present in EMBEDDED_BOT_SERVICES.
    assert any(service_name == embedded_bot_service.name for embedded_bot_service in EMBEDDED_BOT_SERVICES)
