...
def build_page_params_for_home_page_load(
    ...
    # Blocking the HTML response on a returning user's backfill can cost a minute.
    is_long_term_idle = user_profile is not None and user_profile.long_term_idle
    long_term_idle_days: int | None = None
    if is_long_term_idle:
    ...
    page_params: dict[str, object] = dict(
        ...
        long_term_idle_days=long_term_idle_days,
