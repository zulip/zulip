...
def bulk_update_subscriber_counts(
    ...
    # But unlike update_all_subscriber_counts_for_user which uses F() for a single delta value, we can't
...
def create_stream_subscription(
    ...
    """
    Creates a single stream Subscription object, incrementing stream.subscriber_count by 1
