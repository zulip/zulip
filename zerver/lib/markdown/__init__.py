...
class ZulipNormalizeWhitespace(markdown.preprocessors.Preprocessor):
    """Like upstream NormalizeWhitespace, but expands tabs to 2 spaces for list items
    while preserving standard 4-space tab stops inside fenced code blocks.
    ...
    Fixes: https://github.com/zulip/zulip/issues/38436
    """
