...
def user_profile_cache_key(email: str, realm_id: int) -> str:
    return user_profile_cache_key_id(email, realm_id)
...
def delete_user_profile_caches(user_profiles: Iterable["UserProfile"], realm_id: int) -> None:
    ...
    for user_profile in user_profiles:
        ...
        keys.append(user_profile_cache_key(user_profile.email, realm_id))
