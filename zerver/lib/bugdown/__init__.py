...
class EmoticonTranslation(markdown.inlinepatterns.Pattern):
    ...
    def handleMatch(self, match: Match[Text]) -> Optional[Element]:
        ...
        emoji = markdown.util.etree.Element('span')
        emoji.text = translate_emoticons(emoticon)
        return emoji
...
class Bugdown(markdown.Extension):
    ...
    def extendMarkdown(self, md: markdown.Markdown, md_globals: Dict[str, Any]) -> None:
        ...
        md.inlinePatterns.add(
            ...
            Tex(r'\B(?<!\$)\$\$(?P<body>[^\n_$](\\\$|[^$\n])*)\$\$(?!\$)\B'),
            '>backtick')
        md.inlinePatterns.add('translate_emoticons', EmoticonTranslation(emoticon_regex), '_end')
