...
class InlineInterestingLinkProcessor(markdown.treeprocessors.Treeprocessor):
    ...
    def run(self, root: Element) -> None:
        ...
        if self.markdown.zulip_message:
            ...
            if self.markdown.zulip_message.has_link:
                unique_previewable_urls = {
                    url for url in unique_previewable_urls
                    if url not in self.markdown.preview_removed_links}
...
def do_convert(content: str,
    ...
    _md_engine.preview_removed_links = (
        message.preview_removed_links if hasattr(message, 'preview_removed_links') else set())
