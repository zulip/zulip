...
your Zulip app is upgraded. Check out [the announcement
post]({flutter_release_blog_post}) for information about the app and how to
share your feedback.
""".format(
            flutter_release_blog_post="https://blog.zulip.com/zulip-flutter-launch/",
        ),
    ),
]
