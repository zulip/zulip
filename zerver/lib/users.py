...
def check_payload_for_bot_type(
    ...
    if bot_type not in (UserProfile.INCOMING_WEBHOOK_BOT, UserProfile.EMBEDDED_BOT) and config_data:
        raise JsonableError(_("This bot type doesn't use config_data."))
