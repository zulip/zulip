...
def do_create_user(email: str, password: Optional[str], realm: Realm, full_name: str,
                   bot_type: Optional[int]=None, user_avatar_url: str="",
                   role: Optional[int]=None, bot_owner: Optional[UserProfile]=None,
    ...
    user_profile = create_user(email=email, password=password, realm=realm,
                               ...
                               user_avatar_url=user_avatar_url, avatar_source=avatar_source,
