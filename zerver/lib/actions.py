...
def make_unique_display_name(target_realm: Realm, full_name: Text) -> Text:
    full_name_counter = 1
    full_name_initial = full_name
    while UserProfile.objects.filter(realm=target_realm).filter(full_name=full_name).exists():
