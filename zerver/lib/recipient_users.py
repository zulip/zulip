...
def get_recipient_from_user_profiles(
    ...
    # This is only for 1:1 or to-self direct messages.
    # We want to use direct message group as an alternative if exists.
    # Otherwise, we will use the legacty personal recipient.
