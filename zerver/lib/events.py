...
from zerver.lib.video_calls import (
    get_effective_jitsi_server_url,
    get_jitsi_jwt_config,
    server_jitsi_jwt_configured,
)
...
def fetch_initial_state_data(
    ...
    *,
    ...
    if want("realm"):
        ...
        state["jitsi_jwt_enabled"] = get_jitsi_jwt_config(realm) is not None
