...
from zerver.models.streams import get_default_stream_groups, get_topic_pins
...
def fetch_initial_state_data(
    ...
    *,
    ...
    if want("user_topic"):
        ...
        state["pin_realm_stream_topics"] = list(
            get_topic_pins(realm).values_list("stream_id", "topic_name")
        )
