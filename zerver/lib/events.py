...
def fetch_initial_state_data(
    ...
    *,
    ...
    # Miatsu.co fork version and capability flags; see zerver/lib/miatsu.py.
    state["miatsu_version"] = MIATSU_VERSION
    state["miatsu_capabilities"] = list(MIATSU_CAPABILITIES)
