...
def fetch_initial_state_data(
    ...
    *,
    ...
    if want("realm_user"):
        ...
        state["can_change_own_name_group"] = settings_user.can_change_own_name_group()
    ...
    if event["type"] == "message":
        ...
        if event["op"] == "add":
            ...
            if is_me:
                ...
                if "role" in person:
                    ...
                    state["can_change_own_name_group"] = user_profile.can_change_own_name_group()
        ...
        if event["op"] == "update":
            ...
            policy_permission_dict = {
                "can_change_own_name_group": "can_change_own_name_group",
