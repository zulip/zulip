...
from zerver.webhooks.fixtureless_integrations import (
    FIXTURELESS_INTEGRATIONS,
    FIXTURELESS_SCREENSHOT_CONTENT,
)
...
class Integration:
    ...
    def __init__(
        ...
        elif self.name in FIXTURELESS_INTEGRATIONS:
...
WEBHOOK_INTEGRATIONS: list[WebhookIntegration] = [
    ...
    WebhookIntegration(
        "github",
        ["version-control"],
        [WebhookScreenshotConfig("push__1_commit.json")],
        display_name="GitHub",
    ...
    WebhookIntegration(
        "gitlab",
        ["version-control"],
        [WebhookScreenshotConfig("push_hook__push_local_branch_without_commits.json")],
        display_name="GitLab",
        url_options=[WebhookUrlOption(name="branches", label="", validator=check_string)],
    ),
    WebhookIntegration(
    ...
    WebhookIntegration(
        "slack", ["communication"], [WebhookScreenshotConfig("message_with_normal_text.json")]
    ),
    WebhookIntegration(
        "sonarqube",
        ["continuous-integration"],
