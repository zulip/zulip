...
# Worker process context for parallel message import, using ContextVar of a dataclass (Zulip style)
@dataclass
...
def _initialize_message_worker(
    ...
    # Store context in a ContextVar holding a dataclass, following Zulip style
