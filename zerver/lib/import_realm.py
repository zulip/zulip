...
def do_import_realm(import_dir: Path, subdomain: str, processes: int = 1) -> Realm:
    ...
    # is deterministically generated using user ID as input value. Since user ID
    # possibly changes on import, the resulting Jdenticon would differ.
    # We regenerate it here using the current user ID.
