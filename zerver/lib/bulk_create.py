...
from typing import Any, Tuple, Set, Union
...
def bulk_create_users(realms, users_raw, bot_type=None):
    # type: (Dict[Any, Realm], Set[Tuple[Any, Any, Any, bool]], bool) -> None
    """
...
def bulk_create_streams(realms, stream_list):
    # type: (Dict[Any, Realm], Union[Set[Tuple[Any, Any]], List[Tuple[Any, Any]]]) -> None
...
def bulk_create_huddles(users, huddle_user_list):
    # type: (Dict[Any, Any], Set[Tuple[Any, ...]]) -> None
    huddles = {}
    huddles_by_id = {}
    huddle_set = set()
