...
#
# Note that here REQ claims to return a type matching that of the
# parameter of which it is the default value, allowing type
# checking. In reality, REQ returns an instance of class _REQ to
# enable the decorator to scan the parameter list for _REQ objects and
# patch the parameters as the true types.
