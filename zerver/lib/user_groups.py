...
# These recursive lookups use standard SQL common table expression
# (CTE) queries via the django-cte library, since they are not yet
# supported by upstream Django.
#
