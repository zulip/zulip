...
class UserProfile(AbstractBaseUser, PermissionsMixin):
    ...
    notification_setting_types = dict(
        ...
        enable_topic_follow_desktop_notifications=bool,
        enable_topic_follow_email_notifications=bool,
        enable_topic_follow_push_notifications=bool,
        enable_topic_follow_audible_notifications=bool,
        enable_topic_follow_wildcard_mentions_notify=bool,
