...
class UserBaseSettings(models.Model):
    ...
    enable_dm_reactions_notifications = models.BooleanField(default=True)
    enable_followed_topics_reactions_notifications = models.BooleanField(default=True)
    enable_unmuted_topic_reactions_notifications = models.BooleanField(default=True)
    ...
    modern_notification_settings: Dict[str, Any] = dict(
        ...
        enable_dm_reactions_notifications=bool,
        enable_followed_topics_reactions_notifications=bool,
        enable_unmuted_topic_reactions_notifications=bool,
    )
