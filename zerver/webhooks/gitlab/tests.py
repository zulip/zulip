...
~~~
    ...
    def test_deployment_started_event_message(self) -> None:
        ...
        expected_message = "A new [deployment](https://gitlab.com/vedant8600317/test/-/jobs/9905389091) was started."

        self.check_webhook(
            "deployment_hook__started",
            expected_topic_name,
            expected_message,
    ...
    def test_deployment_succeeded_event_message(self) -> None:
        expected_topic_name = "test"
        expected_message = "A [deployment](https://gitlab.com/vedant8600317/test/-/jobs/9905389091) was successful."

        self.check_webhook(
            "deployment_hook__succeeded",
            expected_topic_name,
            expected_message,
            HTTP_X_GITLAB_EVENT="Deployment Hook",
        )
    ...
    def test_deployment_failed_event_message(self) -> None:
        expected_topic_name = "test"
        expected_message = (
            "A [deployment](https://gitlab.com/vedant8600317/test/-/jobs/9905759933) failed."
        )
    ...
    def test_deployment_canceled_event_message(self) -> None:
        expected_topic_name = "test"
        expected_message = (
            "A [deployment](https://gitlab.com/vedant8600317/test/-/jobs/9905830127) was canceled."
        )
