...
class GitlabHookTests(WebhookTestCase):
    ...
    def test_push_event_message(self) -> None:
        expected_subject = "my-awesome-project / tomek"
    ...
    def test_push_local_branch_without_commits(self) -> None:
        expected_subject = "my-awesome-project / changes"
    ...
    def test_add_tag_event_message(self) -> None:
        expected_subject = "my-awesome-project"
    ...
    def test_create_issue_without_assignee_event_message(self) -> None:
        expected_subject = "my-awesome-project / Issue #1 Issue title"
    ...
    def test_update_issue_event_message(self) -> None:
        expected_subject = "my-awesome-project / Issue #1 Issue title_new"
    ...
    def test_note_merge_request_event_message(self) -> None:
        expected_subject = "my-awesome-project / MR #1 Tomek"
    ...
    def test_note_issue_event_message(self) -> None:
        expected_subject = "my-awesome-project / Issue #2 abc"
    ...
    def test_note_snippet_event_message(self) -> None:
        expected_subject = "my-awesome-project / Snippet #2 test"
    ...
    def test_merge_request_created_without_assignee_event_message(self) -> None:
        expected_subject = "my-awesome-project / MR #2 NEW MR"
        expected_message = "Tomasz Kolek created [MR #2](https://gitlab.com/tomaszkolek0/my-awesome-project/merge_requests/2)\nfrom `tomek` to `master`\n\n~~~ quote\ndescription of merge request\n~~~"
    ...
    def test_merge_request_created_with_assignee_event_message(self) -> None:
        expected_subject = "my-awesome-project / MR #3 New Merge Request"
        expected_message = "Tomasz Kolek created [MR #3](https://gitlab.com/tomaszkolek0/my-awesome-project/merge_requests/3)(assigned to Tomasz Kolek)\nfrom `tomek` to `master`\n\n~~~ quote\ndescription of merge request\n~~~"
        self.send_and_test_stream_message(
    ...
    def test_merge_request_reopened_event_message(self) -> None:
        expected_subject = "my-awesome-project / MR #1 Update the README with author ..."
    ...
    def test_build_created_event_message(self) -> None:
        expected_subject = "my-awesome-project / master"
