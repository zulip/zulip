...
def get_deployment_event_body(payload: WildValue, include_title: bool) -> str:
    ...
    deployment_event_body_map = {
        "running": f"A new {deployment_text} was started.",
        "success": f"A {deployment_text} was successful.",
        "failed": f"A {deployment_text} failed.",
        "canceled": f"A {deployment_text} was canceled.",
    }
