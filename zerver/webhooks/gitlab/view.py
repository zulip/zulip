...
EVENT_FUNCTION_MAPPER: dict[str, EventFunction] = {
    ...
    "Issue Hook Incident open": partial(get_work_item_event_body, "created"),
    ...
    "Issue Hook Task open": partial(get_work_item_event_body, "created"),
    ...
    "Issue Hook Key Result open": partial(get_work_item_event_body, "created"),
    ...
    "Issue Hook Objective open": partial(get_work_item_event_body, "created"),
    ...
    "Issue Hook Test Case open": partial(get_work_item_event_body, "created"),
    ...
    "Issue Hook Requirement open": partial(get_work_item_event_body, "created"),
    ...
    "Confidential Issue Hook Incident open": partial(get_work_item_event_body, "created"),
    ...
    "Confidential Issue Hook Task open": partial(get_work_item_event_body, "created"),
    ...
    "Confidential Issue Hook Key Result open": partial(get_work_item_event_body, "created"),
    ...
    "Confidential Issue Hook Objective open": partial(get_work_item_event_body, "created"),
    ...
    "Confidential Issue Hook Test Case open": partial(get_work_item_event_body, "created"),
