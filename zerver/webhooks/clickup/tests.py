...
from .api_endpoints import get_clickup_api_data
...
class ClickUpHookTests(WebhookTestCase):
    ...
    def test_get_clickup_api_data_success_request(self) -> None:
        with patch("zerver.webhooks.clickup.api_endpoints.requests.get") as mock_get:
    ...
    def test_get_clickup_api_data_missing_api_token(self) -> None:
        with patch("zerver.webhooks.clickup.api_endpoints.requests"):
