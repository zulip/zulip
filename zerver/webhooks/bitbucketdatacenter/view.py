...
def ping_handler(
    ...
    if include_title:
        ...
        topic_name = "Bitbucket Data Center Ping"
    body = "Congratulations! The Bitbucket Data Center webhook was configured successfully!"
...
@typed_endpoint
def api_bitbucketdatacenter_webhook(
    request: HttpRequest,
