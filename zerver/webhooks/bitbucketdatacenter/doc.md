...
Zulip supports both Git and Mercurial notifications from Bitbucket. This
integration is for the webhooks used by Bitbucket Data Center.

For the new-style webhooks used by Bitbucket Cloud (SAAS service) click
[here](./bitbucket).
