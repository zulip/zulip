...
class BitbucketDataCenterHookTests(WebhookTestCase):
    def test_legacy_urls(self) -> None:
        ...
        for legacy_name in legacy_names:
            ...
            self.check_webhook(
                "repo_push_update_single_branch", expected_topic_name, expected_message
            )

    # Diagnostics events:
    def test_ping(self) -> None:
        expected_message = (
            "Congratulations! The Bitbucket Data Center webhook was configured successfully!"
        )
        self.check_webhook("diagnostics_ping", "Bitbucket Data Center Ping", expected_message)
    ...
    def test_repo_forked(self) -> None:
    ...
    def test_repo_modified(self) -> None:
