...
import hashlib #changed this 
import hmac #changed this

from django.conf import settings #changed this too
from django.http import HttpRequest, HttpResponse, HttpResponseBadRequest, HttpResponseForbidden #bad request and forbidden added
