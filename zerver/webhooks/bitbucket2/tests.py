...
class Bitbucket2HookTests(WebhookTestCase):
    ...
    EXPECTED_SUBJECT_PR_EVENTS = "Repository name / PR #1 new commit"
    EXPECTED_SUBJECT_ISSUE_EVENTS = "Repository name / Issue #1 Bug"
    ...
    def test_bitbucket2_on_commit_status_changed_event(self) -> None:
        expected_message = "[System mybuildtool](https://my-build-tool.com/builds/MY-PROJECT/BUILD-777) changed status of https://bitbucket.org/kolaszek/repository-name/9fec847784abb10b2fa567ee63b85bd238955d0e to SUCCESSFUL."
    ...
    def test_bitbucket2_on_pull_request_created_event(self) -> None:
        expected_message = "kolaszek created [PR #1](https://bitbucket.org/kolaszek/repository-name/pull-requests/1)(assigned to tkolek)\nfrom `new-branch` to `master`\n\n~~~ quote\ndescription\n~~~"
        kwargs = {
    ...
    def test_bitbucket2_on_pull_request_updated_event(self) -> None:
        expected_message = "kolaszek updated [PR #1](https://bitbucket.org/kolaszek/repository-name/pull-requests/1)(assigned to tkolek)\nfrom `new-branch` to `master`\n\n~~~ quote\ndescription\n~~~"
        kwargs = {
