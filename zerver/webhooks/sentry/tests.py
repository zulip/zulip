...
```"""
    ...
    def test_event_for_error_javascript(self) -> None:
        expected_topic_name = "ReferenceError: blooopy is not defined"
        expected_message = """\
:orange_circle: **New error:** [ReferenceError: blooopy is not defined](https://sentry.io/organizations/test-org/issues/1170820242/events/bb78c1407cea4519aa397afc059c793d/)
```quote
**level:** error
