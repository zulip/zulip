...
class DropboxSignHookTests(WebhookTestCase):
    ...
    URL_TEMPLATE = "/api/v1/external/dropbox sign?stream={stream}&api_key={api_key}"
    WEBHOOK_DIR_NAME = "dropbox sign"
    ...
    def get_payload(self, fixture_name: str) -> dict[str, str]:
        return {"json": self.webhook_fixture_data("dropbox sign", fixture_name, file_type="json")}
