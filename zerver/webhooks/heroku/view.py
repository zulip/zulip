...
Addon Attachment - **{name}** was {action} by **{actor}**:
* Addon: **{addon_name}**
"""

ADDON_TEMPLATE = """
Addon - **{name}** was {action} by **{actor}**:
* Service: {service}
* Plan: {plan}
"""

APP_TEMPLATE = """
App - **{name}** was {action} by **{actor}**:
...
BUILD_TEMPLATE = """
Build was {action} by **{actor}**:
* Status: {status}
* Build Stack: {build_stack}
"""

COLLAB_TEMPLATE = "Collaborator **{email}** was {action} by **{actor}**{role}"

DOMAIN_TEMPLATE = """
Domain was {action} by **{actor}**:
* Hostname: {hostname}
* Kind: {kind}
* Status: {status}
"""
...
RELEASE_TEMPLATE = """
Release was {action} by **{actor}**:{current}
* Status: {status}
* Version: {version}{description}
"""

SNI_ENDPOINT_TEMPLATE = "SNI Endpoint - **{name}** was {action} by **{actor}**."
