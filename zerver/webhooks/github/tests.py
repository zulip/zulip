...
class GitHubWebhookTest(WebhookTestCase):
    ...
    def test_pull_request_closed_msg(self) -> None:
        expected_message = ":wastebasket: baxterthehacker closed without merge [PR #1](https://github.com/baxterthehacker/public-repo/pull/1)."
    ...
    def test_pull_request_closed_msg_with_custom_topic_in_url(self) -> None:
        self.url = self.build_webhook_url(topic="notifications")
        expected_topic_name = "notifications"
        expected_message = ":wastebasket: baxterthehacker closed without merge [PR #1 Update the README with new information](https://github.com/baxterthehacker/public-repo/pull/1)."
...
""".strip()
    ...
    def test_check_run_cancelled(self) -> None:
        expected_message = ":not_allowed: Check [cancelled_job](https://github.com/Pritesh-30/test-repo/actions/runs/21484990515/job/61891523612) completed (cancelled). ([00695aa31e3](https://github.com/Pritesh-30/test-repo/commit/00695aa31e31bdd8a79d21372888fa4ee272cff2))"
