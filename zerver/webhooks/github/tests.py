...
class GitHubWebhookTest(WebhookTestCase):
    ...
    # Toggle this flag to switch between previous (False) and new (True) username formatting
    USE_MENTION_FORMAT = False

    def format_username(self, username: str) -> str:
        """Helper method to format usernames based on USE_MENTION_FORMAT."""
        if self.USE_MENTION_FORMAT and username:
            return f"@_**{username}**"
        return username

    def test_ping_event(self) -> None:
        expected_message = f"GitHub webhook has been successfully configured by {self.format_username('Aneesh-Hegde')}."
        self.check_webhook("ping", TOPIC_REPO, expected_message)

    def test_star_event(self) -> None:
        expected_message = f"{self.format_username('Codertocat', 'https://github.com/Codertocat')} starred the repository [Codertocat/Hello-World](https://github.com/Codertocat/Hello-World)."
    ...
    def test_ping_organization_event(self) -> None:
        expected_message = f"GitHub webhook has been successfully configured by {self.format_username('eeshangarg')}."
        self.check_webhook("ping__organization", "zulip-test-org", expected_message)

    def test_push_delete_branch(self) -> None:
        expected_message = f"{self.format_username('eeshangarg')} [deleted](https://github.com/eeshangarg/public-repo/compare/2e8cf535fb38...000000000000) the branch feature."
        self.check_webhook("push__delete_branch", "public-repo / feature", expected_message)

    def test_push_force_1_commit(self) -> None:
        expected_message = f"{self.format_username('sbansal1999')} [force pushed](https://github.com/sbansal1999/zulip/compare/b6de8891fc10...971d76ca3094) 1 commit to branch temp.\n\n* log: Add important.txt which is useful for logging errors. ([971d76ca309](https://github.com/sbansal1999/zulip/commit/971d76ca309446a9c20381f6271cea8a59b4e40a))"
        self.check_webhook("push__force_1_commit", "zulip / temp", expected_message)

    def test_push__force_remove_commits(self) -> None:
        expected_message = f"{self.format_username('sbansal1999')} [force pushed](https://github.com/sbansal1999/zulip/compare/2084a91af9ca...9a8749ea8fe7) the branch temp."
    ...
    def test_push_local_branch_without_commits(self) -> None:
        expected_message = f"{self.format_username('eeshangarg')} [pushed](https://github.com/eeshangarg/public-repo/compare/feature) the branch feature."
        self.check_webhook(
    ...
    def test_push_1_commit(self) -> None:
        expected_message = f"{self.format_username('baxterthehacker')} [pushed](https://github.com/baxterthehacker/public-repo/compare/9049f1265b7d...0d1a26e67d8f) 1 commit to branch changes.\n\n* Update README.md ([0d1a26e67d8](https://github.com/baxterthehacker/public-repo/commit/0d1a26e67d8f5eaf1f6ba5c57fc3c7d91ac0fd1c))"
    ...
    def test_push_1_commit_without_username(self) -> None:
        expected_message = f"{self.format_username('eeshangarg')} [pushed](https://github.com/eeshangarg/public-repo/compare/0383613da871...2e8cf535fb38) 1 commit to branch changes. Commits by John Snow (1).\n\n* Update the README ([2e8cf535fb3](https://github.com/eeshangarg/public-repo/commit/2e8cf535fb38a3dab2476cdf856efda904ad4c94))"
    ...
    def test_push_multiple_committers(self) -> None:
        ...
        expected_message = f"{self.format_username('baxterthehacker')} [pushed](https://github.com/baxterthehacker/public-repo/compare/9049f1265b7d...0d1a26e67d8f) 6 commits to branch changes. Commits by Tomasz (3), Ben (2) and baxterthehacker (1).\n\n{commits_info * 5}* Update README.md ([0d1a26e67d8](https://github.com/baxterthehacker/public-repo/commit/0d1a26e67d8f5eaf1f6ba5c57fc3c7d91ac0fd1c))"
    ...
    def test_push_multiple_committers_with_others(self) -> None:
        commits_info = "* Update README.md ([0d1a26e67d8](https://github.com/baxterthehacker/public-repo/commit/0d1a26e67d8f5eaf1f6ba5c57fc3c7d91ac0fd1c))\n"
        expected_message = f"{self.format_username('baxterthehacker')} [pushed](https://github.com/baxterthehacker/public-repo/compare/9049f1265b7d...0d1a26e67d8f) 10 commits to branch changes. Commits by Tomasz (4), Ben (3), James (2) and others (1).\n\n{commits_info * 9}* Update README.md ([0d1a26e67d8](https://github.com/baxterthehacker/public-repo/commit/0d1a26e67d8f5eaf1f6ba5c57fc3c7d91ac0fd1c))"
    ...
    def test_push_50_commits(self) -> None:
        ...
        expected_message = f"{self.format_username('baxterthehacker')} [pushed](https://github.com/baxterthehacker/public-repo/compare/9049f1265b7d...0d1a26e67d8f) 50 commits to branch changes.\n\n{commit_info * COMMITS_LIMIT}[and 30 more commit(s)]"
    ...
    def test_commit_comment_msg(self) -> None:
        expected_message = f"{self.format_username('baxterthehacker')} [commented](https://github.com/baxterthehacker/public-repo/commit/9049f1265b7d61be4a8904a9a27120d2064dab3b#commitcomment-11056394) on [9049f1265b7](https://github.com/baxterthehacker/public-repo/commit/9049f1265b7d61be4a8904a9a27120d2064dab3b):\n~~~ quote\nThis is a really good change! :+1:\n~~~"
        self.check_webhook("commit_comment", TOPIC_REPO, expected_message)

    def test_create_msg(self) -> None:
        expected_message = f"{self.format_username('baxterthehacker')} created tag 0.0.1."
        self.check_webhook("create", TOPIC_REPO, expected_message)

    def test_delete_msg(self) -> None:
        expected_message = f"{self.format_username('baxterthehacker')} deleted tag simple-tag."
        self.check_webhook("delete", TOPIC_REPO, expected_message)

    def test_deployment_msg(self) -> None:
        expected_message = f"{self.format_username('baxterthehacker')} created new deployment."
    ...
    def test_fork_msg(self) -> None:
        expected_message = f"{self.format_username('baxterandthehackers')} forked [public-repo](https://github.com/baxterandthehackers/public-repo)."
        self.check_webhook("fork", TOPIC_REPO, expected_message)

    def test_issue_comment_msg(self) -> None:
        expected_message = f"{self.format_username('baxterthehacker')} [commented](https://github.com/baxterthehacker/public-repo/issues/2#issuecomment-99262140) on [issue #2](https://github.com/baxterthehacker/public-repo/issues/2):\n\n~~~ quote\nYou are totally right! I'll get this fixed right away.\n~~~"
    ...
    def test_issue_comment_deleted_msg(self) -> None:
        ...
        expected_message = f"{self.format_username('eeshangarg')} deleted a [comment](https://github.com/eeshangarg/Scheduler/issues/5#issuecomment-425164194) on [issue #5](https://github.com/eeshangarg/Scheduler/issues/5):\n\n~~~ quote\nThis is a comment on this new issue.\n~~~"
    ...
    def test_issue_comment_msg_with_custom_topic_in_url(self) -> None:
        ...
        expected_message = f"{self.format_username('baxterthehacker')} [commented](https://github.com/baxterthehacker/public-repo/issues/2#issuecomment-99262140) on [issue #2 Spelling error in the README file](https://github.com/baxterthehacker/public-repo/issues/2):\n\n~~~ quote\nYou are totally right! I'll get this fixed right away.\n~~~"
    ...
    def test_issue_comment_pull_request_comment_msg(self) -> None:
        expected_message = f"{self.format_username('sbansal1999')} [commented](https://github.com/sbansal1999/public-repo/pull/1#issuecomment-1631445420) on [PR #1](https://github.com/sbansal1999/public-repo/pull/1):\n\n~~~ quote\nSome comment\n~~~"
        self.check_webhook("issue_comment__pull_request_comment", TOPIC_PR, expected_message)

    def test_issue_msg(self) -> None:
        expected_message = f"{self.format_username('baxterthehacker')} opened [issue #2](https://github.com/baxterthehacker/public-repo/issues/2):\n\n~~~ quote\nIt looks like you accidentally spelled 'commit' with two 't's.\n~~~"
        self.check_webhook("issues", TOPIC_ISSUE, expected_message)

    def test_issue_msg_with_custom_topic_in_url(self) -> None:
        self.url = self.build_webhook_url(topic="notifications")
        expected_topic_name = "notifications"
        expected_message = f"{self.format_username('baxterthehacker')} opened [issue #2 Spelling error in the README file](https://github.com/baxterthehacker/public-repo/issues/2):\n\n~~~ quote\nIt looks like you accidentally spelled 'commit' with two 't's.\n~~~"
        self.check_webhook("issues", expected_topic_name, expected_message)

    def test_issue_assigned(self) -> None:
        expected_message = f"{self.format_username('sbansal1999')} assigned {self.format_username('sbansal1999')} to [issue #7](https://github.com/sbansal1999/testing-gh/issues/7)."
    ...
    def test_issue_assigned_with_custom_topic_in_url(self) -> None:
        self.url = self.build_webhook_url(topic="notifications")
        expected_topic_name = "notifications"
        expected_message = f"{self.format_username('sbansal1999')} assigned {self.format_username('sbansal1999')} to [issue #7 Testing when issue assigned!](https://github.com/sbansal1999/testing-gh/issues/7)"
        self.check_webhook("issues__assigned", expected_topic_name, expected_message)

    def test_issue_unassigned(self) -> None:
        expected_message = f"{self.format_username('sbansal1999')} unassigned {self.format_username('sbansal1999')} from [issue #9](https://github.com/sbansal1999/testing-gh/issues/9)."
    ...
    def test_issue_unassigned_with_custom_topic_in_url(self) -> None:
        self.url = self.build_webhook_url(topic="notifications")
        expected_topic_name = "notifications"
        expected_message = f"{self.format_username('sbansal1999')} unassigned {self.format_username('sbansal1999')} from [issue #9 idk man](https://github.com/sbansal1999/testing-gh/issues/9)."
        self.check_webhook("issues__unassigned", expected_topic_name, expected_message)

    def test_issue_labeled(self) -> None:
        expected_topic_name = "testing-gh / issue #9 idk man"
        expected_message = f"{self.format_username('sbansal1999', 'https://github.com/sbansal1999')} added the bug label to [Issue #9](https://github.com/sbansal1999/testing-gh/issues/9)."
    ...
    def test_issue_labeled_with_custom_topic_in_url(self) -> None:
        self.url = self.build_webhook_url(topic="notifications")
        expected_topic_name = "notifications"
        expected_message = f"{self.format_username('sbansal1999', 'https://github.com/sbansal1999')} added the bug label to [Issue #9 idk man](https://github.com/sbansal1999/testing-gh/issues/9)."
        self.check_webhook("issues__labeled", expected_topic_name, expected_message)

    def test_issue_unlabeled(self) -> None:
        expected_topic_name = "testing-gh / issue #9 idk man"
        expected_message = f"{self.format_username('sbansal1999', 'https://github.com/sbansal1999')} removed the bug label from [Issue #9](https://github.com/sbansal1999/testing-gh/issues/9)."
    ...
    def test_issue_milestoned(self) -> None:
        ...
        expected_message = f"{self.format_username('sbansal1999', 'https://github.com/sbansal1999')} added milestone [some_random_milestone](https://github.com/sbansal1999/testing-gh/milestone/1) to [issue #6](https://github.com/sbansal1999/testing-gh/issues/6)."
    ...
    def test_issue_milestoned_with_custom_topic_in_url(self) -> None:
        self.url = self.build_webhook_url(topic="notifications")
        expected_topic_name = "notifications"
        expected_message = f"{self.format_username('sbansal1999', 'https://github.com/sbansal1999')} added milestone [some_random_milestone](https://github.com/sbansal1999/testing-gh/milestone/1) to [issue #6 This is a sample issue to test GH Integration Func](https://github.com/sbansal1999/testing-gh/issues/6)."
        self.check_webhook("issues__milestoned", expected_topic_name, expected_message)

    def test_issue_demilestoned(self) -> None:
        expected_topic_name = "testing-gh / issue #6 This is a sample issue to test GH I..."
        expected_message = f"{self.format_username('sbansal1999', 'https://github.com/sbansal1999')} removed milestone [some_random_milestone](https://github.com/sbansal1999/testing-gh/milestone/1) from [issue #6](https://github.com/sbansal1999/testing-gh/issues/6)."
    ...
    def test_issue_transfer_transferred_message(self) -> None:
        expected_message = f"{self.format_username('Aditya8840')} transferred [issue #4 Fixture collection](https://github.com/CrisisCollab/TestWebhook/issues/4) to [CrisisCollab/admin-frontend-mvp/#4](https://github.com/CrisisCollab/admin-frontend-mvp/issues/4)."
    ...
    def test_membership_msg(self) -> None:
        expected_message = f"{self.format_username('baxterthehacker')} added {self.format_username('kdaigle', 'https://github.com/kdaigle')} to the Contractors team."
        self.check_webhook("membership", TOPIC_ORGANIZATION, expected_message)

    def test_membership_removal_msg(self) -> None:
        expected_message = f"{self.format_username('baxterthehacker')} removed {self.format_username('kdaigle', 'https://github.com/kdaigle')} from the Contractors team."
        self.check_webhook("membership__removal", TOPIC_ORGANIZATION, expected_message)

    def test_member_msg(self) -> None:
        expected_message = f"{self.format_username('baxterthehacker')} added {self.format_username('octocat', 'https://github.com/octocat')} to [public-repo](https://github.com/baxterthehacker/public-repo)."
        self.check_webhook("member", TOPIC_REPO, expected_message)

    def test_pull_request_opened_msg(self) -> None:
        expected_message = f"{self.format_username('baxterthehacker')} opened [PR #1](https://github.com/baxterthehacker/public-repo/pull/1) from `baxterthehacker:changes` to `baxterthehacker:master`:\n\n~~~ quote\nThis is a pretty simple change that we need to pull into master.\n~~~"
    ...
    def test_pull_request_opened_with_preassigned_assignee_msg(self) -> None:
        ...
        expected_message = f"{self.format_username('eeshangarg')} opened [PR #4](https://github.com/eeshangarg/Scheduler/pull/4) from `eeshangarg:improve-readme-2` to `eeshangarg:master` (assigned to {self.format_username('eeshangarg')})."
        self.check_webhook(
    ...
    def test_pull_request_opened_msg_with_custom_topic_in_url(self) -> None:
        self.url = self.build_webhook_url(topic="notifications")
        expected_topic_name = "notifications"
        expected_message = f"{self.format_username('baxterthehacker')} opened [PR #1 Update the README with new information](https://github.com/baxterthehacker/public-repo/pull/1) from `baxterthehacker:changes` to `baxterthehacker:master`:\n\n~~~ quote\nThis is a pretty simple change that we need to pull into master.\n~~~"
    ...
    def test_pull_request_synchronized_msg(self) -> None:
        expected_message = f"{self.format_username('baxterthehacker')} updated [PR #1](https://github.com/baxterthehacker/public-repo/pull/1)."
        self.check_webhook("pull_request__synchronized", TOPIC_PR, expected_message)

    def test_pull_request_closed_msg(self) -> None:
        expected_message = f"{self.format_username('baxterthehacker')} closed without merge [PR #1](https://github.com/baxterthehacker/public-repo/pull/1)."
    ...
    def test_pull_request_closed_msg_with_custom_topic_in_url(self) -> None:
        self.url = self.build_webhook_url(topic="notifications")
        expected_topic_name = "notifications"
        expected_message = f"{self.format_username('baxterthehacker')} closed without merge [PR #1 Update the README with new information](https://github.com/baxterthehacker/public-repo/pull/1)."
        self.check_webhook("pull_request__closed", expected_topic_name, expected_message)

    def test_pull_request_merged_msg(self) -> None:
        expected_message = f"{self.format_username('baxterthehacker')} merged [PR #1](https://github.com/baxterthehacker/public-repo/pull/1)."
    ...
    def test_public_msg(self) -> None:
        expected_message = f"{self.format_username('baxterthehacker')} made the repository [baxterthehacker/public-repo](https://github.com/baxterthehacker/public-repo) public."
        self.check_webhook("public", TOPIC_REPO, expected_message)

    def test_wiki_pages_msg(self) -> None:
        expected_message = f"{self.format_username('jasonrudolph')}:\n* created [Home](https://github.com/baxterthehacker/public-repo/wiki/Home)\n* created [Home](https://github.com/baxterthehacker/public-repo/wiki/Home)"
        self.check_webhook("gollum__wiki_pages", TOPIC_WIKI, expected_message)

    def test_watch_msg(self) -> None:
        expected_message = f"{self.format_username('baxterthehacker')} starred the repository [baxterthehacker/public-repo](https://github.com/baxterthehacker/public-repo)."
        self.check_webhook("watch__repository", TOPIC_REPO, expected_message)

    def test_repository_msg(self) -> None:
        expected_message = f"{self.format_username('baxterthehacker')} created the repository [baxterandthehackers/public-repo](https://github.com/baxterandthehackers/public-repo)."
    ...
    def test_release_msg(self) -> None:
        expected_message = f"{self.format_username('baxterthehacker')} published release [0.0.1](https://github.com/baxterthehacker/public-repo/releases/tag/0.0.1) for tag 0.0.1."
    ...
    def test_page_build_msg(self) -> None:
        expected_message = f"GitHub Pages build, triggered by {self.format_username('baxterthehacker')}, has finished building."
        self.check_webhook("page_build", TOPIC_REPO, expected_message)

    def test_page_build_errored_msg(self) -> None:
        expected_message = f"GitHub Pages build, triggered by {self.format_username('baxterthehacker')}, has failed: \n~~~ quote\nSomething went wrong.\n~~~."
    ...
    def test_pull_request_review_msg(self) -> None:
        expected_message = f"{self.format_username('baxterthehacker')} submitted [PR review](https://github.com/baxterthehacker/public-repo/pull/1#pullrequestreview-2626884):\n\n~~~ quote\nLooks great!\n~~~"
    ...
    def test_pull_request_review_msg_with_custom_topic_in_url(self) -> None:
        self.url = self.build_webhook_url(topic="notifications")
        expected_topic_name = "notifications"
        expected_message = f"{self.format_username('baxterthehacker')} submitted [PR review for #1 Update the README with new information](https://github.com/baxterthehacker/public-repo/pull/1#pullrequestreview-2626884):\n\n~~~ quote\nLooks great!\n~~~"
    ...
    def test_pull_request_review_msg_with_empty_body(self) -> None:
        ...
        expected_message = f"{self.format_username('kou')} submitted [PR review](https://github.com/groonga/groonga/pull/1581#pullrequestreview-1483047907)."
    ...
    def test_pull_request_review_comment_msg(self) -> None:
        expected_message = f"{self.format_username('baxterthehacker')} created [PR review comment](https://github.com/baxterthehacker/public-repo/pull/1#discussion_r29724692):\n\n~~~ quote\nMaybe you should use more emojji on this line.\n~~~"
    ...
    def test_pull_request_review_comment_with_custom_topic_in_url(self) -> None:
        self.url = self.build_webhook_url(topic="notifications")
        expected_topic_name = "notifications"
        expected_message = f"{self.format_username('baxterthehacker')} created [PR review comment on #1 Update the README with new information](https://github.com/baxterthehacker/public-repo/pull/1#discussion_r29724692):\n\n~~~ quote\nMaybe you should use more emojji on this line.\n~~~"
    ...
    def test_pull_request_locked(self) -> None:
        expected_message = f"{self.format_username('tushar912')} has locked [PR #1](https://github.com/tushar912/public-repo/pull/1) as off-topic and limited conversation to collaborators."
        self.check_webhook("pull_request__locked", TOPIC_PR, expected_message)

    def test_pull_request_unlocked(self) -> None:
        expected_message = f"{self.format_username('tushar912')} has unlocked [PR #1](https://github.com/tushar912/public-repo/pull/1)."
        self.check_webhook("pull_request__unlocked", TOPIC_PR, expected_message)

    def test_pull_request_auto_merge_enabled(self) -> None:
        expected_message = f"{self.format_username('tushar912')} has enabled auto merge for [PR #1](https://github.com/tushar912/public-repo/pull/1)."
    ...
    def test_pull_request_auto_merge_disabled(self) -> None:
        expected_message = f"{self.format_username('tushar912')} has disabled auto merge for [PR #1](https://github.com/tushar912/public-repo/pull/1)."
        self.check_webhook("pull_request__auto_merge_disabled", TOPIC_PR, expected_message)

    def test_push_tag_msg(self) -> None:
        expected_message = f"{self.format_username('baxterthehacker')} pushed tag abc."
        self.check_webhook("push__tag", TOPIC_REPO, expected_message)

    def test_pull_request_edited_msg(self) -> None:
        expected_message = f"{self.format_username('baxterthehacker')} edited [PR #1](https://github.com/baxterthehacker/public-repo/pull/1)."
        self.check_webhook("pull_request__edited", TOPIC_PR, expected_message)

    def test_pull_request_edited_with_body_change(self) -> None:
        expected_message = f"{self.format_username('cozyrohan')} edited [PR #1](https://github.com/cozyrohan/public-repo/pull/1):\n\n~~~ quote\nPR EDITED\n~~~"
    ...
    def test_pull_request_assigned_msg(self) -> None:
        expected_message = f"{self.format_username('baxterthehacker')} assigned {self.format_username('baxterthehacker')} to [PR #1](https://github.com/baxterthehacker/public-repo/pull/1)."
    ...
    def test_pull_request_assigned_msg_with_custom_topic_in_url(self) -> None:
        self.url = self.build_webhook_url(topic="notifications")
        expected_topic_name = "notifications"
        expected_message = f"{self.format_username('baxterthehacker')} assigned {self.format_username('baxterthehacker')} to [PR #1 Update the README with new information](https://github.com/baxterthehacker/public-repo/pull/1)."
    ...
    def test_pull_request_unassigned_msg(self) -> None:
        expected_message = f"{self.format_username('eeshangarg')} unassigned {self.format_username('eeshangarg')} from [PR #1](https://github.com/zulip-test-org/helloworld/pull/1)."
    ...
    def test_pull_request_unassigned_msg_with_custom_topic_in_url(self) -> None:
        self.url = self.build_webhook_url(topic="notifications")
        expected_topic_name = "notifications"
        expected_message = f"{self.format_username('eeshangarg')} unassigned {self.format_username('eeshangarg')} from [PR #1 Mention that Zulip rocks!](https://github.com/zulip-test-org/helloworld/pull/1)"
        self.check_webhook("pull_request__unassigned", expected_topic_name, expected_message)

    def test_pull_request_ready_for_review_msg(self) -> None:
        expected_message = f"**{self.format_username('Hypro999')}** has marked [PR #2](https://github.com/Hypro999/temp-test-github-webhook/pull/2) as ready for review."
        self.check_webhook(
    ...
    def test_pull_request_review_requested_msg(self) -> None:
        expected_message = f"**{self.format_username('eeshangarg')}** requested {self.format_username('showell', 'https://github.com/showell')} for a review on [PR #1](https://github.com/eeshangarg/Scheduler/pull/1)."
        self.check_webhook(
    ...
    def test_pull_request__review_requested_team_reviewer_msg(self) -> None:
        expected_message = f"**{self.format_username('singhsourabh')}** requested [authority](https://github.com/orgs/test-org965/teams/authority) for a review on [PR #4](https://github.com/test-org965/webhook-test/pull/4)."
        self.check_webhook(
    ...
    def test_pull_request_review_requested_with_custom_topic_in_url(self) -> None:
        self.url = self.build_webhook_url(topic="notifications")
        expected_topic_name = "notifications"
        expected_message = f"**{self.format_username('eeshangarg')}** requested {self.format_username('showell', 'https://github.com/showell')} for a review on [PR #1 This is just a test commit](https://github.com/eeshangarg/Scheduler/pull/1)."
...
""".strip()
    ...
    def test_team_edited_description(self) -> None:
        ...
        expected_message = f"""\
**{self.format_username("Hypro999")}** changed the team description to:
\n~~~ quote
...
~~~"""
    ...
    def test_discussion_msg(self) -> None:
        expected_message = f"{self.format_username('sbansal1999')} created [discussion #20](https://github.com/sbansal1999/testing-gh/discussions/20) in General:\n\n~~~ quote\n### Lets discuss\nSome random text about which no one cares.\r\n\n~~~"
        self.check_webhook("discussion", TOPIC_DISCUSSION, expected_message)

    def test_discussion_comment_msg(self) -> None:
        expected_message = f"{self.format_username('sbansal1999')} [commented](https://github.com/sbansal1999/testing-gh/discussions/20#discussioncomment-6332416) on [discussion #20](https://github.com/sbansal1999/testing-gh/discussions/20):\n\n~~~ quote\nsome random comment\n~~~"
    ...
    def test_discussion_comment_msg_with_custom_topic_in_url(self) -> None:
        self.url = self.build_webhook_url(topic="notifications")
        expected_topic_name = "notifications"
        expected_message = f"{self.format_username('sbansal1999')} [commented](https://github.com/sbansal1999/testing-gh/discussions/20#discussioncomment-6332416) on [discussion #20 Lets discuss](https://github.com/sbansal1999/testing-gh/discussions/20):\n\n~~~ quote\nsome random comment\n~~~"
    ...
    def test_discussion_comment_edited_msg(self) -> None:
        expected_message = f"{self.format_username('sbansal1999')} edited a [comment](https://github.com/sbansal1999/testing-gh/discussions/20#discussioncomment-6332416) on [discussion #20](https://github.com/sbansal1999/testing-gh/discussions/20):\n\n~~~ quote\nsome random comment edited\n~~~"
