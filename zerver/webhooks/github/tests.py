...
* Final edit to baz, I swear ([b954491](https://github.com/zbenjamin/zulip-test/commit/b95449196980507f08209bdfdc4f1d611689b7a8))"""
    ...
    def basic_test(self, fixture_name: Text, stream_name: Text, expected_subject: Text, expected_content: Text, send_stream: bool=False, branches: Optional[Text]=None) -> None:
