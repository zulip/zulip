...
class GithubWebhookTest(WebhookTestCase):
    ...
    def test_check_run(self) -> None:
        expected_topic = u"hello-world / check runs"
        expected_message = u"""
Check run [randscape](http://github.com/github/hello-world/runs/4) completed (success). ([d6fde92](http://github.com/github/hello-world/commit/d6fde92930d4715a2b49857d24b940956b26d2d3))
""".strip()
