...
class GitHubWebhookTest(WebhookTestCase):
    ...
    def test_pull_request_review_msg(self) -> None:
        expected_message = "baxterthehacker submitted [✅ approved PR review](https://github.com/baxterthehacker/public-repo/pull/1#pullrequestreview-2626884):\n\n~~~ quote\nLooks great!\n~~~"
    ...
    def test_pull_request_review_msg_with_custom_topic_in_url(self) -> None:
        self.url = self.build_webhook_url(topic="notifications")
        expected_topic_name = "notifications"
        expected_message = "baxterthehacker submitted [✅ approved PR review for #1 Update the README with new information](https://github.com/baxterthehacker/public-repo/pull/1#pullrequestreview-2626884):\n\n~~~ quote\nLooks great!\n~~~"
    ...
    def test_pull_request_review_msg_with_empty_body(self) -> None:
        ...
        expected_message = "kou submitted [commented PR review](https://github.com/groonga/groonga/pull/1581#pullrequestreview-1483047907)."
