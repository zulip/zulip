...
DISCUSSION_TEMPLATES = {
    ...
    "generic_action": "{sender} **{action}** [discussion #{discussion_number}{optional_title}]({url}).",
    "deleted": "{sender} **{action}** discussion #{discussion_number}{optional_title}.",
    "closed": "{sender} **{action}** [discussion #{discussion_number}{optional_title}]({url}) as **{closed_reason}**.",
    "locked": "{sender} **{action}** [discussion #{discussion_number}{optional_title}]({url}{optional_title}){locked_reason}.",
    "labeled": "{sender} added the **{label}** label to [discussion #{discussion_number}{optional_title}]({url}).",
    "unlabeled": "{sender} removed the **{label}** label from [discussion #{discussion_number}{optional_title}]({url}).",
    "category_changed": "{sender} changed the category of [discussion #{discussion_number}{optional_title}]({url}) from **{old_category}** to **{category}**.",
    "transferred": "{sender} {action} discussion #{discussion_number}{optional_title} from **{repository_name}** to **{new_repository_name}** as [discussion #{new_discussion_number}]({url}).",
    ...
    # TODO: Change the topic name too
    "edited_title": "{sender} edited the title of [discussion #{discussion_number}{optional_title}]({url}):\n\n~~~ quote\n### {title}\n~~~",
    "edited_body": "{sender} edited [discussion #{discussion_number}{optional_title}]({url}):\n\n~~~ quote\n{body}\n~~~",
}
...
class LazyContext(dict[str, str | int]):
    ...
    def __init__(self, payload: WildValue, include_title: bool) -> None:
        ...
        self.template_values: dict[str, Callable[[], str | int]] = {
            ...
            "optional_title": lambda: f' {self.template_values["title"]()}'
