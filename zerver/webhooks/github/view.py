...
class Helper:
    ...
    def resolve_display_name(self, all_users: list[dict], display_name: str) -> str:
...
def get_push_commits_body(helper: Helper) -> str:
    ...
    for commit in payload["commits"]:
        ...
        # is_unique_user=len(get_zulip_username)==1
...
def api_github_webhook(
    ...
    *,
    ...
    all_users_with_github_username = get_user_by_external_account(
        user_profile.realm, github_username, "github"
    )
    if (
