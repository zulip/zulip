...
def format_value(value: str | list[str] | dict[str, str]) -> str:
    ...
    # The remaining type of values we support other than strings,
    # and list is a dictionary.
...
def get_pretty_fields(pretty: str, values: list[str]) -> dict[str, str]:
    ...
    in the pretty data. Extract each key-value pair by locating the position
