...
from zerver.webhooks.bitbucket.view import BITBUCKET_REPO_UPDATED_CHANGED, BITBUCKET_TOPIC_TEMPLATE
...
def api_bitbucket3_webhook(
    ...
    *,
    ...
    if "eventKey" in payload:
        ...
        eventkey = get_event_header(request, "X-Event-Key", "BitBucket")
