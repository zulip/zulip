...
class PagerDutyHookTests(WebhookTestCase):
    V2_TOPIC = "Incident My new incident (#33)"

    def test_trigger_v2(self) -> None:
        expected_message = "Incident [My new incident (#33)](https://webdemo.pagerduty.com/incidents/PRORDTY) triggered by [Production XDB Cluster](https://webdemo.pagerduty.com/services/PN49J75) (assigned to [Laura Haley](https://webdemo.pagerduty.com/users/P553OPV))."
        self.check_webhook("trigger_v2", self.V2_TOPIC, expected_message)
    ...
    def test_trigger_without_assignee_v2(self) -> None:
        expected_message = "Incident [My new incident (#33)](https://webdemo.pagerduty.com/incidents/PRORDTY) triggered by [Production XDB Cluster](https://webdemo.pagerduty.com/services/PN49J75) (assigned to nobody)."
        self.check_webhook("trigger_without_assignee_v2", self.V2_TOPIC, expected_message)
    ...
    def test_resolved_v2(self) -> None:
        expected_message = "Incident [My new incident (#33)](https://webdemo.pagerduty.com/incidents/PRORDTY) resolved by [Laura Haley](https://webdemo.pagerduty.com/users/P553OPV)."
        self.check_webhook("resolve_v2", self.V2_TOPIC, expected_message)
    ...
    def test_acknowledge_v2(self) -> None:
        expected_message = "Incident [My new incident (#33)](https://webdemo.pagerduty.com/incidents/PRORDTY) acknowledged by [Laura Haley](https://webdemo.pagerduty.com/users/P553OPV)."
        self.check_webhook("acknowledge_v2", self.V2_TOPIC, expected_message)

    def test_incident_assigned_v2(self) -> None:
        expected_message = "Incident [My new incident (#33)](https://webdemo.pagerduty.com/incidents/PRORDTY) assigned to [Wiley Jacobson](https://webdemo.pagerduty.com/users/PFBSJ2Z)."
        self.check_webhook("assign_v2", self.V2_TOPIC, expected_message)
