...
[Go to alert rule](http://localhost:3000/)
...
[Go to alert rule](http://localhost:3000/d/GG2qhR3Wz/alerttest?fullscreen&edit&tab=alert&panelId=6&orgId=1)
""".strip()
    ...
    def test_no_message_alert(self) -> None:
        ...
        expected_message = """
[Go to alert rule](http://localhost:3000/d/GG2qhR3Wz/alerttest?fullscreen&edit&tab=alert&panelId=8&orgId=1)
