...
1. {!generate-webhook-url-basic.md!}
      ...
      also fill `YOUR_JIRA_EMAIL` and `JIRA_API_TOKEN` in inputs. For
      instructions on generating your `JIRA_API_TOKEN`, refer to this
      [Jira documentation][1]. Otherwise, it will appear as
      `[~accountid:MENTIONED_ACC_ID]` in Zulip.
