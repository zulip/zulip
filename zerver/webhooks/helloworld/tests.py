...
class HelloWorldHookTests(WebhookTestCase):
    ...
    def test_stream_error_pm_to_bot_owner(self) -> None:
        ...
        expected_message = "Your bot `webhook-bot@example.com` tried to send a message to channel #**nonexistent**, but that channel does not exist. Click [here](#channels/new) to create it."
        self.send_and_test_private_message(
            "goodbye",
            expected_message=expected_message,
            content_type="application/x-www-form-urlencoded",
