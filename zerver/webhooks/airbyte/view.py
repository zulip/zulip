...
* **Bytes:** {bytes_emitted_formatted} emitted, {bytes_committed_formatted} committed
...
def format_message_from_data(data: dict[str, str | int | bool]) -> str:
    content = AIRBYTE_MESSAGE_TEMPLATE.format(
        ...
        bytes_emitted_formatted=data["bytes_emitted_formatted"],
        bytes_committed_formatted=data["bytes_committed_formatted"],
    )
