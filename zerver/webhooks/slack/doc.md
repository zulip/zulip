...
1. Still in the **OAuth & Permissions** menu, scroll back up to the **OAuth
   Tokens** section, and click **Install to Workspace**. You'll now be sent
   through the Slack OAuth flow, approve the permission request.

1. You will immediately see the **Bot User OAuth Token**. Copy it and add it
