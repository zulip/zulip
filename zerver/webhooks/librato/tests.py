...
class LibratoHookTests(WebhookTestCase):
    ...
    def test_alert_message_with_default_topic(self) -> None:
        ...
        expected_message = "Alert [alert_name](https://metrics.librato.com/alerts#/6294535) has triggered! [Reaction steps](http://www.google.pl):\n * Metric `librato.cpu.percent.idle`, sum was below 44 by 300s, recorded at <time:2016-03-31 09:11:42 UTC>.\n * Metric `librato.swap.swap.cached`, average was absent  by 300s, recorded at <time:2016-03-31 09:11:42 UTC>.\n * Metric `librato.swap.swap.cached`, derivative was above 9 by 300s, recorded at <time:2016-03-31 09:11:42 UTC>."
        self.check_webhook(
            "alert",
            expected_topic_name,
            expected_message,
    ...
    def test_three_conditions_alert_message(self) -> None:
        expected_message = "Alert [alert_name](https://metrics.librato.com/alerts#/6294535) has triggered! [Reaction steps](http://www.use.water.pl):\n * Metric `collectd.interface.eth0.if_octets.tx`, absolute_value was above 4 by 300s, recorded at <time:2016-04-11 20:40:14 UTC>.\n * Metric `collectd.load.load.longterm`, max was above 99, recorded at <time:2016-04-11 20:40:14 UTC>.\n * Metric `librato.swap.swap.cached`, average was absent  by 60s, recorded at <time:2016-04-11 20:40:14 UTC>."
    ...
    def test_alert_clear(self) -> None:
        ...
        expected_message = "Alert [alert_name](https://metrics.librato.com/alerts#/6309313) has cleared at <time:2016-04-12 13:11:44 UTC>!"
        self.check_webhook(
            "alert_cleared",
            expected_topic_name,
            expected_message,
