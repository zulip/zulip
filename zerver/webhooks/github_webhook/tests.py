...
class GithubWebhookTest(WebhookTestCase):
    ...
    EXPECTED_SUBJECT_REPO_EVENTS = "public-repo"
    EXPECTED_SUBJECT_ISSUE_EVENTS = "public-repo / Issue #2 Spelling error in the README file"
    EXPECTED_SUBJECT_PR_EVENTS = "public-repo / PR #1 Update the README with new information"
    EXPECTED_SUBJECT_DEPLOYMENT_EVENTS = "public-repo / Deployment on production"
    EXPECTED_SUBJECT_ORGANIZATION_EVENTS = "baxterandthehackers organization"
    EXPECTED_SUBJECT_BRANCH_EVENTS = "public-repo / changes"
    EXPECTED_SUBJECT_WIKI_EVENTS = "public-repo / Wiki Pages"
    ...
    def test_push_delete_branch(self) -> None:
        ...
        self.send_and_test_stream_message('push_delete_branch', "public-repo / feature",
                                          expected_message, HTTP_X_GITHUB_EVENT='push')
    ...
    def test_push_local_branch_without_commits(self) -> None:
        ...
        self.send_and_test_stream_message('push_local_branch_without_commits', "public-repo / feature",
                                          expected_message, HTTP_X_GITHUB_EVENT='push')
    ...
    def test_membership_msg(self) -> None:
        expected_message = "baxterthehacker added [kdaigle](https://github.com/kdaigle) to Contractors team"
    ...
    def test_pull_request_opened_msg(self) -> None:
        expected_message = "baxterthehacker opened [PR](https://github.com/baxterthehacker/public-repo/pull/1)\nfrom `changes` to `master`\n\n~~~ quote\nThis is a pretty simple change that we need to pull into master.\n~~~"
    ...
    def test_pull_request_synchronized_msg(self) -> None:
        expected_message = "baxterthehacker updated [PR](https://github.com/baxterthehacker/public-repo/pull/1)\nfrom `changes` to `master`"
    ...
    def test_pull_request_closed_msg(self) -> None:
        expected_message = "baxterthehacker closed without merge [PR](https://github.com/baxterthehacker/public-repo/pull/1)"
    ...
    def test_pull_request_merged_msg(self) -> None:
        expected_message = "baxterthehacker merged [PR](https://github.com/baxterthehacker/public-repo/pull/1)"
    ...
    def test_release_msg(self) -> None:
        expected_message = "baxterthehacker published [the release](https://github.com/baxterthehacker/public-repo/releases/tag/0.0.1)"
    ...
    def test_page_build_msg(self) -> None:
        expected_message = "Github Pages build, trigerred by baxterthehacker, is built"
    ...
    def test_pull_request_edited_msg(self) -> None:
        expected_message = "baxterthehacker edited [PR](https://github.com/baxterthehacker/public-repo/pull/1)\nfrom `changes` to `master`"
    ...
    def test_pull_request_assigned_msg(self) -> None:
        expected_message = "baxterthehacker assigned [PR](https://github.com/baxterthehacker/public-repo/pull/1) to baxterthehacker"
    ...
    def test_pull_request_unassigned_msg(self) -> None:
        expected_message = "eeshangarg unassigned [PR](https://github.com/zulip-test-org/helloworld/pull/1)"
