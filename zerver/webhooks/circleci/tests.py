...
class CircleCiHookTests(WebhookTestCase):
    ...
    def test_circleci_build_in_success_status(self) -> None:
        expected_subject = "RepoName"
        expected_message = "[Build](https://circleci.com/gh/username/project/build_number) triggered by username on master branch succeeded."
    ...
    def test_circleci_build_in_failed_status(self) -> None:
        expected_subject = "RepoName"
        expected_message = "[Build](https://circleci.com/gh/username/project/build_number) triggered by username on master branch failed."
    ...
    def test_circleci_build_in_failed_status_when_previous_build_failed_too(self) -> None:
        expected_subject = "RepoName"
        expected_message = "[Build](https://circleci.com/gh/username/project/build_number) triggered by username on master branch is still failing."
    ...
    def test_circleci_build_in_success_status_when_previous_build_failed_too(self) -> None:
        expected_subject = "RepoName"
        expected_message = "[Build](https://circleci.com/gh/username/project/build_number) triggered by username on master branch fixed."
