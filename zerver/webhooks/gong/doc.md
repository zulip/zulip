...
1. From your Gong dashboard, navigate to **Admin center > Settings >
   Ecosystem > Automation rules**. Then, click **+ Add rule** to create a
...
1. Test the automation by clicking **Test now** with the preselected call
   data. Alternatively, you can choose to **Select a different call** for
   the test message.
