...
1. A call matching the rule filters is preselected for the test. To use
   a different one, click **Select a different call**.

1. Test the rule by clicking **Test now**. You'll see a success message
