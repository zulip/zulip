...
class AppOpticsHookTests(WebhookTestCase):
    CHANNEL_NAME = "appoptics"
    URL_TEMPLATE = "/api/v1/external/appoptics?api_key={api_key}&stream={stream}"
    LEGACY_URL_TEMPLATES = ["/api/v1/external/librato?stream={stream}&api_key={api_key}"]
    ...
    def test_alert_clear(self) -> None:
        ...
        expected_message = "Alert [alert_name](https://my.appoptics.com/alerts#/6309313) has cleared at 2016-04-12 13:11:44 UTC!"
        self.check_webhook(
            "alert_cleared",
            expected_topic_name,
            expected_message,
