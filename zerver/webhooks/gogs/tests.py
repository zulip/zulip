...
class GogsHookTests(WebhookTestCase):
    ...
    def test_push(self) -> None:
        expected_subject = "try-git / master"
...
* Webhook Test ([d8fce16](http://localhost:3000/john/try-git/commit/d8fce16c72a2ff56a5afc8a08645a6ce45491794))"""
    ...
    def test_new_branch(self) -> None:
        expected_subject = "try-git / my_feature"
    ...
    def test_pull_request_opened(self) -> None:
        expected_subject = "try-git / PR #1 Title Text for Pull Request"
        expected_message = """john opened [PR #1](http://localhost:3000/john/try-git/pulls/1)
from `feature` to `master`"""
    ...
    def test_pull_request_closed(self) -> None:
        expected_subject = "try-git / PR #1 Title Text for Pull Request"
        expected_message = """john closed [PR #1](http://localhost:3000/john/try-git/pulls/1)
from `feature` to `master`"""
    ...
    def test_pull_request_merged(self) -> None:
        expected_subject = "try-git / PR #2 Title Text for Pull Request"
        expected_message = """john merged [PR #2](http://localhost:3000/john/try-git/pulls/2)
from `feature` to `master`"""
