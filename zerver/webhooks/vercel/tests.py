...
class VercelHookTests(WebhookTestCase):
    def test_deployment_created(self) -> None:
        ...
        expected_message = (
            "Deployment of [my-app]"
            "(https://vercel.com/acme/my-app/dpl_00000000000000000000000001) to **preview** has started."
        )
    ...
    def test_deployment_succeeded(self) -> None:
        ...
        expected_message = (
            "Deployment of [my-app]"
            "(https://vercel.com/acme/my-app/dpl_00000000000000000000000002) to **production** is ready :check:."
        )
    ...
    def test_deployment_error(self) -> None:
        ...
        expected_message = (
            "Deployment of [my-app]"
            "(https://vercel.com/acme/my-app/dpl_00000000000000000000000003) to **production** failed :cross_mark:."
        )
    ...
    def test_deployment_canceled(self) -> None:
        ...
        expected_message = (
            "Deployment of [my-app]"
            "(https://vercel.com/acme/my-app/dpl_00000000000000000000000004) to **production** was canceled."
        )
    ...
    def test_deployment_promoted(self) -> None:
        ...
        expected_message = (
            "Deployment of [my-app]"
            "(https://vercel.com/acme/my-app/dpl_00000000000000000000000005) to **production** was promoted."
        )
