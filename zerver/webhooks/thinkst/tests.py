...
class ThinkstHookTests(WebhookTestCase):
    ...
    def test_canary_dummy(self) -> None:
        expected_message = (
            ...
            "**Kind:** Dummy Incident\n"
            "**Timestamp:** <time:2020-06-09 13:59:38Z>\n"
            "**Canary IP:** `1.1.1.1`\n"
            "**Source IP:** `2.2.2.2`\n"
    ...
    def test_canary_consolidated_port_scan(self) -> None:
        expected_message = (
            ...
            "**Timestamp:** <time:2020-07-20 16:18:40Z>\n"
            "**Canary IP:** `1.1.1.1`\n"
    ...
    def test_canary_file_access(self) -> None:
        expected_message = (
            ...
            "**Timestamp:** <time:2020-07-20 16:27:20Z>\n"
            "**Canary IP:** `1.1.1.1`\n"
            "**Canary location:** dining room\n"
            "**Source IP:** `1.1.1.1`\n"
            "**User:** guest\n"
    ...
    def test_canary_host_port_scan(self) -> None:
        expected_message = (
            ...
            "**Kind:** Host Port Scan\n"
            "**Timestamp:** <time:2020-07-20 16:26:30Z>\n"
            "**Canary IP:** `1.1.1.1`\n"
            "**Canary location:** dining room\n"
            "**Source IP:** `1.1.1.1`\n"
            "**Reverse DNS:** `attacker.local`\n"
    ...
    def test_canary_http_login(self) -> None:
        expected_message = (
            ...
            "**Timestamp:** <time:2020-07-20 14:55:45Z>\n"
            "**Canary IP:** `1.1.1.1`\n"
            "**Canary location:** dining room\n"
            "**Source IP:** `1.1.1.1`\n"
            "**Username:** regular\n"
    ...
    def test_canary_ssh_login(self) -> None:
        expected_message = (
            ...
            "**Timestamp:** <time:2020-07-20 16:26:22Z>\n"
            "**Canary IP:** `1.1.1.1`\n"
            "**Canary location:** dining room\n"
            "**Source IP:** `1.1.1.1`\n"
            "**Reverse DNS:** `attacker.local`\n"
    ...
    def test_canarytoken_msword(self) -> None:
        expected_message = (
            ...
            "**Timestamp:** <time:2020-07-20 14:40:15Z>\n"
            "**Triggered:** 5 times\n"
            "**Accept:** `*/*`\n"
    ...
    def test_canarytoken_remote_image(self) -> None:
        expected_message = (
            ...
            "**Timestamp:** <time:2020-07-20 16:33:12Z>\n"
            "**Triggered:** 37 times\n"
            "**Accept:** `image/webp,*/*`\n"
            "**Accept-Encoding:** gzip, deflate\n"
