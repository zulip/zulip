...
class DBTHookWithAccessUrlTests(WebhookTestCase):
    CHANNEL_NAME = "DBT"
    URL_TEMPLATE = "/api/v1/external/dbt?&api_key={api_key}&stream={stream}&access_url=https://example.us1.dbt.com"
    WEBHOOK_DIR_NAME = "dbt"
...
[Job #123](https://example.us1.dbt.com/deploy/1/projects/167194/jobs/123) was kicked off from the ui by test@test.com at <time:2023-01-31T19:28:07Z>."""
        self.check_webhook("job_run_started", "Example Project", expected_message)
