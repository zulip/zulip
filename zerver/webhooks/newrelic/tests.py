...
class NewRelicHookTests(WebhookTestCase):
    ...
    def test_incident_activated_new_default_payload(self) -> None:
        expected_topic_name = "Activated Critical Priority"
        expected_message = """
...
```
    ...
    def test_incident_activated_new_provided_base_payload(self) -> None:
        expected_topic_name = "Activated High Priority"
        expected_message = """
...
```
    ...
    def test_incident_closed_default_payload(self) -> None:
        expected_topic_name = "Closed Critical Priority"
        expected_message = """
...
```
    ...
    def test_incident_closed_provided_base_payload(self) -> None:
        expected_topic_name = "Closed High Priority"
        expected_message = """
...
```
    ...
    def test_incident_created_default_payload(self) -> None:
        expected_topic_name = "Created Critical Priority"
        expected_message = """
...
|:clock: Incident created at: <time: 2024-04-22 07:12:29.493000+00:00 > |
|:silhouette:  Acknowledged by **N/A**|
|*The **Invalid fields 1** contains [unsupported field](/integrations/doc/newrelic#displaying-custom-fields) format.* |
|*The **Invalid field 2** contains [unsupported field](/integrations/doc/newrelic#displaying-custom-fields) format.* |
|Is valid: **True**|
...
> *Integration last updated: **June 2024***
```
        """.strip()
