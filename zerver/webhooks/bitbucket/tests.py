...
class BitbucketHookTests(WebhookTestCase):
    ...
    def test_push_commits_multiple_committers(self) -> None:
        commit_info = "* first commit ([84b96adc644](https://bitbucket.org/kolaszek/repository-name/commits/84b96adc644a30fd6465b3d196369d880762afed))\n"
    ...
    def test_push_commits_multiple_committers_with_others(self) -> None:
        commit_info = "* first commit ([84b96adc644](https://bitbucket.org/kolaszek/repository-name/commits/84b96adc644a30fd6465b3d196369d880762afed))\n"
    ...
    def test_push_commits_multiple_committers_filtered_by_branches(self) -> None:
        self.url = self.build_webhook_url(branches="master,development")
        commit_info = "* first commit ([84b96adc644](https://bitbucket.org/kolaszek/repository-name/commits/84b96adc644a30fd6465b3d196369d880762afed))\n"
        expected_message = f"""Tomasz [pushed](https://bitbucket.org/kolaszek/repository-name/branch/master) 3 commits to branch master. Commits by Ben (2) and Tomasz (1).\n\n{commit_info * 2}* first commit ([84b96adc644](https://bitbucket.org/kolaszek/repository-name/commits/84b96adc644a30fd6465b3d196369d880762afed))"""
        self.check_webhook("push_multiple_committers", TOPIC_BRANCH_EVENTS, expected_message)

    def test_push_commits_multiple_committers_with_others_filtered_by_branches(
        self,
    ) -> None:
        self.url = self.build_webhook_url(branches="master,development")
        commit_info = "* first commit ([84b96adc644](https://bitbucket.org/kolaszek/repository-name/commits/84b96adc644a30fd6465b3d196369d880762afed))\n"
    ...
    def test_push_event_filtered_by_branches(self) -> None:
        self.url = self.build_webhook_url(branches="master,development")
        commit_info = "* first commit ([84b96adc644](https://bitbucket.org/kolaszek/repository-name/commits/84b96adc644a30fd6465b3d196369d880762afed))"
        expected_message = f"Tomasz [pushed](https://bitbucket.org/kolaszek/repository-name/branch/master) 1 commit to branch master.\n\n{commit_info}"
        self.check_webhook("push", TOPIC_BRANCH_EVENTS, expected_message)

    def test_push_commits_above_limit_event(self) -> None:
    ...
    def test_push_commits_above_limit_filtered_by_branches(self) -> None:
        self.url = self.build_webhook_url(branches="master,development")
        commit_info = "* a ([6f161a7bced](https://bitbucket.org/kolaszek/repository-name/commits/6f161a7bced94430ac8947d87dbf45c6deee3fb0))\n"
        expected_message = f"Tomasz [pushed](https://bitbucket.org/kolaszek/repository-name/branches/compare/6f161a7bced94430ac8947d87dbf45c6deee3fb0..1221f2fda6f1e3654b09f1f3a08390e4cb25bb48) 5 commits to branch master.\n\n{(commit_info * 5)}[and more commit(s)]"
    ...
    def test_force_push_event(self) -> None:
    ...
    def test_force_push_event_filtered_by_branches(self) -> None:
        self.url = self.build_webhook_url(branches="master,development")
        expected_message = "Tomasz [force pushed](https://bitbucket.org/kolaszek/repository-name/branch/master) to branch master. Head is now 25f93d22b719e2d678a7ad5ee0ef0d1fcdf39c12."
        self.check_webhook("force_push", TOPIC_BRANCH_EVENTS, expected_message)

    def test_remove_branch_event(self) -> None:
    ...
    def test_issue_commented_event(self) -> None:
    ...
    def test_issue_commented_with_custom_topic_in_url(self) -> None:
        self.url = self.build_webhook_url(topic="notifications")
        expected_topic_name = "notifications"
    ...
    def test_pull_request_approved_event(self) -> None:
    ...
    def test_pull_request_approved_with_custom_topic_in_url(self) -> None:
        self.url = self.build_webhook_url(topic="notifications")
        expected_topic_name = "notifications"
    ...
    def test_pull_request_unapproved_event(self) -> None:
    ...
    def test_pull_request_declined_event(self) -> None:
    ...
    def test_pull_request_fulfilled_event(self) -> None:
    ...
    def test_repo_updated_event(self) -> None:
    ...
    def test_push_one_tag_event(self) -> None:
        expected_message = (
    ...
    def test_push_remove_tag_event(self) -> None:
        expected_message = (
    ...
    def test_push_more_than_one_tag_event(self) -> None:
    ...
    def test_more_than_one_push_event(self) -> None:
        self.subscribe(self.test_user, self.channel_name)
    ...
    def test_more_than_one_push_event_filtered_by_branches(self) -> None:
        self.url = self.build_webhook_url(branches="master,development")
    ...
    def test_more_than_one_push_event_filtered_by_branches_ignore(self) -> None:
    ...
    def test_push_event_filtered_by_branches_ignore(
    ...
    @patch("zerver.webhooks.bitbucket.view.check_send_webhook_message")
    def test_push_commits_above_limit_filtered_by_branches_ignore(
        self, check_send_webhook_message_mock: MagicMock
    ) -> None:
        self.url = self.build_webhook_url(branches="changes,development")
    ...
    @patch("zerver.webhooks.bitbucket.view.check_send_webhook_message")
    def test_force_push_event_filtered_by_branches_ignore(
        self, check_send_webhook_message_mock: MagicMock
    ) -> None:
        self.url = self.build_webhook_url(branches="changes,development")
    ...
    @patch("zerver.webhooks.bitbucket.view.check_send_webhook_message")
    def test_push_multiple_committers_with_others_filtered_by_branches_ignore(
        self, check_send_webhook_message_mock: MagicMock
    ) -> None:
        self.url = self.build_webhook_url(branches="changes,development")
    ...
    @patch("zerver.webhooks.bitbucket.view.check_send_webhook_message")
    def test_push_without_changes_ignore(self, check_send_webhook_message_mock: MagicMock) -> None:
