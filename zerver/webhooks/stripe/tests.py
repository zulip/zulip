...
class StripeHookTests(WebhookTestCase):
    ...
    def test_charge_dispute_closed(self) -> None:
        expected_subject = "Charge ch_00000000000000"
        expected_message = "A charge dispute for **10.01aud** has been closed as **won**.\nThe charge in dispute was **[ch_00000000000000](https://dashboard.stripe.com/payments/ch_00000000000000)**."
    ...
    def test_charge_failed(self) -> None:
        expected_subject = "Charge ch_00000000000000"
        expected_message = "A charge with id **[ch_00000000000000](https://dashboard.stripe.com/payments/ch_00000000000000)** for **1.00aud** has failed."
    ...
    def test_charge_succeeded(self) -> None:
        expected_subject = "Charge ch_00000000000000"
        expected_message = "A charge with id **[ch_00000000000000](https://dashboard.stripe.com/payments/ch_00000000000000)** for **1.00aud** has succeeded."
    ...
    def test_customer_created_email(self) -> None:
        expected_subject = "Customer cus_00000000000000"
        expected_message = "A new customer with id **[cus_00000000000000](https://dashboard.stripe.com/customers/cus_00000000000000)** and email **example@abc.com** has been created."
    ...
    def test_customer_created(self) -> None:
        expected_subject = "Customer cus_00000000000000"
        expected_message = "A new customer with id **[cus_00000000000000](https://dashboard.stripe.com/customers/cus_00000000000000)** has been created."
    ...
    def test_customer_deleted(self) -> None:
        expected_subject = "Customer cus_00000000000000"
        expected_message = "A customer with id **[cus_00000000000000](https://dashboard.stripe.com/customers/cus_00000000000000)** has been deleted."
    ...
    def test_customer_subscription_created(self) -> None:
        expected_subject = "Customer sub_00000000000000"
        expected_message = "A new customer subscription for **20.00aud** every **month** has been created.\nThe subscription has id **[sub_00000000000000](https://dashboard.stripe.com/subscriptions/sub_00000000000000)**."
    ...
    def test_customer_subscription_deleted(self) -> None:
        expected_subject = "Customer sub_00000000000000"
        expected_message = "The customer subscription with id **[sub_00000000000000](https://dashboard.stripe.com/subscriptions/sub_00000000000000)** was deleted."
    ...
    def test_customer_subscription_trial_will_end(self) -> None:
        expected_subject = "Customer sub_00000000000000"
        expected_message = "The customer subscription trial with id **[sub_00000000000000](https://dashboard.stripe.com/subscriptions/sub_00000000000000)** will end in 3 days."
    ...
    def test_invoice_payment_failed(self) -> None:
        expected_subject = "Invoice in_00000000000000"
        expected_message = "An invoice payment on invoice with id **[in_00000000000000](https://dashboard.stripe.com/invoices/in_00000000000000)** and with **0.00aud** due has failed."
    ...
    def test_order_payment_failed(self) -> None:
        expected_subject = "Order or_00000000000000"
        expected_message = "An order payment on order with id **[or_00000000000000](https://dashboard.stripe.com/orders/or_00000000000000)** for **15.00aud** has failed."
    ...
    def test_order_payment_succeeded(self) -> None:
        expected_subject = "Order or_00000000000000"
        expected_message = "An order payment on order with id **[or_00000000000000](https://dashboard.stripe.com/orders/or_00000000000000)** for **15.00aud** has succeeded."
    ...
    def test_order_updated(self) -> None:
        expected_subject = "Order or_00000000000000"
        expected_message = "The order with id **[or_00000000000000](https://dashboard.stripe.com/orders/or_00000000000000)** for **15.00aud** has been updated."
    ...
    def test_transfer_failed(self) -> None:
        expected_subject = "Transfer tr_00000000000000"
        expected_message = "The transfer with description **Transfer to test@example.com** and id **[tr_00000000000000](https://dashboard.stripe.com/transfers/tr_00000000000000)** for amount **11.00aud** has failed."
    ...
    def test_transfer_paid(self) -> None:
        expected_subject = "Transfer tr_00000000000000"
        expected_message = "The transfer with description **Transfer to test@example.com** and id **[tr_00000000000000](https://dashboard.stripe.com/transfers/tr_00000000000000)** for amount **11.00aud** has been paid."
