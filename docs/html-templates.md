...
There are a few possible locations for the context:
...
sometimes work directly from JavaScript code.
...
`invite_subscription.handlebars` is rendered, you should run:

```
$ git grep "render('invite_subscription" 'js/*.js'
