...
"Message" can be literally translated as "消息" and "信息", either is acceptable. Here "消息" is chosen for translation. For example, "Stream
Message" is translated as "频道消息", and "Direct Message" (abbreviated as "DM") is
