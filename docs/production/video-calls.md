...
- [Integrated Zulip calling (LiveKit)](#integrated-zulip-calling-livekit),
  powered by the open-source [LiveKit](https://livekit.io/) WebRTC SFU.
...
## Integrated Zulip calling (LiveKit)

To use integrated Zulip calling on a self-hosted Zulip installation, you'll
need a [LiveKit](https://livekit.io/) server instance, an open-source
WebRTC SFU (Selective Forwarding Unit) that provides scalable, low-latency
video and voice calls.

### Prerequisites

- A LiveKit server. You can [self-host
...
This enables integrated Zulip calling on your Zulip server. Finally,
[configure Integrated Zulip calling (LiveKit) as the video call
provider](https://zulip.com/help/configure-call-provider)
in the Zulip organizations where you want to use it.
