...
OAuth 2.0 app with access to the [Google Meet REST API][google-meet-api].
...
This enables Google Meet support in your Zulip server. Finally, [configure
Google Meet as the video call provider](https://zulip.com/help/configure-call-provider)
in the Zulip organization where you want to use it.
