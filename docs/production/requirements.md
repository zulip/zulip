...
Ubuntu 24.04, Ubuntu 26.04, and Debian 13 are supported for running
Zulip in production. You can also run Zulip on other platforms that
support Docker using [our Docker image](docker.md).
