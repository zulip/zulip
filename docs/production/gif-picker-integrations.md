...
a production API key from KLIPY.
...
1. In your API key entry, click on the **three-dot button** on the right and select **Request Production**.

1. Enter the necessary details and select **Apply**.
