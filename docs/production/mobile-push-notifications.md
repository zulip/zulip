...
* A key APNS_TOPIC is provided in `settings.py` where you can put your bundle identifier and use that key                       in `push_notifications.py` to start sending push notifications directly from your server.
