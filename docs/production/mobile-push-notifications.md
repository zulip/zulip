...
* A key APNS_TOPIC is provided in `settings.py` which is used in `push_notifications.py` while passing the topic. This key,  anyone can override in /etc/zulip/settings.py
