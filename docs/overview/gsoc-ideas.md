...
[What makes a great Zulip contributor](../overview/contributing.md#what-makes-a-great-zulip-contributor)
...
- Fill in the gaps in Zulip's
  ...
  [nice framework](../tutorials/documenting-api-endpoints.md) for
...
- Make Zulip integrations easier for nontechnical users to setup.
  ...
  [Zulip integration writing guide](../subsystems/integration-docs.md)
  and
