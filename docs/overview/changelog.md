...
- New [web-public streams](https://zulip.com/help/web-public-streams)
  allows Zulip organizations to enable visitors to browse certain
  streams without creating an account.
...
- Migrated most permissions settings that only supported
  administrators or normal users to support choosing which roles have
  permission.
...
- Added support for emoji in user statuses, displayed alongside user
  names in the sidebars and message feed. Animated status emoji will
...
9d291c9d3fb29479bf0adbb6162d37b9d17f3ae6
...
- User groups mentions now correctly function as silent mentions when
  inside block quotes.
- Added new "Scroll to bottom" component for the message feed.
...
- Fixed several server bugs involving rare raceconditions.
