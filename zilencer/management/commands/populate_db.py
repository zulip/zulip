    ...
    def handle(self, *args: Any, **options: Any) -> None:
        ...
        if options["delete"]:
            ...
            birthday = try_add_realm_custom_profile_field(
                zulip_realm, "Birthday", CustomProfileField.DATE, acting_user=iago
            )
            ...
            mentor = try_add_realm_custom_profile_field(
                zulip_realm, "Mentor", CustomProfileField.USER, acting_user=iago
            )
            github_profile = try_add_realm_default_custom_profile_field(
                zulip_realm, "github", acting_user=iago
            )
