...
1. Click the **pencil** (<i class="zulip-icon zulip-icon-pencil"></i>) icon in
   the message recipient bar. If you do not see the
   **pencil** (<i class="zulip-icon zulip-icon-pencil"></i>) icon, you do not
   have permission to rename this topic.

1. Edit the topic name.

1. Click the **checkmark** (<i class="zulip-icon zulip-icon-check"></i>) icon
