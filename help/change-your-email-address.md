...
1. Under **Account**, click on the
   **pencil** (<i class="zulip-icon zulip-icon-edit"></i>) icon to the
   right of your current email. If you do not see the
   **pencil** (<i class="zulip-icon zulip-icon-edit"></i>) icon, you do
   not have permission to change your email address.
