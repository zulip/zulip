...
* **Announce new stream in #<stream configured by your organization\>**: Posts an automated notice that the stream was created in the [new stream announcements stream](/#organization/organization-settings).
