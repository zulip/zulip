...
1. Tap to select one of the most common statuses, *or* choose any emoji and/or write a short message.
...
You can remove a status emoji, status message, or both.
...
1. Click the <kbd>X</kbd> beside the status
