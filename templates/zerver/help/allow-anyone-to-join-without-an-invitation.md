...
* [Restrict sign-ups to a fixed list of allowed
  domains](/help/allow-anyone-to-join-without-an-invitation#restrict-sign-ups-to-a-list-of-domains)
...
* Disallow signups with known [disposable email
  address](https://en.wikipedia.org/wiki/Disposable_email_address) . This is
  recommended for open organizations to help protect against
  abuse
