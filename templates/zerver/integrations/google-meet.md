...
1. If you're using a new Google Cloud project, configure the **OAuth consent
   screen** under **APIs & Services > OAuth consent screen**:
    ...
    - Fill in the **App name**, **User support email**, and **Developer contact
      information**.
    - If creating an app for use outside of your Google Workspace organization,
