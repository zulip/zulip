...
!!! warn ""
    ...
    **Note:** There are two Audience types for Google Cloud OAuth 2.0 apps:

    - **Internal**: Zulip users must have an account in the Google
      Workspace organization associated with your Google Cloud OAuth app
      in order to create calls.
    - **External**: Zulip users just need a regular Google account to
      create calls, but your Google Cloud OAuth app must go through
      [Google's OAuth verification](https://support.google.com/cloud/answer/13463073?hl=en&ref_topic=13460882&sjid=6878633552635075588-EU)
      process.
