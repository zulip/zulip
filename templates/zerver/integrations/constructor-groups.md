...
## Room naming and conflicts

Constructor Groups video call rooms are created with names based on the user's full name. If multiple users in your organization have the same full name, room name conflicts may occur. When a conflict occurs, the room name will include the user ID to ensure uniqueness (e.g., **John-123's Zulip Videoconferencing Room**).
