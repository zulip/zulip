...
organization. Users will be able to start a Galène call and invite others using the
...
1. [Install Galène][galene-install].
...
## Moderator permissions in Galène calls

Galène's [operator][galene-moderation] role is assigned per joining
user, based on their Zulip role and not based on who created the call.

- Zulip organization owners, administrators, and moderators become
  Galène operators when they join a call.
- Members and guests can present video and audio and use the chat,
  but cannot moderate.
- In direct message calls, everyone who joins becomes an operator,
  regardless of their Zulip role.
...
[galene-moderation]: https://github.com/jech/galene/blob/master/galene.md#group-moderation
