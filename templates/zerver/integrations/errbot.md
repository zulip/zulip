...
1. Edit your ErrBot's `config.py`. Use the following template for a minimal
   configuration:
        ...
        CHATROOM_PRESENCE = ()
        BOT_PREFIX = '<@**err-bot**>'  # Providing your errbot's full name in Zulip lets it respond to @-mentions.
