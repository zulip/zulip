...
# Set MAX_FILE_UPLOAD_SIZE to 0 to disable file uploads.
# All upload UI will be hidden, and an appropriate error message will be
# displayed if a user tries to upload files.
