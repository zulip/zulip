...
# Update default_template_engine_settings with the path to
# static/generated/bots/ so that the static files generated by
# tools/setup/generate_zulip_bots_static_files.py can be rendered.
bots_generated_search_path = os.path.join(STATIC_ROOT, 'generated', 'bots')
default_template_engine_settings['DIRS'].append(bots_generated_search_path)
