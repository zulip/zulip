...
#
# These endpoints must also exist in zproject/urls.py, because the
# test suite uses Django's URL resolver (via client_post_request /
# resolve()) with the default ROOT_URLCONF.
