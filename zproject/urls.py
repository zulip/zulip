...
from zerver.views.video_calls import (
    ...
    make_google_meet_video_call,
    make_webex_video_call,
    make_zoom_video_call,
    register_google_meet_user,
    register_webex_user,
    register_zoom_user,
)
...
v1_api_and_json_patterns = [
    ...
    rest_path("calls/google_meet/create", POST=make_google_meet_video_call),
...
i18n_urls = [
    ...
    # Used to complete Google Meet OAuth flow to get user's access token.
    path("calls/google_meet/register", register_google_meet_user),
    path("calls/google_meet/complete", complete_google_meet_user),
