...
v1_api_and_json_patterns = [
    ...
    rest_path("tasks/<int:task_id>/time/start", POST=start_time_tracking),
    rest_path("tasks/<int:task_id>/time/stop", POST=stop_time_tracking),
    rest_path("tasks/<int:task_id>/time/logs", GET=get_task_time_logs),
    rest_path("users/me/time/stats", GET=get_my_time_stats),
