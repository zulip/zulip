...
help_documentation = MarkdownDirectoryView.as_view(
    template_name='zerver/documentation_main.html', path_template='/zerver/help/%s.md'
)
api_documentation = MarkdownDirectoryView.as_view(
    template_name='zerver/documentation_main.html', path_template='/zerver/api/%s.md'
)
urls += [
    path('help/', help_documentation),
    path('help/<path:article>', help_documentation),
    path('api/', api_documentation),
    path('api/<slug:article>', api_documentation),
]
