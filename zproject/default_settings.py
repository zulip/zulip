...
# Allow setting Galène settings in zulip-secrets.conf in
# development; this is useful since there are no public Galène servers.
GALENE_URL = get_secret("galene_url", development_only=True)
