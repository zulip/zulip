...
IGNORED_PHRASES = [
    ...
    r"exclude",
    r"exclude group private messages including",
    r"exclude message ID",
    r"exclude messages around",
    r"exclude messages in",
    r"exclude messages that are",
    r"exclude messages with one or more",
    r"exclude private messages with",
    r"exclude sent by",
    r"exclude sent by me",
    r"exclude stream",
    r"exclude streams",
    r"exclude topic",
    r"group private messages including",
    r"message ID",
    r"messages around",
    r"messages in",
    r"messages that are",
    r"messages with one or more",
    r"messages with one or more attachment",
    r"messages with one or more image",
    r"messages with one or more link",
    r"private messages",
    r"private messages with",
    r"search for",
    r"sent by",
    r"sent by me",
    r"starred messages",
