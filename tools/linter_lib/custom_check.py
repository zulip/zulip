    ...
    rules=[
        {
            ...
            "exclude_pattern": "Rocket.Chat|org.zulip.Zulip|Directory.Read.All|RoleManagement.Read.Directory|User.Read.All|ChannelMessage.Read.All|ChatMember.Read.All|Chat.Read.All",
        },
        {
