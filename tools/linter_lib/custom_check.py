...
def build_custom_checkers(by_lang):
    ...
    '''},
        ...
        {'pattern': '(logging|logger)\.warn\W',
         ...
         'good_lines': ["logging.warning('I am a warning.')", "mock_logger.warning.assert_not_called()"],
         'bad_lines': ["logging.warn('I am a warning.')", "mock_logger.warn.assert_not_called()"]},
    ]) + whitespace_rules
    bash_rules = [
        {'pattern': '#!.*sh [-xe]',
