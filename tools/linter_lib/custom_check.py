...
def build_custom_checkers(by_lang):
    ...
    css_rules = cast(RuleList, [
        ...
        {'pattern': 'https://',
         ...
         'good_lines': ["background: url(\"background.jpg\")"],
         'bad_lines': ["background: url(\"https://example.com/background.jpg\")"]},
        {'pattern': '^[ ][ ][a-zA-Z0-9]',
         'description': "Incorrect 2-space indentation in CSS",
         'exclude': set(['static/third/thirdparty-fonts.css']),
         'strip': '\n',
         'good_lines': [" color: white;"],
    ...
    html_rules = whitespace_rules + prose_style_rules + [
        ...
        {'pattern': '\Walt=["\'][^{"\']',
         ...
         'exclude': set(['static/templates/settings/display-settings.handlebars',
                         ...
                         'templates/zerver/markdown_help.html']),
         'good_lines': ['<img alt=("Foo Image")></img>', '<img alg=""></img>'],
         'bad_lines': ['<img alt="Foo Image"></img>']},
        {'pattern': '\Walt=["\']{{ ?["\']',
         'description': "alt argument should be enclosed by _().",
         'good_lines': ['<img alt=("Foo Image")></img>'],
         'bad_lines': ['<img alt="{{"></img>']}, 
        {'pattern': r'\bon\w+ ?=',
