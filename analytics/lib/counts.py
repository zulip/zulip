...
def process_count_stat(stat: CountStat, fill_to_time: datetime, realm: Optional[Realm]=None) -> None:
    ...
    while currently_filled <= fill_to_time:
        ...
        # Realm argument is here just for plumbing, not for production use
        # as we're only updating the count_stat for a single realm while
        # updating the global FillState, should be fixed in future
