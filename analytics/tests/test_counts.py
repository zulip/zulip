...
class TestCountStats(AnalyticsTestCase):
    ...
    def test_messages_sent_by_is_bot(self) -> None:
        ...
        recipient_bot_and_human1 = self.get_dm_recipient(bot, human1)
        recipient_human1_and_2 = self.get_dm_recipient(human1, human2)
        recipient_human1 = self.get_dm_recipient(human1)
    ...
    def test_messages_sent_by_is_bot_realm_constraint(self) -> None:
        ...
        recipient_human1_and_2 = self.get_dm_recipient(human1, human2)
        recipient_human1 = self.get_dm_recipient(human1)
        recipient_hourly_user_and_human1 = self.get_dm_recipient(self.hourly_user, human1)
        recipient_stream = self.create_stream_with_recipient()[1]
        recipient_direct_message_group = self.create_direct_message_group_with_recipient()[1]
    ...
    def test_messages_sent_by_message_type(self) -> None:
        ...
        # direct messages
        recipient_user1_and_2 = self.get_dm_recipient(user1, user2)
        recipient_user3 = self.get_dm_recipient(user3)
    ...
    def test_messages_sent_by_message_type_realm_constraint(self) -> None:
        ...
        user = self.create_user()
        user_recipient = self.get_dm_recipient(user)
        hourly_user_and_user_recipient = self.get_dm_recipient(self.hourly_user, user)
    ...
    def test_messages_sent_by_client(self) -> None:
        ...
        recipient_user1_and_2 = self.get_dm_recipient(user1, user2)
        recipient_user2 = self.get_dm_recipient(user2)
        recipient_stream = self.create_stream_with_recipient()[1]
        recipient_direct_message_group = self.create_direct_message_group_with_recipient()[1]
    ...
    def test_messages_sent_by_client_realm_constraint(self) -> None:
        ...
        recipient_user1_and_2 = self.get_dm_recipient(user1, user2)
        recipient_user2 = self.get_dm_recipient(user2)
        recipient_hourly_user_and_user2 = self.get_dm_recipient(self.hourly_user, user2)
...
class TestLoggingCountStats(AnalyticsTestCase):
    ...
    def test_mobile_pushes_received_count(self) -> None:
        ...
        message = Message(
            sender=hamlet,
            recipient=self.get_dm_recipient(hamlet, self.example_user("othello")),
