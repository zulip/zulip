...
import ArrowRightIcon from "~icons/zulip-icon/arrow-right";
...
<Tabs>
  <TabItem label="Desktop/Web">
    <Steps>
      ...
      1. *(optional)* Once you are at the bottom of the conversation, click
         the **Go to next unread topic** or
         **Go to next unread direct message** (<ArrowRightIcon />) button to
