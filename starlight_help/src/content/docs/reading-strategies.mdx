...
import ViewAlertWords from "../include/_ViewAlertWords.mdx";
...
The alert words view lets you find messages containing one of your configured
[alert words](/help/dm-mention-alert-notifications#alert-words). It appears in
the left sidebar once you have at least one alert word configured.
