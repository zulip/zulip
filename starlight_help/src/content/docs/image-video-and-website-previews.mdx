...
## Configure the size of images and videos in messages
...
<FlattenedSteps>
  ...
  1. Under **Message feed settings**, select the desired option from the **Size of images and videos in messages** dropdown:
     * **Small** - Images are displayed at a small size (default)
     * **Medium** - Images are displayed 50% larger than small
     * **Large** - Images are displayed 100% larger than small
