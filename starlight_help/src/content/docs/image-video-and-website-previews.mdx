...
preview](#configure-whether-website-previews-are-shown) or a YouTube video
preview that you'd rather not see, you can hide it just for yourself, without
changing how the message looks for anyone else.
