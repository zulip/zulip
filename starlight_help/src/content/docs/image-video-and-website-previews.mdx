...
preview](#configure-whether-website-previews-are-shown) that you'd rather not
see, you can hide it just for yourself, without changing how the message looks
for anyone else.
