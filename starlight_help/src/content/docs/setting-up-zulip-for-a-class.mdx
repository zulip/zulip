...
* If your class uses a programming language, set the [default
  language for code blocks][default-code-block-language]. If different
  classes use different languages, you can also configure a [default
  language for each channel][channel-code-block-language]. Also
...
[channel-code-block-language]: /help/code-blocks#configure-the-default-code-block-language-for-a-channel
