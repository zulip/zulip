...
<Tabs>
  <TabItem label="Via compose box button">
    <FlattenedSteps>
      ...
      1. Click the **bold** (<BoldIcon />) icon at the bottom of the compose box.
    </FlattenedSteps>
...
<Tabs>
  <TabItem label="Via compose box button">
    <FlattenedSteps>
      ...
      1. Select the text you want to format.
      1. Click the **italic** (<ItalicIcon />) icon at the bottom of the compose box.
    </FlattenedSteps>
...
<Tabs>
  <TabItem label="Via compose box button">
    <FlattenedSteps>
      ...
      1. Select the text you want to format.
      1. Click the **strikethrough** (<StrikethroughIcon />) icon at the bottom
         of the compose box.
    </FlattenedSteps>
  </TabItem>
