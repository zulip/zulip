...
<FlattenedSteps>
  ...
  1. Click the **add saved snippet** (<MessageSquareTextIcon />) icon at the
     bottom of the compose box to open the saved snippets menu.
...
<FlattenedSteps>
  ...
  1. Click the **add saved snippet** (<MessageSquareTextIcon />) icon at the bottom
     of the compose box to open the saved snippets menu.
...
<FlattenedSteps>
  ...
  1. Click the **add saved snippet** (<MessageSquareTextIcon />) icon at the bottom
     of the compose box to open the saved snippets menu.
  1. Hover over the saved snippet you'd like to edit, and click the **edit snippet**
     (<EditIcon />) icon on the right.
