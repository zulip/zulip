  ...
  <TabItem label="Default installation">
    <Steps>
      ...
      1. Download the export file to the server, replacing `latest_export`
         ...
         ```
      1. Finally, copy the exported zip to your local computer.
         ```bash "<username>" "<server_ip>"
...
* Mattermost channel threads are imported as topics with names that include snippets of
  the original message, such as "2023-05-30 Hi, can anyone reply if you're o…".
