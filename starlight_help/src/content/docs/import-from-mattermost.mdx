  ...
  <TabItem label="Docker">
    <Steps>
      ...
      1. List all of the exports on the server, and copy the name of the
         ...
         ```
      1. Generate a link to download the file. This requires the
         `EnableExportDirectDownload` feature flag to be set to `true`.
         ```bash
         docker exec -it mattermost-docker_app_1 mmctl export \
            generate-presigned-url latest_export.zip
         ```
      ...
      1. Download the exported file from the server to your local
         computer using the generated presigned url.
    </Steps>
  </TabItem>
