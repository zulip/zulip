...
## Configure whether resolving a topic requires a message
...
<Tabs>
  <TabItem label="Desktop/Web">
    <FlattenedSteps>
      ...
      1. Under **Moving messages**, configure **Topic resolution message**.
         Choose **Not requested**, **Optional**, or **Required**.
