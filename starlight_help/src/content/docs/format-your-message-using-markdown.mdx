...
<ZulipTip>
  You can also use the **bulleted list** (<UnorderedListIcon />)
...
<ZulipTip>
  You can also use the **link** (<LinkIcon />)
...
<ZulipTip>
  You can also use the **spoiler** (<SpoilerIcon />) button in the compose
...
<ZulipTip>
  You can also use the **add global time** (<TimeIcon />) button in the compose
