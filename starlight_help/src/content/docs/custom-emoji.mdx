...
Custom emoji can be animated. You can
[configure](/help/image-video-and-website-previews#configure-how-animated-images-are-played)
whether animated custom emoji play always, only on hover, or never.
