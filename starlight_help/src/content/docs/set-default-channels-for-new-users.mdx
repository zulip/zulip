...
<FlattenedSteps>
  ...
  1. Find the channel you would like to remove, and click the
     **remove from default** (<CloseIcon />) icon.
</FlattenedSteps>
...
* [Enable channel notifications for new subscribers](/help/enable-mobile-notifications-by-default)
