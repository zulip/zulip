...
* [Moving from **Discord**](/help/moving-from-discord). You can [import your
  Discord server](/help/import-from-discord).
...
<ZulipNote>
  You can import data from Slack, Discord, Mattermost, and Rocket.Chat. **You can only
