...
### Expand or collapse all channel folders
...
<Tabs>
  <TabItem label="Desktop/Web">
    <Steps>
      1. Next to any folder name in the channels section, click the triangle icon to expand or collapse just that folder’s channels.
    </Steps>
  </TabItem>
</Tabs>
