...
security team][reporting-security-issues] as soon as possible. To allow us to
responsibly remediate security issues, please *do not* report them publicly on
GitHub, in the Zulip development community, or anywhere else.

[reporting-security-issues]: https://zulip.readthedocs.io/en/latest/contributing/reporting-security-vulnerabilities.html#how-to-report-a-possible-security-issue
