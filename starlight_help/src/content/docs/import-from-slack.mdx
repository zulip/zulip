  ...
  <TabItem label="Zulip Cloud">
    <Steps>
      ...
      1. Enter your Slack **Bot User OAuth Token**, which will be a long
         ...
         **Submit**.
      1. Upload the **exported data** `.zip` file containing your workspace
      ...
      1. Set a password for your Zulip account. If you're using a different
         registration email from your Slack account, start by selecting your
         account from the dropdown. If you don't have an account in the imported
         workspace, you can create a new Zulip account.
    </Steps>
