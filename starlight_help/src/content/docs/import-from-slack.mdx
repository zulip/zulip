...
<Steps>
  ...
  1. [Create a
     ...
     * `users:read.email`
     * `team:read`
  1. In the **OAuth & Permissions** menu, scroll to the **OAuth Tokens** section,
     and click **Install to Workspace**. You'll now be sent through the Slack OAuth
     flow, approve the permission request.
