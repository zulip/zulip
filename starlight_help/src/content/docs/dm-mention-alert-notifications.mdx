...
### View messages with alert words

Zulip shows an **Alert words** view in the left sidebar, with an unread count,
once you have configured at least one alert word.
