...
Zulip can show you how a [conversation](/help/reading-conversations) is connected
to others through links, making it easy to navigate between related discussions.

* **Links to** shows the channels and conversations that messages in the current
...
it. These lists are built from messages Zulip has loaded, so they may be
incomplete until you have visited the relevant conversations.
