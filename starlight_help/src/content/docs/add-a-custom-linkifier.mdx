...
<FlattenedSteps>
  ...
  1. Enter the **Pattern** of the text you want to linkify, and **Example text
     to linkify**, which will help verify your pattern.
...
<FlattenedSteps>
  ...
  1. In the **Pattern** column, click and drag the vertical
