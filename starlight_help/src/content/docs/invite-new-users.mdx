...
<FlattenedSteps>
  ...
  1. (optional) Select **Require invitee to use the invited email address** if invitees must register using the exact email you entered.
...
<ZulipNote>
  **Tip:** Invitation emails link to your organization’s registration page with the invitee’s email prefilled. By default, invitees can edit this email and sign up with a different address. If you selected **Require invitee to use the invited email address**, the registration page will require the invited email.
</ZulipNote>
