...
If you'd like to preserve your Discord history, you can [import your Discord
server](/help/import-from-discord) into a new Zulip organization instead.
...
let users join Zulip without creating a separate password.
  ...
  <TabItem label="Require invitations">
    <Steps>
      1. [Configure allowed authentication
         ...
         Discord, Zulip offers a variety of
...
* [Import from Discord](/help/import-from-discord)
