...
channel, unless an organization administrator has [set a default
color](/help/set-a-default-channel-color) for that channel. Changing a
channel's color does not change it for anyone else.
...
* [Set a default channel color](/help/set-a-default-channel-color)
