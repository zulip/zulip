...
## Use Markdown in field labels and hints

You can use Markdown to format the **Label** and **Hint** text for custom
profile fields. Formatted labels and hints are displayed in the custom
profile fields settings and user profiles.

Only inline formatting is supported: **bold**, *italic*, `inline code`,
[links](https://zulip.com), and ~~strikethrough~~. Other Markdown, such as
headings, lists, mentions, and emoji, is shown as plain text.
...
<FlattenedSteps>
  ...
  1. In the **Actions** column, click the **edit** (<EditIcon />)
     icon for the profile field you want to edit.
  1. Edit the **Label** or **Hint** field using Markdown formatting.
