...
* For channels where it's important that everyone stays on top of new messages,
  organization administrators can [enable mobile notifications](/help/enable-mobile-notifications-by-default)
  as a default for new subscribers.
