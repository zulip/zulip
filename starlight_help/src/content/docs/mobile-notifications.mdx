...
notifications will only be sent to apps that support end-to-end
encryption. Older apps that don't support E2EE will not receive any push
notifications. See [technical
