...
the server to an updated version of the app will be end-to-end encrypted. E2EE
push notifications ensure that message content and metadata (including the
sender's name, and the channel and topic where the message was sent) is not
